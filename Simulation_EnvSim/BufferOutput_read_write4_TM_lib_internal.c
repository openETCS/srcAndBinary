  ...
  *Stacksize_new = Stacksize_old + 3;
  if (_L34) {
    ...
    kcg_copy_array__137223(
      &(*Buffer_Out)[0],
      (array__137223 *) &(*Message_In)[1]);
    kcg_copy_array__131302(&(*Buffer_Out)[3], &_L40);
  }
  else {
    ...
    kcg_copy_array__136722(
      &(*Buffer_Out)[0],
      (array__136722 *) &(*Message_In)[0]);
  }
  kcg_copy_array__137219(&(*Buffer_Out)[4], (array__137219 *) &(*Buffer_In)[0]);
}
