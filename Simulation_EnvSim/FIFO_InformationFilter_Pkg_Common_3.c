  ...
  outC_FIFO_InformationFilter_Pkg_Common_3 *outC)
{
  static kcg_int tmp1;
  static kcg_int tmp;
  static array__130612 tmp2;
  /* InformationFilter_Pkg::Common::FIFO::IfBlock1::then::_L19 */
  static array__130612 _L19_IfBlock1;
  ...
  if (inValid) {
    ...
    if (outC->init) {
      _L9_IfBlock1 = 0;
      kcg_copy_array__130612(&outC->_L4_IfBlock1, &_L19_IfBlock1);
    }
    else {
    ...
    kcg_copy_array__130612(&outC->buffer, &outC->_L4_IfBlock1);
    ...
    if (outC->init1) {
      kcg_copy_array__130612(&outC->buffer, &tmp2);
    }
    tmp1 = 0;
  }
  if (outC->init1) {
