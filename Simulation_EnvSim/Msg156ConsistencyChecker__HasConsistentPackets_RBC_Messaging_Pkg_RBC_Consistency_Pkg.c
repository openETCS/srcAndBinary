...
kcg_bool Msg156ConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistency_Pkg(
...
{
  static PT0_PositionReport_T_Packet_TrainTypes_Pkg tmp6;
  static PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg tmp5;
  static PT3_OnboardTelephoneNumbers_T_Packet_TrainTypes_Pkg tmp4;
  ...
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentPackets::outIsConsistent */
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Msg156ConsistencyChecker__HasConsistentPackets_RBC_Messaging_Pkg_RBC_Consistency_Pkg.c
** Generation date: 2015-11-23T09:24:24
*************************************************************$ */
