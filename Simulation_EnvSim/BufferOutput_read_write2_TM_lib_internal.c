  ...
  *Stacksize_new = Stacksize_old + 1;
  if (_L34) {
    ...
    kcg_copy_array__130636(
      &(*Buffer_Out)[0],
      (array__130636 *) &(*Message_In)[1]);
    kcg_copy_array__130636(&(*Buffer_Out)[1], &_L40);
  }
  else {
    ...
    kcg_copy_array__136580(
      &(*Buffer_Out)[0],
      (array__136580 *) &(*Message_In)[0]);
  }
  kcg_copy_array__136583(&(*Buffer_Out)[2], (array__136583 *) &(*Buffer_In)[0]);
}
