  ...
  *Stacksize_new = Stacksize_old + 1;
  if (_L34) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      Message_out,
      &(*Message_In)[0]);
    kcg_copy_array__131333(
      &(*Buffer_Out)[0],
      (array__131333 *) &(*Message_In)[1]);
    kcg_copy_array__131333(&(*Buffer_Out)[1], &_L40);
  }
  else {
    ...
    kcg_copy_array__137261(
      &(*Buffer_Out)[0],
      (array__137261 *) &(*Message_In)[0]);
  }
  kcg_copy_array__137264(&(*Buffer_Out)[2], (array__137264 *) &(*Buffer_In)[0]);
}
