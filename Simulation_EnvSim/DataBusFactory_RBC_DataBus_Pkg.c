  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  ...
  if (_L3) {
    ...
    kcg_copy_array__128383(
      &tmp3,
      (array__128383 *) &DIAG_MSG_DEFAULT_ARRAY_RBC_Diagnostic_Pkg);
    ...
    kcg_copy_array__128383(&tmp3, &(*inDataBus).diagnostic);
  ...
  kcg_copy_array__128383(&outC->outDataBus.diagnostic, &tmp3);
