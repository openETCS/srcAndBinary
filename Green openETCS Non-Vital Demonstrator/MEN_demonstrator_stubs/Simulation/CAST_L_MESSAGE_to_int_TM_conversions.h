...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int /* TM_conversions::CAST_L_MESSAGE_to_int::l_message_int */ l_message_int;
  /* -----------------------  no local probes  ----------------------- */
  ...
  L_MESSAGE /* TM_conversions::CAST_L_MESSAGE_to_int::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_L_MESSAGE_to_int::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_L_MESSAGE_to_int::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_L_MESSAGE_to_int::_L12 */ _L12;
  kcg_int /* TM_conversions::CAST_L_MESSAGE_to_int::_L13 */ _L13;
