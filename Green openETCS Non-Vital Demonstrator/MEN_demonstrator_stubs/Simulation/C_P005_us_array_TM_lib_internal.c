  ...
  outC_C_P005_us_array_TM_lib_internal *outC)
{
  ...
  /* 1 */ CAST_Int_to_Q_NEWCOUNTRY_reset_TM_conversions(&outC->_4_Context_1);
  /* 2 */ C_P005_extract_el_section_reset_TM_lib_internal(&outC->Context_2);
  /* 1 */ CAST_Int_to_Q_LOCACC_reset_TM_conversions(&outC->_3_Context_1);
  ...
  outC_C_P005_us_array_TM_lib_internal *outC)
{
  ...
  /* 1 */ CAST_Int_to_NID_BG_TM_conversions(outC->_L21, &outC->Context_1);
  outC->_L27 = outC->Context_1.nid_bg;
  /* 1 */
  CAST_Int_to_Q_LINKORIENTATION_TM_conversions(outC->_L22, &outC->_1_Context_1);
  outC->_L29 = outC->_1_Context_1.q_linkorientation;
  /* 1 */
  CAST_Int_to_Q_LINKREACTION_TM_conversions(outC->_L23, &outC->_2_Context_1);
  outC->_L30 = outC->_2_Context_1.q_linkreaction;
  /* 1 */ CAST_Int_to_Q_LOCACC_TM_conversions(outC->_L24, &outC->_3_Context_1);
  outC->_L31 = outC->_3_Context_1.q_locacc;
  outC->_L3 = n_iter_int;
  ...
  /* 1 */
  CAST_Int_to_Q_NEWCOUNTRY_TM_conversions(outC->_L19, &outC->_4_Context_1);
  outC->_L28 = outC->_4_Context_1.q_newcountry;
  /* 3 */
  C_P005_extract_el_section_TM_lib_internal(
    outC->_L16,
    &outC->_L1,
