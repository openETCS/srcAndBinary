...
void M016_to_Radio_Track_Train_H_reset_TM_RBC_conversions_legacy(
  ...
  outC_M016_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
  ...
  kcg_copy_M_016_T_TM_radio_messages(&outC->_L1, M016_in);
  outC->_L26 = outC->_L1.nid_em;
  ...
  outC->_L16 = default_m_version_TM_RBC_conversions_legacy;
  ...
  outC->_L14._1_m_version = outC->_L16;
