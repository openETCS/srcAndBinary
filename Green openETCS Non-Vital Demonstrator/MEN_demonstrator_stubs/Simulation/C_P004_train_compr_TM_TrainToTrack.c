  ...
  outC_C_P004_train_compr_TM_TrainToTrack *outC)
{
  ...
  /* 1 */ CAST_M_ERROR_to_int_reset_TM_conversions(&outC->_2_Context_1);
  ...
  outC_C_P004_train_compr_TM_TrainToTrack *outC)
{
  ...
  /* 1 */ CAST_M_ERROR_to_int_TM_conversions(outC->_L5, &outC->_2_Context_1);
  outC->_L71 = outC->_2_Context_1.m_error_int;
