...
void Read_P041_reset_TM(outC_Read_P041_TM *outC)
{
  /* 1 */ C_P041_compr_onboard_reset_TM_conversions(&outC->_1_Context_1);
  ...
  outC_Read_P041_TM *outC)
{
  ...
  /* 1 */
  C_P041_compr_onboard_TM_conversions(
    &outC->_L5,
    &outC->_L30,
    &outC->_1_Context_1);
  kcg_copy_P041_OBU_T_TM(&outC->_L166, &outC->_1_Context_1.P041_onboard);
  kcg_copy_P041_OBU_T_TM(&outC->P041_OBU_out, &outC->_L166);
}
