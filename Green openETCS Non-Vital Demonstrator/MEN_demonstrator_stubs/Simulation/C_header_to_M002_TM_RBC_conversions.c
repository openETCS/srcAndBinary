  ...
  outC_C_header_to_M002_TM_RBC_conversions *outC)
{
  ...
  /* 1 */ CAST_Int_to_D_SR_reset_TM_conversions(&outC->_3_Context_1);
  ...
  outC_C_header_to_M002_TM_RBC_conversions *outC)
{
  ...
  outC->_L34 = outC->Context_1.t_train;
  /* 1 */ CAST_Int_to_L_MESSAGE_TM_conversions(outC->_L4, &outC->_1_Context_1);
  outC->_L33 = outC->_1_Context_1.l_message;
  /* 1 */
  CAST_Int_to_NID_MESSAGE_TM_conversions(outC->_L3, &outC->_2_Context_1);
  outC->_L32 = outC->_2_Context_1.nid_message;
  _13_noname = outC->_L13;
  _12_noname = outC->_L12;
  _11_noname = outC->_L11;
  noname = outC->_L10;
  /* 1 */ CAST_Int_to_D_SR_TM_conversions(outC->_L9, &outC->_3_Context_1);
  outC->_L30 = outC->_3_Context_1.d_sr;
