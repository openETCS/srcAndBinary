...
void C_P001_train_compr_reset_TM_TrainToTrack(
  outC_C_P001_train_compr_TM_TrainToTrack *outC)
{
  /* 1 */ CAST_L_PACKET_to_int_reset_TM_conversions(&outC->_17_Context_1);
  /* 1 */ CAST_Q_SCALE_to_int_reset_TM_conversions(&outC->_16_Context_1);
  /* 1 */ CAST_NID_LRBG_to_int_reset_TM_conversions(&outC->_15_Context_1);
  /* 1 */ CAST_Q_DIRLRBG_to_int_reset_TM_conversions(&outC->_14_Context_1);
  /* 1 */ CAST_Q_DRLRBG_to_int_reset_TM_conversions(&outC->_13_Context_1);
  /* 1 */ CAST_L_DOUBTOVER_to_int_reset_TM_conversions(&outC->_12_Context_1);
  /* 1 */ CAST_L_DOUBTUNDER_to_int_reset_TM_conversions(&outC->_11_Context_1);
  /* 1 */ CAST_Q_LENGTH_to_int_reset_TM_conversions(&outC->_10_Context_1);
  /* 1 */ CAST_L_TRAININT_to_int_reset_TM_conversions(&outC->_9_Context_1);
  /* 1 */ CAST_V_TRAIN_to_int_reset_TM_conversions(&outC->_8_Context_1);
  /* 1 */ CAST_Q_DIRTRAIN_to_int_reset_TM_conversions(&outC->_7_Context_1);
  /* 1 */ CAST_M_MODE_to_int_reset_TM_conversions(&outC->_6_Context_1);
  /* 1 */ CAST_M_LEVEL_to_int_reset_TM_conversions(&outC->_5_Context_1);
  /* 1 */ CAST_NID_NTC_to_int_reset_TM_conversions(&outC->_4_Context_1);
  /* 1 */ Encode_NID_PACKET_reset_TM_TrainToTrack(&outC->_3_Context_1);
  /* 1 */ CAST_NID_PACKET_to_int_reset_TM_conversions(&outC->_2_Context_1);
  /* 1 */ CAST_D_LRBG_to_int_reset_TM_conversions(&outC->_1_Context_1);
  /* 1 */ CAST_NID_PRVLRBG_to_int_reset_TM_conversions(&outC->Context_1);
}
