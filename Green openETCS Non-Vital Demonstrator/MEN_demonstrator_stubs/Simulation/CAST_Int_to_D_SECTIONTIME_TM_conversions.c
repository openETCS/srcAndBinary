  ...
  outC_CAST_Int_to_D_SECTIONTIME_TM_conversions *outC)
{
  ...
  outC->_L1 = d_sectiontimerstoploc_int;
  ...
  _1_noname = outC->_L8;
  noname = outC->_L9;
  outC->d_sectiontimerstoploc = outC->_L1;
}

/* $*************** KCG Version 6.1.3 (build i6) ****************
** CAST_Int_to_D_SECTIONTIME_TM_conversions.c
** Generation date: 2015-10-19T14:35:57
*************************************************************$ */
