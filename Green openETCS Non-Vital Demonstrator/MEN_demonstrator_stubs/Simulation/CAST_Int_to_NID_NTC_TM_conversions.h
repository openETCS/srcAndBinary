...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  NID_NTC /* TM_conversions::CAST_Int_to_NID_NTC::nid_ntc */ nid_ntc;
  /* -----------------------  no local probes  ----------------------- */
  ...
  kcg_int /* TM_conversions::CAST_Int_to_NID_NTC::_L1 */ _L1;
  kcg_int /* TM_conversions::CAST_Int_to_NID_NTC::_L5 */ _L5;
  kcg_bool /* TM_conversions::CAST_Int_to_NID_NTC::_L4 */ _L4;
  kcg_int /* TM_conversions::CAST_Int_to_NID_NTC::_L3 */ _L3;
  kcg_bool /* TM_conversions::CAST_Int_to_NID_NTC::_L2 */ _L2;
