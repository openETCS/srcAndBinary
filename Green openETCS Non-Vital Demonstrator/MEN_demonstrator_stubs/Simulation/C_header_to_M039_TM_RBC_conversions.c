...
void C_header_to_M039_reset_TM_RBC_conversions(
...
void C_header_to_M039_TM_RBC_conversions(
  ...
  outC_C_header_to_M039_TM_RBC_conversions *outC)
{
  ...
  kcg_copy_M_039_T_TM_radio_messages(&outC->message_out, &outC->_L26);
}

/* $*************** KCG Version 6.1.3 (build i6) ****************
** C_header_to_M039_TM_RBC_conversions.c
** Generation date: 2015-10-19T14:35:58
*************************************************************$ */
