...
void CAST_Int_to_Q_ENDTIMER_TM_conversions(
  ...
  outC_CAST_Int_to_Q_ENDTIMER_TM_conversions *outC)
{
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::q_endtimer */ Q_ENDTIMER _2_q_endtimer;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::error */ kcg_bool error1;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::q_endtimer */ Q_ENDTIMER q_endtimer;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::error */ kcg_bool error;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::q_endtimer */ Q_ENDTIMER _3_q_endtimer;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::error */ kcg_bool error4;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::q_endtimer */ Q_ENDTIMER _5_q_endtimer;
  /* TM_conversions::CAST_Int_to_Q_ENDTIMER::error */ kcg_bool error6;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    _2_q_endtimer = outC->_L4_IfBlock1;
    outC->q_endtimer = _2_q_endtimer;
    outC->error = error1;
  }
  else {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      _5_q_endtimer = outC->_L3_IfBlock1;
      error = error6;
      ...
      outC->_L1_IfBlock1 =
        ENUM_Q_ENDTIMER_endsection_timer_info_follows_TM_conversions;
      _3_q_endtimer = outC->_L1_IfBlock1;
      error = error4;
      q_endtimer = _3_q_endtimer;
    }
    outC->q_endtimer = q_endtimer;
    outC->error = error;
  }
