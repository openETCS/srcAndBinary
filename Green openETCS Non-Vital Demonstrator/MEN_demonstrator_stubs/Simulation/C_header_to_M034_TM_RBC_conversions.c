  ...
  outC_C_header_to_M034_TM_RBC_conversions *outC)
{
  ...
  /* 1 */ CAST_Int_to_D_REF_reset_TM_conversions(&outC->_5_Context_1);
  /* 1 */ CAST_Int_to_L_TAFDISPLAY_reset_TM_conversions(&outC->_4_Context_1);
  /* 1 */ CAST_Int_to_D_TAFDISPLAY_reset_TM_conversions(&outC->_3_Context_1);
  /* 1 */ CAST_Int_to_NID_MESSAGE_reset_TM_conversions(&outC->_2_Context_1);
  ...
  outC_C_header_to_M034_TM_RBC_conversions *outC)
{
  ...
  outC->_L37 = outC->Context_1.t_train;
  /* 1 */ CAST_Int_to_L_MESSAGE_TM_conversions(outC->_L4, &outC->_1_Context_1);
  outC->_L36 = outC->_1_Context_1.l_message;
  /* 1 */
  CAST_Int_to_NID_MESSAGE_TM_conversions(outC->_L3, &outC->_2_Context_1);
  outC->_L35 = outC->_2_Context_1.nid_message;
  /* 1 */
  CAST_Int_to_D_TAFDISPLAY_TM_conversions(outC->_L11, &outC->_3_Context_1);
  outC->_L33 = outC->_3_Context_1.d_tafdisplay;
  /* 1 */
  CAST_Int_to_L_TAFDISPLAY_TM_conversions(outC->_L12, &outC->_4_Context_1);
  outC->_L32 = outC->_4_Context_1.l_tafdisplay;
  outC->q_dir_int_1 = outC->_L10;
  ...
  outC->_L31 = outC->q_dir_1;
  /* 1 */ CAST_Int_to_D_REF_TM_conversions(outC->_L9, &outC->_5_Context_1);
  outC->_L30 = outC->_5_Context_1.d_ref;
