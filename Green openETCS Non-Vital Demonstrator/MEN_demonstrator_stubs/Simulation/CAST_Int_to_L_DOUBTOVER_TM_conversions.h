...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  L_DOUBTOVER /* TM_conversions::CAST_Int_to_L_DOUBTOVER::l_doubtover */ l_doubtover;
  /* -----------------------  no local probes  ----------------------- */
  ...
  kcg_int /* TM_conversions::CAST_Int_to_L_DOUBTOVER::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_Int_to_L_DOUBTOVER::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_Int_to_L_DOUBTOVER::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_Int_to_L_DOUBTOVER::_L10 */ _L10;
  kcg_int /* TM_conversions::CAST_Int_to_L_DOUBTOVER::_L11 */ _L11;
