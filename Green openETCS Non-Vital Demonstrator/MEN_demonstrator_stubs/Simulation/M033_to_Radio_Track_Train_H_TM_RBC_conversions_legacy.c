...
void M033_to_Radio_Track_Train_H_reset_TM_RBC_conversions_legacy(
  ...
  outC_M033_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
  ...
  kcg_copy_M_033_T_TM_radio_messages(&outC->_L1, M033_in);
  ...
  outC->_L28 = default_m_version_TM_RBC_conversions_legacy;
  ...
  outC->_L14._1_m_version = outC->_L28;
