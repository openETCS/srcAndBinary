  ...
  /* TM_conversions::C_P015_compr_onboard::P015_onboard */P015_OBU_T_TM *P015_onboard)
{
  ...
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1::else */ kcg_bool _1_else_clock_2_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1::else::else */ kcg_bool else_clock_2_IfBlock1;
