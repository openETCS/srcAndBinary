...
void M040_to_Radio_Track_Train_H_TM_RBC_conversions_legacy(
  /* TM_RBC_conversions_legacy::M040_to_Radio_Track_Train_H::M040_in */M_040_T_TM_radio_messages *M040_in,
  /* TM_RBC_conversions_legacy::M040_to_Radio_Track_Train_H::Radio_Track_Train_Hd_out */Radio_TrackTrain_Header_T_Radio_Types_Pkg *Radio_Track_Train_Hd_out)
{
  ...
  (*Radio_Track_Train_Hd_out).nid_message = (*M040_in).nid_message;
  (*Radio_Track_Train_Hd_out).t_train = (*M040_in).t_train;
  (*Radio_Track_Train_Hd_out).m_ack = (*M040_in).m_ack;
  (*Radio_Track_Train_Hd_out).nid_lrbg = (*M040_in).nid_lrbg;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** M040_to_Radio_Track_Train_H_TM_RBC_conversions_legacy.c
** Generation date: 2015-10-19T14:37:59
*************************************************************$ */
