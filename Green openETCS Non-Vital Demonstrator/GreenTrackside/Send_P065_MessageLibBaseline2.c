...
void Send_P065_MessageLibBaseline2(
  /* MessageLibBaseline2::Send_P065::B_data_in */ CompressedPackets_T_Common_Type *B_data_in,
  /* MessageLibBaseline2::Send_P065::P065 */ P065_trackside_int_T_TM *P065,
  /* MessageLibBaseline2::Send_P065::B_data_out */ CompressedPackets_T_Common_Type *B_data_out)
{
  /* MessageLibBaseline2::Send_P065 */
  static kcg_bool op_call;
  
  /* ck__L5 */ if ((*P065).valid) {
    /* 1 */ Write_P065_TM_trackside(P065, B_data_in, &op_call, B_data_out);
  }
  else {
