...
#include "M045_to_Radio_Track_Train_H_TM_.h"

/* TM_RBC_conversions_legacy::M045_to_Radio_Track_Train_H */
void M045_to_Radio_Track_Train_H_TM_(
  /* TM_RBC_conversions_legacy::M045_to_Radio_Track_Train_H::M045_in */ M_045_T_TM_radio_messages *M045_in,
  /* TM_RBC_conversions_legacy::M045_to_Radio_Track_Train_H::Radio_Track_Train_Hd_out */ _1_Radio_TrackTrain_Header_T_Ra *Radio_Track_Train_Hd_out)
{
  ...
  (*Radio_Track_Train_Hd_out).nid_message = (*M045_in).nid_message;
  (*Radio_Track_Train_Hd_out).t_train = (*M045_in).t_train;
  (*Radio_Track_Train_Hd_out).m_ack = (*M045_in).m_ack;
  (*Radio_Track_Train_Hd_out).nid_lrbg = (*M045_in).nid_lrbg;
...
/* $**************** KCG Version 6.4 (build i21) ****************
** M045_to_Radio_Track_Train_H_TM_.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
