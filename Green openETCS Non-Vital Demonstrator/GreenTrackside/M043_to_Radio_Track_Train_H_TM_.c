...
#include "M043_to_Radio_Track_Train_H_TM_.h"

/* TM_RBC_conversions_legacy::M043_to_Radio_Track_Train_H */
void M043_to_Radio_Track_Train_H_TM_(
  /* TM_RBC_conversions_legacy::M043_to_Radio_Track_Train_H::M043_in */ M_043_T_TM_radio_messages *M043_in,
  /* TM_RBC_conversions_legacy::M043_to_Radio_Track_Train_H::Radio_Track_Train_Hd_out */ _1_Radio_TrackTrain_Header_T_Ra *Radio_Track_Train_Hd_out)
{
  ...
  (*Radio_Track_Train_Hd_out).nid_message = (*M043_in).nid_message;
  (*Radio_Track_Train_Hd_out).t_train = (*M043_in).t_train;
  (*Radio_Track_Train_Hd_out).m_ack = (*M043_in).m_ack;
  (*Radio_Track_Train_Hd_out).nid_lrbg = (*M043_in).nid_lrbg;
...
/* $**************** KCG Version 6.4 (build i21) ****************
** M043_to_Radio_Track_Train_H_TM_.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
