...
#include "Balise_Group_440_AmsterdamUtrec.h"

/* AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_Group_440 */
void Balise_Group_440_AmsterdamUtrec(
  ...
  /* AmsterdamUtrechtL2::Sheet15_MaarssenUtrechtCS_Balises::Balise_Group_440::BG_message_out */ CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* 1 */
  Balise_440_0_AmsterdamUtrechtL2(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG440_header_B0_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_440_1_AmsterdamUtrechtL2(
    &tmp,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Balise_Group_440_AmsterdamUtrec.c
** Generation date: 2015-11-10T22:49:43
*************************************************************$ */
