...
void Send_P015_MessageLibBaseline2(
  /* MessageLibBaseline2::Send_P015::B_data_in */ CompressedPackets_T_Common_Type *B_data_in,
  /* MessageLibBaseline2::Send_P015::P015 */ P015_trackside_int_T_TM *P015,
  /* MessageLibBaseline2::Send_P015::B_data_out */ CompressedPackets_T_Common_Type *B_data_out)
{
  /* MessageLibBaseline2::Send_P015 */
  static kcg_bool op_call;
  
  /* ck__L5 */ if ((*P015).valid) {
    /* 1 */ Write_P015_TM_trackside(P015, B_data_in, &op_call, B_data_out);
  }
  else {
