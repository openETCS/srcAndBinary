...
void Balise_364_0_AmsterdamUtrechtL2(
...
{
  /* AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Balise_364_0::_L2 */
  static kcg_bool _L2;
  /* AmsterdamUtrechtL2::Sheet06_Bijlmer_Balises::Balise_364_0::_L21 */
  static kcg_int _L21;
  
  /* 1 */ Balise_Localisation_InfraLib(B_data_in, Header, PIG_nom, &_L21, &_L2);
  /* ck__L2 */ if (_L2) {
    /* 1 */ Packets_BG364_AmsterdamUtrechtL(Header, B_data_in, B_data_out);
  }
  else {
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Balise_364_0_AmsterdamUtrechtL2.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
