  ...
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg159ConsistencyChecker__HasConsistentPackets::inRadioTrainTrackPackets */ outPackets_T_Common_Types_Pkg *inRadioTrainTrackPackets)
{
  ...
  /* 1 */ _149_RadioTrainTrackPackets__Ge(inRadioTrainTrackPackets, &tmp5);
  /* 1 */ _150_RadioTrainTrackPackets__Ge(inRadioTrainTrackPackets, &tmp4);
  ...
  outIsConsistent = !/* 1 */ RadioTrainTrackPacket000__IsVal(&tmp5) & !/* 1 */
    RadioTrainTrackPacket001__IsVal(&tmp4) & !/* 1 */
...
/* $**************** KCG Version 6.4 (build i21) ****************
** _84_Msg159ConsistencyChecker__H.c
** Generation date: 2015-11-10T22:49:44
*************************************************************$ */
