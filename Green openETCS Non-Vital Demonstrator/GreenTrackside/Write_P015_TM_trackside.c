...
void Write_P015_TM_trackside(
  ...
  /* TM_trackside::Write_P015::Packets */ CompressedPackets_T_Common_Type *Packets,
  /* TM_trackside::Write_P015::Error */ kcg_bool *Error,
  /* TM_trackside::Write_P015::RadioPacketsOut */ CompressedPackets_T_Common_Type *RadioPacketsOut)
{
  ...
  *Error = kcg_false;
  /* 1 */ C_P015_tracksim_compr_TM_conver(Packet15, &_L43, &_L44);
  /* 1 */
