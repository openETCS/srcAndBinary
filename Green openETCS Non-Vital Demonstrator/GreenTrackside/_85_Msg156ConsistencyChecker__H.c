  ...
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg156ConsistencyChecker__HasConsistentPackets::inRadioTrainTrackPackets */ outPackets_T_Common_Types_Pkg *inRadioTrainTrackPackets)
{
  ...
  /* 1 */ RadioTrainTrackPackets__GetP009(inRadioTrainTrackPackets, &tmp1);
  ...
  outIsConsistent = !/* 1 */ RadioTrainTrackPacket000__IsVal(&tmp6) & !/* 1 */
    ...
    RadioTrainTrackPacket005__IsVal(&tmp2) & !/* 1 */
...
/* $**************** KCG Version 6.4 (build i21) ****************
** _85_Msg156ConsistencyChecker__H.c
** Generation date: 2015-11-10T22:49:44
*************************************************************$ */
