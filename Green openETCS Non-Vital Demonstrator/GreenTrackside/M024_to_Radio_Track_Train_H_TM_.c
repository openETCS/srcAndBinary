...
#include "M024_to_Radio_Track_Train_H_TM_.h"

/* TM_RBC_conversions_legacy::M024_to_Radio_Track_Train_H */
void M024_to_Radio_Track_Train_H_TM_(
  /* TM_RBC_conversions_legacy::M024_to_Radio_Track_Train_H::M024_in */ M_024_T_TM_radio_messages *M024_in,
  /* TM_RBC_conversions_legacy::M024_to_Radio_Track_Train_H::Radio_Track_Train_Hd_out */ _1_Radio_TrackTrain_Header_T_Ra *Radio_Track_Train_Hd_out)
{
...
/* $**************** KCG Version 6.4 (build i21) ****************
** M024_to_Radio_Track_Train_H_TM_.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
