...
#include "M018_to_Radio_Track_Train_H_TM_.h"

/* TM_RBC_conversions_legacy::M018_to_Radio_Track_Train_H */
void M018_to_Radio_Track_Train_H_TM_(
  /* TM_RBC_conversions_legacy::M018_to_Radio_Track_Train_H::M018_in */ M_018_T_TM_radio_messages *M018_in,
  /* TM_RBC_conversions_legacy::M018_to_Radio_Track_Train_H::Radio_Track_Train_Hd_out */ _1_Radio_TrackTrain_Header_T_Ra *Radio_Track_Train_Hd_out)
{
...
/* $**************** KCG Version 6.4 (build i21) ****************
** M018_to_Radio_Track_Train_H_TM_.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
