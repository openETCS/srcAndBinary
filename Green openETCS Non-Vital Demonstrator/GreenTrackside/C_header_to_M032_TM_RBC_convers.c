...
#include "C_header_to_M032_TM_RBC_convers.h"

/* TM_RBC_conversions::C_header_to_M032 */
void C_header_to_M032_TM_RBC_convers(
  ...
  /* TM_RBC_conversions::C_header_to_M032::message_out */ M_032_T_TM_radio_messages *message_out)
{
  ...
  (*message_out).m_version = /* 1 */
    CAST_Int_to_M_VERSION_TM_conver((*header_in).field3);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** C_header_to_M032_TM_RBC_convers.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
