...
void compressed_to_Radio_Track_Train(
  /* TM_RBC_conversions_legacy::compressed_to_Radio_Track_Train_H::Header_In */ M_TrackTrain_Radio_T_TM_radio_m *Header_In,
  /* TM_RBC_conversions_legacy::compressed_to_Radio_Track_Train_H::Header_Out */ _1_Radio_TrackTrain_Header_T_Ra *Header_Out)
{
  /* TM_RBC_conversions_legacy::compressed_to_Radio_Track_Train_H */
  ...
  nid_message = /* 1 */
    CAST_NID_MESSAGE_to_int_TM_conv((*Header_In).nid_message);
  ...
  /* 1 */ if (nid_message <= 27) {
    /* ck_IfBlock1 */ if (IfBlock1_clock) {
      /* 1 */ C_header_to_M002_TM_RBC_convers(Header_In, &tmp19);
      /* 1 */ M002_to_Radio_Track_Train_H_TM_(&tmp19, Header_Out);
    }
    else /* ck_anon_activ */ if (_35_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M003_TM_RBC_convers(Header_In, &tmp18);
      /* 4 */ M003_to_Radio_Track_Train_H_TM_(&tmp18, Header_Out);
    }
    else /* ck_anon_activ */ if (_34_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M006_TM_RBC_convers(Header_In, &tmp17);
      /* 1 */ M006_to_Radio_Track_Train_H_TM_(&tmp17, Header_Out);
    }
    else /* ck_anon_activ */ if (_33_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M008_TM_RBC_convers(Header_In, &tmp16);
      /* 2 */ M008_to_Radio_Track_Train_H_TM_(&tmp16, Header_Out);
    }
    else /* ck_anon_activ */ if (_32_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M009_TM_RBC_convers(Header_In, &tmp15);
      /* 1 */ M009_to_Radio_Track_Train_H_TM_(&tmp15, Header_Out);
    }
    else /* ck_anon_activ */ if (_31_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M015_TM_RBC_convers(Header_In, &tmp14);
      /* 2 */ M015_to_Radio_Track_Train_H_TM_(&tmp14, Header_Out);
    }
    else /* ck_anon_activ */ if (_30_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M016_TM_RBC_convers(Header_In, &tmp13);
      /* 2 */ M016_to_Radio_Track_Train_H_TM_(&tmp13, Header_Out);
    }
    else /* ck_anon_activ */ if (_29_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M018_TM_RBC_convers(Header_In, &tmp12);
      /* 2 */ M018_to_Radio_Track_Train_H_TM_(&tmp12, Header_Out);
    }
    else /* ck_anon_activ */ if (_28_else_clock_IfBlock1) {
      /* 1 */ C_header_to_M024_TM_RBC_convers(Header_In, &tmp11);
      /* 9 */ M024_to_Radio_Track_Train_H_TM_(&tmp11, Header_Out);
    }
    else /* ck_anon_activ */ if (else_clock_IfBlock1) {
      /* 1 */ C_header_to_M027_TM_RBC_convers(Header_In, &tmp10);
      /* 1 */ M027_to_Radio_Track_Train_H_TM_(&tmp10, Header_Out);
    }
    else {
      kcg_copy__1_Radio_TrackTrain_He(
        Header_Out,
        (_1_Radio_TrackTrain_Header_T_Ra *) &default_header_TM_RBC_conversio);
    }
  }
  else /* ck_IfBlock2 */ if (IfBlock2_clock) {
    /* 1 */ C_header_to_M028_TM_RBC_convers(Header_In, &tmp9);
    /* 1 */ M028_to_Radio_Track_Train_H_TM_(&tmp9, Header_Out);
  }
  else /* ck_anon_activ */ if (_27_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M032_TM_RBC_convers(Header_In, &tmp8);
    /* 2 */ M032_to_Radio_Track_Train_H_TM_(&tmp8, Header_Out);
  }
  else /* ck_anon_activ */ if (_26_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M033_TM_RBC_convers(Header_In, &tmp7);
    /* 1 */ M033_to_Radio_Track_Train_H_TM_(&tmp7, Header_Out);
  }
  else /* ck_anon_activ */ if (_25_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M034_TM_RBC_convers(Header_In, &tmp6);
    /* 1 */ M034_to_Radio_Track_Train_H_TM_(&tmp6, Header_Out);
  }
  else /* ck_anon_activ */ if (_24_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M038_TM_RBC_convers(Header_In, &tmp5);
    /* 1 */ M038_to_Radio_Track_Train_H_TM_(&tmp5, Header_Out);
  }
  else /* ck_anon_activ */ if (_23_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M039_TM_RBC_convers(Header_In, &tmp4);
    /* 1 */ M039_to_Radio_Track_Train_H_TM_(&tmp4, Header_Out);
  }
  else /* ck_anon_activ */ if (_22_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M040_TM_RBC_convers(Header_In, &tmp3);
    /* 1 */ M040_to_Radio_Track_Train_H_TM_(&tmp3, Header_Out);
  }
  else /* ck_anon_activ */ if (_21_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M041_TM_RBC_convers(Header_In, &tmp2);
    /* 1 */ M041_to_Radio_Track_Train_H_TM_(&tmp2, Header_Out);
  }
  else /* ck_anon_activ */ if (_20_else_clock_IfBlock2) {
    /* 1 */ C_header_to_M043_TM_RBC_convers(Header_In, &tmp1);
    /* 1 */ M043_to_Radio_Track_Train_H_TM_(&tmp1, Header_Out);
  }
  else /* ck_anon_activ */ if (else_clock_IfBlock2) {
    /* 1 */ C_header_to_M045_TM_RBC_convers(Header_In, &tmp);
    /* 1 */ M045_to_Radio_Track_Train_H_TM_(&tmp, Header_Out);
  }
  else {
    kcg_copy__1_Radio_TrackTrain_He(
      Header_Out,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** compressed_to_Radio_Track_Train.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
