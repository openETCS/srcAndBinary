...
#include "Balise_Group_401_AmsterdamUtrec.h"

/* AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Balise_Group_401 */
void Balise_Group_401_AmsterdamUtrec(
  ...
  /* AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Balise_Group_401::BG_message_out */ CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Balise_Group_401::_L14 */
  static kcg_bool _L14;
  
  /* 1 */ Balise_Group_Init_InfraLib(TrainPos, Engineering_Data, &tmp1);
  /* 1 */
  Balise_401_0_AmsterdamUtrechtL2(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG401_header_B0_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_401_1_AmsterdamUtrechtL2(
    &tmp,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Balise_Group_401_AmsterdamUtrec.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
