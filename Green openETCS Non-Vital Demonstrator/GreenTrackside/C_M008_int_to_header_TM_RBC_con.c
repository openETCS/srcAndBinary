...
#include "C_M008_int_to_header_TM_RBC_con.h"

/* TM_RBC_conversions::C_M008_int_to_header */
void C_M008_int_to_header_TM_RBC_con(
  ...
  /* TM_RBC_conversions::C_M008_int_to_header::Message_Header_Out */ M_TrackTrain_Radio_T_TM_radio_m *Message_Header_Out)
{
  ...
  (*Message_Header_Out).field3 = (*Message_Data_in).t_train_received;
...
/* $**************** KCG Version 6.4 (build i21) ****************
** C_M008_int_to_header_TM_RBC_con.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
