...
#include "C_header_to_M028_TM_RBC_convers.h"

/* TM_RBC_conversions::C_header_to_M028 */
void C_header_to_M028_TM_RBC_convers(
  /* TM_RBC_conversions::C_header_to_M028::header_in */ M_TrackTrain_Radio_T_TM_radio_m *header_in,
  /* TM_RBC_conversions::C_header_to_M028::message_out */ M_028_T_TM_radio_messages *message_out)
{
  ...
  (*message_out).t_train_SH_request = /* 1 */
    CAST_Int_to_T_TRAIN_TM_conversi((*header_in).field3);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** C_header_to_M028_TM_RBC_convers.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
