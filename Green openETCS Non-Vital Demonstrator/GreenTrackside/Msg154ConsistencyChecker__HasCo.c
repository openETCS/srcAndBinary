...
#include "Msg154ConsistencyChecker__HasCo.h"

/* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg154ConsistencyChecker__HasConsistentHeader */
kcg_bool Msg154ConsistencyChecker__HasCo(
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg154ConsistencyChecker__HasConsistentHeader::inRadioTrainTrackHeader */ Radio_TrainTrack_Header_T_Radio *inRadioTrainTrackHeader)
{
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Msg154ConsistencyChecker__HasCo.c
** Generation date: 2015-11-10T22:49:44
*************************************************************$ */
