...
#include "Balise_411_1_AmsterdamUtrechtL2.h"

/* AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Balise_411_1 */
void Balise_411_1_AmsterdamUtrechtL2(
...
{
  /* AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Balise_411_1::_L2 */
  static kcg_bool _L2;
  /* AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Balise_411_1::_L21 */
  static kcg_int _L21;
  
  /* 1 */ Balise_Localisation_InfraLib(B_data_in, Header, PIG_nom, &_L21, &_L2);
  /* ck__L2 */ if (_L2) {
    /* 1 */ Packets_BG411_AmsterdamUtrechtL(Header, B_data_in, B_data_out);
  }
  else {
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Balise_411_1_AmsterdamUtrechtL2.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
