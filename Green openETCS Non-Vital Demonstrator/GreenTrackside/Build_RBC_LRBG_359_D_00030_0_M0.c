...
void Build_RBC_LRBG_359_D_00030_0_M0(
  ...
  /* UserStories13_16::US_13::Build_RBC_LRBG_359_D_00030_0_M003::R_data_out */ R_data_internal_T_InfraLib *R_data_out)
{
  ...
  /* 1 */
  SendRadioPackets_LRBG_359_D_000(
    &(*RadiaDataIn).packets,
    &(*R_data_out).packets);
  /* 1 */
  Send_M003_JRU_MessageLibBaselin(
    (M_003_int_T_TM_radio_messages *) &LRBG_362_D_00230_7_M003_Message,
    &(*R_data_out).message);
  (*R_data_out).message_sent = kcg_true;
}

/* $**************** KCG Version 6.4 (build i21) ****************
** Build_RBC_LRBG_359_D_00030_0_M0.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
