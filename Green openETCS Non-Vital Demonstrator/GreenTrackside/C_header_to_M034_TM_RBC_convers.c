...
#include "C_header_to_M034_TM_RBC_convers.h"

/* TM_RBC_conversions::C_header_to_M034 */
void C_header_to_M034_TM_RBC_convers(
  /* TM_RBC_conversions::C_header_to_M034::header_in */ M_TrackTrain_Radio_T_TM_radio_m *header_in,
  /* TM_RBC_conversions::C_header_to_M034::message_out */ M_034_T_TM_radio_messages *message_out)
{
  ...
  IfBlock1_clock_1 = (*header_in).field5 == INT_Q_DIR_nomiinal_TM_conversio;
  ...
  /* 1_ck_IfBlock1 */ if (IfBlock1_clock_1) {
    ...
    /* 1_ck_anon_activ */ if (_1_else_clock_1_IfBlock1) {
      ...
      else_clock_1_IfBlock1 = (*header_in).field5 ==
  ...
  (*message_out).d_tafdisplay = /* 1 */
    CAST_Int_to_D_TAFDISPLAY_TM_con((*header_in).field6);
  (*message_out).l_tafdisplay = /* 1 */
    CAST_Int_to_L_TAFDISPLAY_TM_con((*header_in).field7);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** C_header_to_M034_TM_RBC_convers.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
