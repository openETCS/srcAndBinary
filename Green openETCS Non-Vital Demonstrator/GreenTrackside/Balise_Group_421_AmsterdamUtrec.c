...
#include "Balise_Group_421_AmsterdamUtrec.h"

/* AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Balise_Group_421 */
void Balise_Group_421_AmsterdamUtrec(
  ...
  /* AmsterdamUtrechtL2::Sheet13_Breukelen_Maarssen_Balises::Balise_Group_421::BG_message_out */ CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* 1 */
  Balise_421_1_AmsterdamUtrechtL2(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG421_header_B1_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_421_0_AmsterdamUtrechtL2(
    &tmp,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Balise_Group_421_AmsterdamUtrec.c
** Generation date: 2015-11-10T22:49:43
*************************************************************$ */
