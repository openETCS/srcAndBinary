...
#include "C_P041_tracksim_compr_TM_conver.h"

/* TM_conversions::C_P041_tracksim_compr */
void C_P041_tracksim_compr_TM_conver(
  /* TM_conversions::C_P041_tracksim_compr::P041_from_track */ P041_trackside_int_T_TM *P041_from_track,
  /* TM_conversions::C_P041_tracksim_compr::Header */ MetadataElement_T_Common_Types_ *Header,
  /* TM_conversions::C_P041_tracksim_compr::P005_compressed */ CompressedPacketData_T_Common_T *P005_compressed)
{
  /* TM_conversions::C_P041_tracksim_compr */
  static P041_OBU_sectionlist_int_T_TM tmp;
  ...
  (*Header).endAddress = /* 1 */
    T_DeterminePacketSizeInt_TM_lib((*P041_from_track).N_ITER, 5 + 1 + 3, 3) -
    1;
  (&(&(&(*P005_compressed)[0])[0])[5])[0] = (*P041_from_track).N_ITER;
  kcg_copy_P041_trackide_sectionl(&tmp[1], &(*P041_from_track).SECTIONS);
  /* 1 */
  C_P041_flatten_sections_TM_lib_(
    &tmp,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** C_P041_tracksim_compr_TM_conver.c
** Generation date: 2015-11-10T22:49:42
*************************************************************$ */
