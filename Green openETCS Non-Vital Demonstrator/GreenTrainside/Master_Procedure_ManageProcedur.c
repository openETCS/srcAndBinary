  ...
  outC_Master_Procedure_ManagePro *outC)
{
  ...
  static _194_SSM_ST_SM1 SM1_state_sel;
  /* ManageProcedure_Pkg::Master_Procedure::SM1 */
  static _194_SSM_ST_SM1 SM1_state_act;
  /* ManageProcedure_Pkg::Master_Procedure::SM1 */
  static _196_SSM_TR_SM1 SM1_fired_strong;
  ...
  /* sel_SM1 */ switch (SM1_state_sel) {
    case SSM_st_SoM_NTC_SN_SM1 :
      ...
      SM1_fired_strong = _195_SSM_TR_no_trans_SM1;
