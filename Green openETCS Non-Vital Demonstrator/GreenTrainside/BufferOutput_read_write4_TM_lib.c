  ...
  /* TM_lib_internal::BufferOutput_read_write4::Message_out */ M_TrainTrack_Message_T_TM_radio *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_98996(&(*Buffer_Out)[0], (array_98996 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_99328(&(*Buffer_Out)[0], (array_99328 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_100226(&(*Buffer_Out)[4], (array_100226 *) &(*Buffer_In)[0]);
