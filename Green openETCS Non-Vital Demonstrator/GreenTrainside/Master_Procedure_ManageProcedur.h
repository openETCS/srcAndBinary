...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  struct_99451 /* ManageProcedure_Pkg::Master_Procedure */ _2_fby_ck_fby;
  struct_99451 /* ManageProcedure_Pkg::Master_Procedure */ fby_ck_fby;
  ...
  _194_SSM_ST_SM1 /* ManageProcedure_Pkg::Master_Procedure::SM1 */ SM1_state_nxt;
