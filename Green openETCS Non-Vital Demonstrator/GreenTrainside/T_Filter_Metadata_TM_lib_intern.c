...
kcg_bool T_Filter_Metadata_TM_lib_intern(
  ...
  /* TM_lib_internal::T_Filter_Metadata::F_id */ kcg_bool F_id)
{
  ...
  /* 1 */
  T_Decode_metadata_new_TM_lib_in(Metadata_from_track, &_L3, &_L4, &_L6);
  /* 2 */
  T_Decode_metadata_new_TM_lib_in(Metadata_looked_for, &_L7, &_L8, &_L10);
  data_match = (_L3 == _L7) & /* 1 */
    T_Filter_Metadata_Element_TM_li(_L4, _L8, F_id) & /* 3 */
    T_Filter_Metadata_Element_TM_li(_L6, _L10, F_version);
  return data_match;
}

/* $**************** KCG Version 6.4 (build i21) ****************
** T_Filter_Metadata_TM_lib_intern.c
** Generation date: 2015-11-10T23:01:10
*************************************************************$ */
