...
#include "_207_MA_Convert_P15_to_Distance.h"

/* TA_MA::MA_Convert_P15_to_DistanceProfile */
void _207_MA_Convert_P15_to_Distance(
  ...
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::MovementAuthority */ MovementAuthority_t_TrackAtlasT *MovementAuthority)
{
  /* TA_MA::MA_Convert_P15_to_DistanceProfile */
  ...
  kcg_copy_AccuDistanceProfileMA_(
    &_L77,
    (AccuDistanceProfileMA_TA_MA *) &DEFAULT_AccuDistanceProfileMA_T);
  /* 1 */ for (i = 0; i < 10; i++) {
...
/* $**************** KCG Version 6.4 (build i21) ****************
** _207_MA_Convert_P15_to_Distance.c
** Generation date: 2015-11-10T23:01:11
*************************************************************$ */
