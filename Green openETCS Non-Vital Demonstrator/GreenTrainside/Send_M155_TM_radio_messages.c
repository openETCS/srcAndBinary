...
void Send_M155_init_TM_radio_message(outC_Send_M155_TM_radio_message *outC)
{
  static kcg_int i1;
  static kcg_int i;
...
void Send_M155_reset_TM_radio_messag(outC_Send_M155_TM_radio_message *outC)
{
  ...
  outC_Send_M155_TM_radio_message *outC)
{
  ...
  /* 1 */ C_M155_to_header_TM_RBC_convers(Message_155_in, &tmp);
  for (i = 0; i < 50; i++) {
    _L8[i] = 0;
  }
