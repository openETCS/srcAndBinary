  ...
  /* TM_lib_internal::BufferOutput_read_write3::Message_out */ M_TrainTrack_Message_T_TM_radio *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_98720(&(*Buffer_Out)[0], (array_98720 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_98996(&(*Buffer_Out)[0], (array_98996 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_101721(&(*Buffer_Out)[3], (array_101721 *) &(*Buffer_In)[0]);
