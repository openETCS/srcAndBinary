...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  array__30249 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_AcklMSG::queue */ queue;
  ...
  outC_MSGQueueController_DMI_Control_Pkg_Sub_func_TextMessages /* 1 */ _1_Context_1;
  outC_FIFO_Insert_Op_Normal_DMI_Control_Pkg_Sub_func_TextMessages /* 1 */ Context_1;
