  ...
  outC_TextMessagesDipatcher_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::hh_local_array */ array_real_5 last_hh_local_array;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::Local_isEmpty */ kcg_bool last_Local_isEmpty;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::mm_local_array */ array_real_5 last_mm_local_array;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::Local_ack_empty */ kcg_bool last_Local_ack_empty;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::Local_NormaliMsgQueue */ array__30249 last_Local_NormaliMsgQueue;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::numNormalMsg */ kcg_int last_numNormalMsg;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::Local_AckMsgQueue */ array__30249 last_Local_AckMsgQueue;
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::mm_array */ array_real_5 last_mm_array;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::hh_array */ array_real_5 last_hh_array;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::NumAckMsg */ kcg_int last_NumAckMsg;
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::MsgQueue */ array__30249 last_MsgQueue;
  /* DMI_Control_Pkg::Sub_func::TextMessages::TextMessagesDipatcher::AckMsgQueue */ array__30249 last_AckMsgQueue;
  ...
  if (outC->init) {
    ...
    kcg_copy_array_real_5(&last_hh_local_array, &outC->hh_local_array);
    last_Local_isEmpty = outC->Local_isEmpty;
    kcg_copy_array_real_5(&last_mm_local_array, &outC->mm_local_array);
    last_Local_ack_empty = outC->Local_ack_empty;
    kcg_copy_array__30249(
      &last_Local_NormaliMsgQueue,
      &outC->Local_NormaliMsgQueue);
    last_numNormalMsg = outC->numNormalMsg;
    kcg_copy_array__30249(&last_Local_AckMsgQueue, &outC->Local_AckMsgQueue);
    ...
    last_NumE = outC->NumE;
    kcg_copy_array__30249(&last_MsgQueue, &outC->MsgQueue);
    kcg_copy_array__30249(&last_AckMsgQueue, &outC->AckMsgQueue);
  }
  /* 1 */
  ...
  if (AckMsg) {
    ...
    MSGQueue_AcklMSG_DMI_Control_Pkg_Sub_func_TextMessages(
      ...
      last_numAckMsg,
      &outC->Context_3);
    kcg_copy_array__30249(&outC->AckMsgQueue, &last_AckMsgQueue);
    kcg_copy_array__30249(&outC->MsgQueue, &last_MsgQueue);
    outC->NumE = last_NumE;
    outC->AckisEmpty = last_AckisEmpty;
    outC->isEmpty = _L14;
    outC->NumAckMsg = last_NumAckMsg;
    kcg_copy_array_real_5(&outC->hh_array, &last_hh_array);
    kcg_copy_array_real_5(&outC->mm_array, &last_mm_array);
    ...
    kcg_copy_array__30249(&outC->Local_AckMsgQueue, &outC->Context_3.queue);
    outC->numNormalMsg = last_numNormalMsg;
    kcg_copy_array__30249(
      &outC->Local_NormaliMsgQueue,
      &last_Local_NormaliMsgQueue);
    outC->Local_ack_empty = outC->Context_3.AckisEmpty;
    kcg_copy_array_real_5(&outC->mm_local_array, &last_mm_local_array);
    outC->Local_isEmpty = last_Local_isEmpty;
    kcg_copy_array_real_5(&outC->hh_local_array, &last_hh_local_array);
  }
  else {
    ...
    if (else_clock_IfBlock5) {
      ...
      kcg_copy_array_real_5(
        ...
        &last_hh_local_array_ack);
      kcg_copy_array__30249(&outC->Local_AckMsgQueue, &last_Local_AckMsgQueue);
      outC->numNormalMsg = outC->Context_1.NumE;
      kcg_copy_array__30249(
        &outC->Local_NormaliMsgQueue,
        &outC->Context_1.queue);
      outC->Local_ack_empty = last_Local_ack_empty;
      kcg_copy_array_real_5(&outC->mm_local_array, &outC->Context_1.mm_array);
      outC->Local_isEmpty = outC->Context_1.isEmpty;
      kcg_copy_array_real_5(&outC->hh_local_array, &outC->Context_1.hh_array);
    }
    else {
      /* 1 */
      ...
      kcg_copy_array__30249(&outC->AckMsgQueue, &outC->Local_AckMsgQueue);
      kcg_copy_array__30249(&outC->MsgQueue, &outC->Local_NormaliMsgQueue);
      ...
      kcg_copy_array_real_5(&outC->hh_array, &outC->hh_local_array);
      kcg_copy_array_real_5(&outC->mm_array, &outC->mm_local_array);
