...
void DeleteAckMsg_DMI_Control_Pkg_Sub_func_TextMessages(
  /* DMI_Control_Pkg::Sub_func::TextMessages::DeleteAckMsg::localQueue */array__30249 *localQueue,
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::DeleteAckMsg::queue */array__30249 *queue,
...
{
  /* DMI_Control_Pkg::Sub_func::TextMessages::DeleteAckMsg::_L30 */ array_real_5 _L30;
  /* DMI_Control_Pkg::Sub_func::TextMessages::DeleteAckMsg::_L31 */ array_real_5 _L31;
  ...
  FIFO_delete_time_DMI_Control_Pkg_Sub_func_TextMessages(
    ...
    &_L31);
  if (Delete) {
    kcg_copy_array_real_5(new_hh, &_L31);
    *NumE = local_num_ack - 1;
    kcg_copy_array_real_5(new_mm, &_L30);
    /* 1 */
    FIFO_Delete_Op_DMI_Control_Pkg_Sub_func_TextMessages(0, localQueue, queue);
  }
  else {
    kcg_copy_array_real_5(new_hh, hh_array);
    *NumE = local_num_ack;
    kcg_copy_array_real_5(new_mm, mm_array);
    kcg_copy_array__30249(queue, localQueue);
  }
  if (local_ack_empty) {
