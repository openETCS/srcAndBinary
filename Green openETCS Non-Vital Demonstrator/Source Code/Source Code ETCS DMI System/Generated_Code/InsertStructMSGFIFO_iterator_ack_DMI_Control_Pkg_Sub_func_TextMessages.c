...
void InsertStructMSGFIFO_iterator_ack_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::InsertStructMSGFIFO_iterator_ack::acc */array__31749 *acc,
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::InsertStructMSGFIFO_iterator_ack::OutputArray */array__31749 *OutputArray)
{
  MsgStructure tmp;
  ...
  _L4 = index == Position;
  if (_L4 & !isFull) {
    kcg_copy_array__31749(OutputArray, acc);
    if ((0 <= index) & (index < 5)) {
