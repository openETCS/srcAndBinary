...
typedef struct {
  ...
  array__30249 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::queue */ queue;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::mm_array */ mm_array;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::hh_array */ hh_array;
  /* -----------------------  no local probes  ----------------------- */
  ...
  array__30249 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::impQueue */ impQueue;
  array__30249 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::auxiQueue */ auxiQueue;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_mm_array_imp */ Local_mm_array_imp;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_hh_array_imp */ Local_hh_array_imp;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_hh_array_auxi */ Local_hh_array_auxi;
  array_real_5 /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_mm_array_auxi */ Local_mm_array_auxi;
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_TimeCounter_DMI_Control_Pkg_Sub_func_TextMessages /* 1 */ _1_Context_1;
  outC_MSGQueueController_DMI_Control_Pkg_Sub_func_TextMessages /* 3 */ Context_3;
  outC_MSGQueueController_DMI_Control_Pkg_Sub_func_TextMessages /* 2 */ Context_2;
  ...
  outC_MSGQueueController_DMI_Control_Pkg_Sub_func_TextMessages /* 1 */ Context_1;
