  ...
  outC_MSGQueue_normalMSG_DMI_Control_Pkg_Sub_func_TextMessages *outC)
{
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_mm_array_auxi */ array_real_5 last_Local_mm_array_auxi;
  /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_hh_array_auxi */ array_real_5 last_Local_hh_array_auxi;
  /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_hh_array_imp */ array_real_5 last_Local_hh_array_imp;
  /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::Local_mm_array_imp */ array_real_5 last_Local_mm_array_imp;
  /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::auxiQueue */ array__30249 last_auxiQueue;
  /* DMI_Control_Pkg::Sub_func::TextMessages::MSGQueue_normalMSG::impQueue */ array__30249 last_impQueue;
  ...
  if (outC->init) {
    ...
    kcg_copy_array_real_5(&last_Local_hh_array_imp, &outC->Local_hh_array_imp);
    kcg_copy_array_real_5(&last_Local_mm_array_imp, &outC->Local_mm_array_imp);
    kcg_copy_array__30249(&last_auxiQueue, &outC->auxiQueue);
    kcg_copy_array__30249(&last_impQueue, &outC->impQueue);
    _L13 = outC->isFull;
    tmp1 = outC->NumAuxi;
  }
  /* 1 */
  ...
  if (ins) {
    if (IfBlock1_clock_OperationQueue_IfBlock) {
      ...
      FIFO_Insert_Op_Normal_DMI_Control_Pkg_Sub_func_TextMessages(
        ...
        _L13,
        &outC->Context_25);
      kcg_copy_array__30249(&outC->impQueue, &outC->Context_25.queue);
      kcg_copy_array__30249(&outC->auxiQueue, &last_auxiQueue);
      kcg_copy_array_real_5(
      ...
      FIFO_Insert_Op_Normal_DMI_Control_Pkg_Sub_func_TextMessages(
        ...
        _L13,
        &outC->Context_24);
      kcg_copy_array__30249(&outC->impQueue, &last_impQueue);
      kcg_copy_array__30249(&outC->auxiQueue, &outC->Context_24.queue);
      kcg_copy_array_real_5(
        &outC->Local_mm_array_imp,
        &last_Local_mm_array_imp);
      kcg_copy_array_real_5(
    ...
    kcg_copy_array__30249(&outC->impQueue, &last_impQueue);
    kcg_copy_array__30249(&outC->auxiQueue, &last_auxiQueue);
    kcg_copy_array_real_5(&outC->Local_mm_array_imp, &last_Local_mm_array_imp);
    kcg_copy_array_real_5(&outC->Local_hh_array_imp, &last_Local_hh_array_imp);
    kcg_copy_array_real_5(
      &outC->Local_hh_array_auxi,
      &last_Local_hh_array_auxi);
    kcg_copy_array_real_5(
