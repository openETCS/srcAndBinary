...
void InsertStructMSGFIFO_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::InsertStructMSGFIFO_iterator_normal::acc */array__31757 *acc,
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::InsertStructMSGFIFO_iterator_normal::OutputArray */array__31757 *OutputArray)
{
  MsgStructure tmp;
