...
void InsertStructMSGFIFO_iterator_normal_DMI_Control_Pkg_Sub_func_TextMessages(
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::InsertStructMSGFIFO_iterator_normal::acc */array__30249 *acc,
  ...
  /* DMI_Control_Pkg::Sub_func::TextMessages::InsertStructMSGFIFO_iterator_normal::OutputArray */array__30249 *OutputArray)
{
  MsgStructure tmp;
