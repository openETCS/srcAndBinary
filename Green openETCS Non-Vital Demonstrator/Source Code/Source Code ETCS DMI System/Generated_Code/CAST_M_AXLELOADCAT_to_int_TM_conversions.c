...
{
  /* TM_conversions::CAST_M_AXLELOADCAT_to_int::IfBlock1::else */ kcg_bool _10_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_AXLELOADCAT_to_int::IfBlock1::else::else::else */ kcg_bool _8_else_clock_IfBlock1;
  ...
  /* TM_conversions::CAST_M_AXLELOADCAT_to_int::IfBlock1::else::else::else::else */ kcg_bool _7_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_AXLELOADCAT_to_int::IfBlock1::else::else */ kcg_bool _9_else_clock_IfBlock1;
                  ...
                  if (_3_else_clock_IfBlock1) {
                    ...
                    if (_2_else_clock_IfBlock1) {
                      ...
                      if (_1_else_clock_IfBlock1) {
                        m_axleloadcat_int = INT_M_AXLELOADCAT_E5_TM_conversions;
                      }
                      else {
