...
void ConvertPackets_RBC_Model_Pkg_TrainTrackMsgConversion(
  ...
  outC_ConvertPackets_RBC_Model_Pkg_TrainTrackMsgConversion *outC)
{
  P000_TM_TrainToTrack tmp6;
  P001_TM_TrainToTrack tmp5;
  P003_TM_TrainToTrack tmp4;
  P004_TM_TrainToTrack tmp3;
  P005_TM_TrainToTrack tmp2;
  P009_TM_TrainToTrack tmp1;
  P011_TM_TrainToTrack tmp;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertPackets::Det_if_P003 */ kcg_bool Det_if_P003_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertPackets::Det_if_P004 */ kcg_bool Det_if_P004_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertPackets::Det_if_P009 */ kcg_bool Det_if_P009_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertPackets::Det_if_P011 */ kcg_bool Det_if_P011_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertPackets::P0_or_P1 */ P000_TrainTrack_int_TM_TrainToTrack P0_or_P1;
