  ...
  outC_RBC__ProcessGeneralMessage_RBC_Model_Pkg *outC)
{
  ...
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::GENERAL_MESSAGE_SM::AWAIT_ACKNOWLEDGEMENT::_L3 */ Radio_TrackTrain_Header_T_TM _L3_GENERAL_MESSAGE_SM_AWAIT_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::GENERAL_MESSAGE_SM::TRY_PROCESS_ACKNOWLEDGEMENT::_L23 */ Radio_TrackTrain_Header_T_TM _L23_GENERAL_MESSAGE_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::GENERAL_MESSAGE_SM::TRY_PROCESS_ACKNOWLEDGEMENT::IfBlock1 */ kcg_bool IfBlock1_clock_GENERAL_MESSAGE_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::invalidAck */ kcg_bool last_invalidAck;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::radioTrackTrainMessageWasSentTimestamp */ T_TRAIN last_radioTrackTrainMessageWasSentTimestamp;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::ackRequired */ kcg_bool last_ackRequired;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::GENERAL_MESSAGE_SM */ SSM_ST_GENERAL_MESSAGE_SM GENERAL_MESSAGE_SM_state_sel;
  /* RBC_Model_Pkg::RBC__ProcessGeneralMessage::GENERAL_MESSAGE_SM */ SSM_ST_GENERAL_MESSAGE_SM GENERAL_MESSAGE_SM_state_act;
