...
void Balise_Group_389_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  ...
  /* AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Balise_Group_389::TrainPos */kcg_real TrainPos,
  ...
  /* AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Balise_Group_389::BG_message_out */CompressedBaliseMessage_TM *BG_message_out)
{
  B_data_internal_T_InfraLib tmp1;
  B_data_internal_T_InfraLib tmp;
  /* AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Balise_Group_389::_L14 */ kcg_bool _L14;
  
  /* 1 */ Balise_Group_Init_InfraLib(TrainPos, Engineering_Data, &tmp1);
  /* 1 */
  Balise_389_1_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG389_header_B1_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_389_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &tmp,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_389_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises.c
** Generation date: 2015-11-10T18:22:10
*************************************************************$ */
