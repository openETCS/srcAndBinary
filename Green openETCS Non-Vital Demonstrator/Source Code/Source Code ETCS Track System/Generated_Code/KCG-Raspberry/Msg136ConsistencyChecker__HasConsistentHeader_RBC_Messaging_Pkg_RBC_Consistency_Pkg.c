...
{
  /* RBC_Messaging_Pkg::RBC_Consistency_Pkg::Msg136ConsistencyChecker__HasConsistentHeader::outIsConsistent */ kcg_bool outIsConsistent;
  
  outIsConsistent = (/* 1 */
      RadioTrainTrackHeader__Get_T_TRAIN_Ref_RBC_Messaging_Pkg_RBC_RadioTrainTrack_Pkg(
        inRadioTrainTrackHeader) == T_TRAIN_DEFAULT) & (/* 1 */
