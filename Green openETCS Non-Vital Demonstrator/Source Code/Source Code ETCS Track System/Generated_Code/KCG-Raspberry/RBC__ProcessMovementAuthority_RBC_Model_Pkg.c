...
void RBC__ProcessMovementAuthority_RBC_Model_Pkg(
  ...
  outC_RBC__ProcessMovementAuthority_RBC_Model_Pkg *outC)
{
  RadioTrackTrainMessageQueueEntry_T tmp8;
  PosData_T tmp7;
  PosData_T tmp6;
  PosData_T tmp5;
  PosData_T tmp4;
  NID_MESSAGE tmp3;
  T_TRAIN tmp2;
  Radio_TrainTrack_Header_T_Radio_Types_Pkg tmp1;
  NID_MESSAGE tmp;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM::SEND_MA::IfBlock1 */ kcg_bool IfBlock1_clock_MOVEMENT_AUTHORITY_SM_SEND_MA;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM::AWAIT_ACKNOWLEDGEMENT::_L3 */ Radio_TrackTrain_Header_T_TM _L3_MOVEMENT_AUTHORITY_SM_AWAIT_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM::TRY_PROCESS_ACKNOWLEDGEMENT::_L19 */ Radio_TrackTrain_Header_T_TM _L19_MOVEMENT_AUTHORITY_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM::TRY_PROCESS_ACKNOWLEDGEMENT::IfBlock1 */ kcg_bool IfBlock1_clock_MOVEMENT_AUTHORITY_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::radioTrackTrainMessageWasSentTimestamp */ T_TRAIN last_radioTrackTrainMessageWasSentTimestamp;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM */ SSM_ST_MOVEMENT_AUTHORITY_SM MOVEMENT_AUTHORITY_SM_state_sel;
  /* RBC_Model_Pkg::RBC__ProcessMovementAuthority::MOVEMENT_AUTHORITY_SM */ SSM_ST_MOVEMENT_AUTHORITY_SM MOVEMENT_AUTHORITY_SM_state_act;
