...
void RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg(
  ...
  outC_RadioTrackTrainMessageTrigger__Trigger_RBC_Scenario_Pkg *outC)
{
  /* RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger::IfBlock1::then::IfBlock3 */ kcg_bool IfBlock3_clock_IfBlock1;
  /* RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger::referenceTime */ T_TRAIN last_referenceTime;
  /* RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger::setReferenceTime */ kcg_bool last_setReferenceTime;
  /* RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger::valid */ kcg_bool last_valid;
  /* RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* RBC_Scenario_Pkg::RadioTrackTrainMessageTrigger__Trigger::activatorTimeout */ T_TRAIN activatorTimeout;
