...
{
  PT0_PositionReport_T_Packet_TrainTypes_Pkg tmp2;
  kcg_bool tmp1;
  PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg tmp;
  /* RBC_Session_Pkg::PosData__Update::validPacket0 */ kcg_bool validPacket0;
  /* RBC_Session_Pkg::PosData__Update::_L2 */ outPackets_T_Common_Types_Pkg _L2;
