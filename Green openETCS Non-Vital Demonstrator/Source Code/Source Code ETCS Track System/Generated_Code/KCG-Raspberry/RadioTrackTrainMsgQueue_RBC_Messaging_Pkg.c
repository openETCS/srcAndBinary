...
{
  Radio_TrackTrain_Header_T_TM tmp2;
  Radio_TrackTrain_Header_T_TM tmp1;
  T_TRAIN tmp;
  /* RBC_Messaging_Pkg::RadioTrackTrainMsgQueue::IfBlock1::then::_L35 */ RadioTrackTrainMessageQueueEntry_T _L35_IfBlock1;
  /* RBC_Messaging_Pkg::RadioTrackTrainMsgQueue::IfBlock1::then::_L34 */ RadioTrackTrainMessageQueue_T _L34_IfBlock1;
  /* RBC_Messaging_Pkg::RadioTrackTrainMsgQueue::IfBlock1::then::_L36 */ CompressedRadioMessage_TM _L36_IfBlock1;
  /* RBC_Messaging_Pkg::RadioTrackTrainMsgQueue::IfBlock1 */ kcg_bool IfBlock1_clock;
