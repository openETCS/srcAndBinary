...
{
  kcg_bool tmp;
  /* RBC_SendMergeRadio_Pkg::SEND_MergeRadioPackets::RadioMessagePackets_1_2 */ CompressedPackets_T_Common_Types_Pkg RadioMessagePackets_1_2;
  /* RBC_SendMergeRadio_Pkg::SEND_MergeRadioPackets::_L24 */ CompressedPackets_T_Common_Types_Pkg _L24;
