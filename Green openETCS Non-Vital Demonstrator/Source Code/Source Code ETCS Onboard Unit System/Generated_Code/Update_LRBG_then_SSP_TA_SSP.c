  ...
  /* TA_SSP::Update_LRBG_then_SSP::new_profile_out */SSP_cat_t_TA_MRSP *new_profile_out)
{
  ...
  /* TA_SSP::Update_LRBG_then_SSP::_L9 */
  static SSP_cat_t_TA_MRSP _L9;
  /* TA_SSP::Update_LRBG_then_SSP::_L10 */
  static V_internal_Type_Obu_BasicTypes_Pkg _L10;
  /* TA_SSP::Update_LRBG_then_SSP::_L11 */
  static SSP_section_t_TA_MRSP _L11;
  /* TA_SSP::Update_LRBG_then_SSP::_L12 */
  static SSP_section_t_TA_MRSP _L12;
