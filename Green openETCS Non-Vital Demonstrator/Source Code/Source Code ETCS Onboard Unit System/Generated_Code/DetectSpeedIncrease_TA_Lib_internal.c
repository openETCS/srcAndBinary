...
{
  static V_internal_Type_Obu_BasicTypes_Pkg tmp1;
  static P027V1_section_enum_T_TM_baseline2 tmp;
  /* TA_Lib_internal::DetectSpeedIncrease::q_speed_increase */
  static kcg_bool q_speed_increase;
