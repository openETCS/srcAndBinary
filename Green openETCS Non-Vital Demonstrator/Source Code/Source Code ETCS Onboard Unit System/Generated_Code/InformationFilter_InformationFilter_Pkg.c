  ...
  outC_InformationFilter_InformationFilter_Pkg *outC)
{
  ...
  outC->_L39.BG_Common_Header.m_version =
  ...
  outC->_L39.BG_Common_Header.BG_centerDetectionInaccuraccuracies.nominal = 0;
  outC->_L39.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_min = 0;
  outC->_L39.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max = 0;
  outC->_L39.BG_Common_Header.q_nvlocacc = 0;
  outC->_L39.BG_Common_Header.noCoordinateSystemHasBeenAssigned = kcg_true;
  ...
  outC->_L39.Radio_Common_Header.t_train = 0.0;
  outC->_L39.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_required;
  outC->_L39.Radio_Common_Header.nid_lrbg = 0;
  outC->_L39.Radio_Common_Header.t_train_reference = 0.0;
  ...
  outC->_L39.Radio_Common_Header.t_sh_rqst = 0.0;
  ...
  outC->_L39.Radio_Common_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  for (i = 0; i < 30; i++) {
  ...
  outC->_L37.BG_Common_Header.bgPosition.motionDirection =
    unknownDirection_Obu_BasicTypes_Pkg;
  outC->_L37.BG_Common_Header.BG_centerDetectionInaccuraccuracies.nominal = 0;
  outC->_L37.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_min = 0;
  outC->_L37.BG_Common_Header.BG_centerDetectionInaccuraccuracies.d_max = 0;
  ...
  outC->_L37.Radio_Common_Header.t_sh_rqst = 0.0;
  ...
  /* 2 */ TransitionBuffer_init_InformationFilter_Pkg_Common(&outC->Context_2);
  /* 1 */
  RbcTransitionEffective_init_InformationFilter_Pkg(&outC->_3_Context_1);
  /* 1 */
  TransitionBuffer_init_InformationFilter_Pkg_Common(&outC->_2_Context_1);
  /* 1 */
  LevelTransitionEffective_init_InformationFilter_Pkg(&outC->_1_Context_1);
  /* 1 */ MessageBuffer_init_InformationFilter_Pkg(&outC->Context_1);
}
  ...
  outC_InformationFilter_InformationFilter_Pkg *outC)
{
  ...
  /* 1 */
  TransitionBuffer_reset_InformationFilter_Pkg_Common(&outC->_2_Context_1);
  /* 1 */
  ...
  outC_InformationFilter_InformationFilter_Pkg *outC)
{
  ...
  /* fby_1_init_5 */ if (outC->init) {
    ...
    kcg_copy_ReceivedMessage_T_Common_Types_Pkg(&tmp1, &outC->_L37);
    _L59 = outC->_L38;
    kcg_copy_ReceivedMessage_T_Common_Types_Pkg(&_L10, &outC->_L39);
    _L11 = outC->_L40;
  }
  /* 1 */
