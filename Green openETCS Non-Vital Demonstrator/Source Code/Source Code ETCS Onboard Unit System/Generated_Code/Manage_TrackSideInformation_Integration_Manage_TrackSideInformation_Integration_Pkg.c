  ...
  outC_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg *outC)
{
  ...
  outC->outputMessageForRadioAck.Radio_Common_Header.t_train = 0.0;
  ...
  outC->outputMessageForRadioAck.Radio_Common_Header.t_train_reference = 0.0;
  ...
  outC->outputMessageForRadioAck.Radio_Common_Header.t_sh_rqst = 0.0;
