...
void Output_Mode_Level_To_Use_init_O(outC_Output_Mode_Level_To_Use_O *outC)
{
  outC->init = kcg_true;
...
void Output_Mode_Level_To_Use_reset_(outC_Output_Mode_Level_To_Use_O *outC)
{
  outC->init = kcg_true;
}
...
void Output_Mode_Level_To_Use_Output(
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Output_Mode_Level_To_Use_Output.c
** Generation date: 2015-11-03T13:50:14
*************************************************************$ */
