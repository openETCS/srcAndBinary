...
void InputTrackManagement_Interfaces(
  /* Interfaces::InputTrackManagement::Data_From_Track */T_Data_From_Track_Level_And_Mode_Types_Pkg *Data_From_Track,
  ...
  /* Interfaces::InputTrackManagement::Error_BG_System_Version */kcg_bool *Error_BG_System_Version,
  /* Interfaces::InputTrackManagement::Linking_Reaction_To_Trip */kcg_bool *Linking_Reaction_To_Trip,
  ...
  /* Interfaces::InputTrackManagement::T_NVCONTACT_Overpass */kcg_bool *T_NVCONTACT_Overpass,
  /* Interfaces::InputTrackManagement::Emergency_Stop_Message_Received */kcg_bool *Emergency_Stop_Message_Received)
{
  ...
  *T_NVCONTACT_Overpass = (*Data_From_Track).T_NVCONTACT_Overpass;
  ...
  *Linking_Reaction_To_Trip = (*Data_From_Track).Linking_Reaction_To_Trip;
  *Error_BG_System_Version = (*Data_From_Track).Error_BG_System_Version;
  ...
  *Shunting_Granted_By_RBC = (*Data_From_Track).Shunting_granted_By_RBC;
  kcg_copy_T_Mode_Profile_Level_And_Mode_Types_Pkg(
    ...
    &(*Data_From_Track).Mode_Profile_On_Board);
