...
void distanceLastMSG_init_xdebugSupp(outC_distanceLastMSG_xdebugSupp *outC)
{
  outC->init = kcg_true;
  outC->MSGLocation = 0;
  outC->lastLRBG = 0;
...
void distanceLastMSG_reset_xdebugSup(outC_distanceLastMSG_xdebugSupp *outC)
{
  outC->init = kcg_true;
}
...
void distanceLastMSG_xdebugSupport_P(
  ...
  outC_distanceLastMSG_xdebugSupp *outC)
{
  ...
  static L_internal_Type_Obu_BasicTypes_ last_MSGLocation;
  ...
  /* ck__L11 */ if (_L11) {
    tmp = /* 1 */ countPacketsMsg_xdebugSupport_P(msg);
  }
  else {
    tmp = 0;
  }
...
/* $**************** KCG Version 6.4 (build i21) ****************
** distanceLastMSG_xdebugSupport_P.c
** Generation date: 2015-11-03T13:50:15
*************************************************************$ */
