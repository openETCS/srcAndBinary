  ...
  outC_managementOfRadioCommunication_MoRC_Pck *outC)
{
  ...
  /* 5 */ EitherEdge_init_digital(&outC->Context_5);
  /* 4 */ EitherEdge_init_digital(&outC->Context_4);
  /* 3 */ EitherEdge_init_digital(&outC->Context_3);
  /* 2 */ EitherEdge_init_digital(&outC->_12_Context_2);
  /* 1 */ EitherEdge_init_digital(&outC->_11_Context_1);
  /* 1 */
  safeRadioConnectionIndication_init_MoRC_Pck_Subfunc_Pkg(&outC->_10_Context_1);
  /* 2 */ RisingEdge_init_digital(&outC->_9_Context_2);
  /* 2 */ FallingEdge_init_digital(&outC->_8_Context_2);
  /* 1 */ RisingEdge_init_digital(&outC->_7_Context_1);
  /* 1 */
  ...
  /* 1 */ FallingEdge_init_digital(&outC->_4_Context_1);
  /* 1 */ initiate_a_Session_init_MoRC_Pck_Subfunc_Pkg(&outC->_3_Context_1);
  /* 1 */
  terminating_a_CommunicationSession_init_MoRC_Pck_Subfunc_Pkg(
    &outC->_2_Context_1);
  /* 2 */ establish_a_Session_init_MoRC_Pck_Subfunc_Pkg(&outC->Context_2);
  /* 1 */
  terminateAndEstablishSession_init_MoRC_Pck_Subfunc_Pkg(&outC->_1_Context_1);
  /* 1 */ maintaining_a_Session_init_MoRC_Pck_Subfunc_Pkg(&outC->Context_1);
}
  ...
  outC_managementOfRadioCommunication_MoRC_Pck *outC)
{
  ...
  /* MoRC_Pck::managementOfRadioCommunication::CommunicationSession_SM::Maintaining::_L2 */
  static kcg_bool _L2_CommunicationSession_SM_Maintaining;
  /* MoRC_Pck::managementOfRadioCommunication::CommunicationSession_SM::Maintaining::_L3 */
  static kcg_bool _L3_CommunicationSession_SM_Maintaining;
  ...
  /* MoRC_Pck::managementOfRadioCommunication::communicationSessionInitiatedFromTrackside */
  static kcg_bool last_communicationSessionInitiatedFromTrackside;
  /* MoRC_Pck::managementOfRadioCommunication::communicationSessionInitiatedByOBU */
  static kcg_bool last_communicationSessionInitiatedByOBU;
  /* MoRC_Pck::managementOfRadioCommunication::sessionEstablished */
  static kcg_bool last_sessionEstablished;
  /* MoRC_Pck::managementOfRadioCommunication::sessionSuccessfullyEstablished */
  static kcg_bool last_sessionSuccessfullyEstablished;
  ...
  /* MoRC_Pck::managementOfRadioCommunication::CommunicationSession_SM */
  static kcg_bool CommunicationSession_SM_reset_sel;
  /* MoRC_Pck::managementOfRadioCommunication::initiateTermination */
  static kcg_bool initiateTermination;
  ...
  /* last_init_ck_finalAttemptToSetupTheSafeRadioConnectionFailed */ if (outC->init) {
  ...
  /* act_CommunicationSession_SM */ switch (CommunicationSession_SM_state_act) {
  ...
  /* act_CommunicationSession_SM */ switch (CommunicationSession_SM_state_act) {
    case SSM_st_Terminating_CommunicationSession_SM :
      ...
      /* 3 */ if (outC->_2_Context_1.requestReleaseOfSafeRadioConnectionWithTrackside) {
      ...
      /* ck__L12 */ if (outC->_2_Context_1.communicationSessionTerminated) {
        outC->CommunicationSession_SM_state_nxt =
          SSM_st_NoSession_CommunicationSession_SM;
        tmp = kcg_true;
      }
    ...
    case SSM_st_Maintaining_CommunicationSession_SM :
      ...
      /* 2 */ if (_L5_CommunicationSession_SM_Maintaining) {
        kcg_copy_mobileSWCmd_Type_MoRC_Pck(
          &tmp1,
          (mobileSWCmd_Type_MoRC_Pck *)
            &cTerminateSafeRadioConnectionCmd_MoRC_Pck);
      }
      else /* 1 */ if (_L1_CommunicationSession_SM_Maintaining) {
        kcg_copy_mobileSWCmd_Type_MoRC_Pck(
          &tmp1,
          (mobileSWCmd_Type_MoRC_Pck *)
      ...
      /* guard_Maintaining */ if (initiateTermination) {
        outC->CommunicationSession_SM_state_nxt =
          SSM_st_Terminating_CommunicationSession_SM;
        tmp = kcg_true;
      }
    ...
    case SSM_st_Establishing_CommunicationSession_SM :
      ...
      kcg_copy_mobileSWCmd_Type_MoRC_Pck(
        &tmp1,
        (mobileSWCmd_Type_MoRC_Pck *) &cInvalidMobileSWCmd_MoRC_Pck);
      /* guard_Establishing */ if (br_1_guard_CommunicationSession_SM_Establishing) {
        outC->CommunicationSession_SM_reset_nxt = kcg_true;
        outC->CommunicationSession_SM_state_nxt =
          SSM_st_Terminating_CommunicationSession_SM;
        tmp = kcg_true;
        ...
        outC->CommunicationSession_SM_reset_nxt =
          outC->Context_2.sessionSuccessfullyEstablished;
        /* cb_anon_sm */ if (outC->Context_2.sessionSuccessfullyEstablished) {
          tmp = kcg_true;
        }
        else {
          tmp = kcg_false;
    ...
    case SSM_st_NoSession_CommunicationSession_SM :
      ...
      kcg_copy_mobileSWCmd_Type_MoRC_Pck(
        &tmp1,
        (mobileSWCmd_Type_MoRC_Pck *) &cInvalidMobileSWCmd_MoRC_Pck);
      /* ck__L5 */ if (outC->_3_Context_1.initiate_a_communicationSession_Request) {
        outC->CommunicationSession_SM_state_nxt =
          SSM_st_Establishing_CommunicationSession_SM;
        tmp = kcg_true;
      }
