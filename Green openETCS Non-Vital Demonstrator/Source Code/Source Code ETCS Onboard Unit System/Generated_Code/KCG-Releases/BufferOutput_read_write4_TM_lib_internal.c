  ...
  /* TM_lib_internal::BufferOutput_read_write4::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_99380(&(*Buffer_Out)[0], (array_99380 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_99719(&(*Buffer_Out)[0], (array_99719 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_100620(&(*Buffer_Out)[4], (array_100620 *) &(*Buffer_In)[0]);
