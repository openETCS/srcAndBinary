  ...
  outC_establishSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  outC->init = kcg_true;
  outC->SM1_state_nxt = _8_SSM_st_idle_SM1;
  ...
  outC_establishSession_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  static _9_SSM_ST_SM1 SM1_state_sel;
  /* MoRC_Pck::Subfunc_Pkg::establishSession_v2::SM1 */
  ...
  /* init_SM1 */ if (outC->init) {
    outC->init = kcg_false;
    SM1_state_sel = _8_SSM_st_idle_SM1;
  }
  else {
    ...
    case _8_SSM_st_idle_SM1 :
      if (initiatedByOBU) {
        ...
        if (initiatedByRBC) {
          ...
          SM1_state_act = _8_SSM_st_idle_SM1;
        }
