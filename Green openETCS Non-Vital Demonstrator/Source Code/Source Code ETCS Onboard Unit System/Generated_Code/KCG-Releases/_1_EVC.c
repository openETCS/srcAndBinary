...
void _1_EVC_init(void)
{
  ...
  Ctxt__1_EVC.init20 = kcg_true;
  Ctxt__1_EVC.init = kcg_true;
  Ctxt__1_EVC.probe_newInput = kcg_true;
  Ctxt__1_EVC.ck_every = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.linkedBGError = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.unlinkedBGError = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.BG_versionIncompatible = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.radioSequenceError = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.tNvContactError = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.otherTimingError = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.radioMessageConsistencyError = kcg_true;
  Ctxt__1_EVC.probe_MsgErrors.nid_c = 0;
  Ctxt__1_EVC.probe_MsgErrors.nid_errorbg = 0;
  Ctxt__1_EVC.probe_PositioningErrors.outOfMemSpace = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.passedBG_foundNotWhereExpected = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.positionCalculation_inconsistent =
    kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.linkedBGMissed = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.BGpassedInUnexpectedDirection = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.BG_LinkingConsistencyError = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.twoConsecutiveLinkedBGs_missed = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.doubleRepositioningError = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.valid = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.nid_c = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.nid_bg = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.q_link = Q_LINK_Unlinked;
  Ctxt__1_EVC.probe_PositioningErrors.bg.location.nominal = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.location.d_min = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.location.d_max = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.seqNoOnTrack = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.valid = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.nid_bg_fromLinkingBG =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.nid_c_fromLinkingBG =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.expectedLocation.nominal =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.expectedLocation.d_min =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.expectedLocation.d_max =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.d_link.nominal = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.d_link.d_min = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.d_link.d_max = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.valid =
    kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.nid_LRBG =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.q_dir =
    Q_DIR_Reverse;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.q_scale =
    Q_SCALE_10_cm_scale;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.d_link = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.q_newcountry =
    Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.nid_c = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.nid_bg = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.q_linkorientation =
    Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.q_linkreaction =
    Q_LINKREACTION_Train_trip;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromLinking.linkingInfo.q_locacc =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.valid = kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.valid =
    kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.q_updown =
    Q_UPDOWN_Down_link_telegram;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.m_version =
    M_VERSION_Previous_versions_according_to_e_g_EEIG_SRS_and_UIC_A200_SRS;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.q_media =
    Q_MEDIA_Balise;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.n_total =
    N_TOTAL_1_balise_in_the_group;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.m_mcount = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.nid_c = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.nid_bg = 0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.q_link =
    Q_LINK_Unlinked;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.valid =
    kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.timestamp =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.odo.o_nominal =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.odo.o_min =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.odo.o_max =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.speed.v_safeNominal =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.speed.v_rawNominal =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.speed.v_lower =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.speed.v_upper =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.acceleration =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.motionState =
    noMotion_Obu_BasicTypes_Pkg;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.bgPosition.motionDirection =
    unknownDirection_Obu_BasicTypes_Pkg;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.nominal =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_min =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.BG_centerDetectionInaccuraccuracies.d_max =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.q_nvlocacc =
    0;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.noCoordinateSystemHasBeenAssigned =
    kcg_true;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.trainOrientationToBG =
    Q_DIRLRBG_Reverse;
  Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.BG_Header.trainRunningDirectionToBG =
    Q_DIRTRAIN_Reverse;
  for (i = 0; i < 33; i++) {
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].valid =
      kcg_true;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].nid_LRBG =
      0;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].q_dir =
      Q_DIR_Reverse;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].q_scale =
      Q_SCALE_10_cm_scale;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].d_link =
      0;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].q_newcountry =
      Q_NEWCOUNTRY_Same_country__or__railway_administration_no_NID_C_follows;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].nid_c =
      0;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].nid_bg =
      0;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].q_linkorientation =
      Q_LINKORIENTATION_The_balise_group_is_seen_by_the_train_in_reverse_direction;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].q_linkreaction =
      Q_LINKREACTION_Train_trip;
    Ctxt__1_EVC.probe_PositioningErrors.bg.infoFromPassing.linkedBGs[i].q_locacc =
      0;
  }
  Ctxt__1_EVC.probe_PositioningErrors.bg.missed = kcg_true;
  ...
  Ctxt__1_EVC.EVC_ActiveLevelList.number = 0;
  ...
  for (i = 0; i < 32; i++) {
    Ctxt__1_EVC.EVC_ActiveLevelList.levelList[i].level = M_LEVEL_Level_0;
    Ctxt__1_EVC.EVC_ActiveLevelList.levelList[i].nid_stm = 0;
  ...
  /* 1 */ ProbeEVC_init_EnvSim(&Ctxt__1_EVC._19_Context_1);
  /* 3 */ probe_MsgOut_init_RadioSupport_Pkg(&Ctxt__1_EVC._18_Context_3);
  /* 1 */ collectRadioOutput_init_radioOutput_Pkg(&Ctxt__1_EVC._17_Context_1);
  /* 3 */ checkGeneralMessage_init_trainData_pkg(&Ctxt__1_EVC._16_Context_3);
  /* 2 */ setProbes_init_xdebugSupport_Pkg(&Ctxt__1_EVC._15_Context_2);
  /* 2 */ distanceLastMSG_init_xdebugSupport_Pkg(&Ctxt__1_EVC._14_Context_2);
  /* 2 */ distanceLastBG_init_xdebugSupport_Pkg(&Ctxt__1_EVC._13_Context_2);
  /* 2 */ setProbesBalises_init_xdebugSupport_Pkg(&Ctxt__1_EVC._12_Context_2);
  /* 2 */
  manageDMI_Output_init_manage_DMI_Output_Pkg(&Ctxt__1_EVC._11_Context_2);
  /* 2 */ Master_Procedure_init_ManageProcedure_Pkg(&Ctxt__1_EVC._10_Context_2);
  /* 1 */ MoRC_HO_init_MoRC_HO_Pkg(&Ctxt__1_EVC._9_Context_1);
  /* 2 */
  ProvidePositionReport_init_ProvidePositionReport_Pkg(
    &Ctxt__1_EVC._8_Context_2);
  /* 2 */
  TIU_OutputIntegration_init_output_to_TIU_API_Pkg(&Ctxt__1_EVC._7_Context_2);
  /* 2 */
  SpeedSupervision_Integration_init_SpeedSupervision_Integration_Pkg(
    &Ctxt__1_EVC._6_Context_2);
  /* 2 */ ManageLevelAndMode_init(&Ctxt__1_EVC._5_Context_2);
  /* 1 */
  MEM_combineForLevelChange_init_EVC_MEM_Support_Pkg(&Ctxt__1_EVC._4_Context_1);
  ...
  /* 1 */ probePackets_init_EVC_MEM_Support_Pkg(&Ctxt__1_EVC.Context_1);
}
...
void _1_EVC_reset(void)
{
  Ctxt__1_EVC.init20 = kcg_true;
  Ctxt__1_EVC.init = kcg_true;
  /* 1 */ ProbeEVC_reset_EnvSim(&Ctxt__1_EVC._19_Context_1);
  /* 3 */ probe_MsgOut_reset_RadioSupport_Pkg(&Ctxt__1_EVC._18_Context_3);
  /* 1 */ collectRadioOutput_reset_radioOutput_Pkg(&Ctxt__1_EVC._17_Context_1);
  /* 3 */ checkGeneralMessage_reset_trainData_pkg(&Ctxt__1_EVC._16_Context_3);
  /* 2 */ setProbes_reset_xdebugSupport_Pkg(&Ctxt__1_EVC._15_Context_2);
  /* 2 */ distanceLastMSG_reset_xdebugSupport_Pkg(&Ctxt__1_EVC._14_Context_2);
  /* 2 */ distanceLastBG_reset_xdebugSupport_Pkg(&Ctxt__1_EVC._13_Context_2);
  /* 2 */ setProbesBalises_reset_xdebugSupport_Pkg(&Ctxt__1_EVC._12_Context_2);
  /* 2 */
  manageDMI_Output_reset_manage_DMI_Output_Pkg(&Ctxt__1_EVC._11_Context_2);
  /* 2 */
  Master_Procedure_reset_ManageProcedure_Pkg(&Ctxt__1_EVC._10_Context_2);
  /* 1 */ MoRC_HO_reset_MoRC_HO_Pkg(&Ctxt__1_EVC._9_Context_1);
  /* 2 */
  ProvidePositionReport_reset_ProvidePositionReport_Pkg(
    &Ctxt__1_EVC._8_Context_2);
  /* 2 */
  TIU_OutputIntegration_reset_output_to_TIU_API_Pkg(&Ctxt__1_EVC._7_Context_2);
  /* 2 */
  SpeedSupervision_Integration_reset_SpeedSupervision_Integration_Pkg(
    &Ctxt__1_EVC._6_Context_2);
  /* 2 */ ManageLevelAndMode_reset(&Ctxt__1_EVC._5_Context_2);
  /* 1 */
  ...
  /* 1 */ probePackets_reset_EVC_MEM_Support_Pkg(&Ctxt__1_EVC.Context_1);
}
...
void _1_EVC(void)
{
  ...
  /* EVC */
  static morcStatus_T_RCM_Session_Types_Pkg tmp25;
  /* EVC */
  ...
  /* EVC */
  static trainData_Events_T_trainData_Types_pkg tmp21;
  /* EVC */
  static L_internal_Type_Obu_BasicTypes_Pkg tmp20;
  /* EVC */
  static DataForModeAndLevel_t_TrackAtlasTypes tmp19;
  /* EVC */
  ...
  /* EVC */
  static mobileRegistrationContext_T_RCM_Types_Pkg tmp13;
  /* EVC */
  static kcg_int tmp12;
  /* EVC */
  static mobileConnectionContext_T_RCM_Types_Pkg tmp11;
  /* EVC */
  ...
  kcg_copy_odometry_T_Obu_BasicTypes_Pkg(
    ...
    &API_Odometry);
  resetOut = EVC_reset;
  /* ck_EVC */ if (Ctxt__1_EVC.ck_every) {
    /* 1 */
    probePackets_EVC_MEM_Support_Pkg(&API_fromTrack, &Ctxt__1_EVC.Context_1);
  }
  /* fby_1_init_2 */ if (Ctxt__1_EVC.init20) {
    ...
    tmp22 = Ctxt__1_EVC.EVC_currentNTC;
    kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(
      &_L1219,
      &Ctxt__1_EVC.rep_P0);
    kcg_copy_PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg(
    ...
    tmp20 = Ctxt__1_EVC.DMI_sdmToDMI.location_brake_curve_starting_point;
    kcg_copy_ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg(
      &last_EVC_PersistentData,
      &Ctxt__1_EVC.EVC_PersistentData);
    _L813 = Ctxt__1_EVC.MoRC_newSessionEstablished;
    tmp17 = Ctxt__1_EVC.EVC_ready;
    _L1678 = Ctxt__1_EVC.PROC_statusstartofmissionongoing_to_MoRC;
    tmp16 = Ctxt__1_EVC.PROC_powerUp_to_MoRC;
    tmp15 = Ctxt__1_EVC.PROC_powerOff_to_MoRC;
    tmp14 = Ctxt__1_EVC.PROC_radioCmdFromProcedures.valid;
    tmp12 = Ctxt__1_EVC.MoRC_MN_1;
    tmp10 = Ctxt__1_EVC.MoRC_RadioID_1;
    tmp = Ctxt__1_EVC._L477;
  }
  /* 5 */
  ...
  kcg_copy_positionErrors_T_TrainPosition_Types_Pck(
    &Ctxt__1_EVC.probe_PositioningErrors,
  ...
  maintainTrainProperties_EVC_MEM_Support_Pkg(
    ...
    4065801,
    &Ctxt__1_EVC.TIU_trainProperties);
  _L1754 = Ctxt__1_EVC.Context_5.outTIUStatus.valid &
    Ctxt__1_EVC.Context_5.outTIUStatus.deskOpen;
  /* 2 */
  ...
  MEM_combineForLevelChange_EVC_MEM_Support_Pkg(
    ...
    &Ctxt__1_EVC.CALC_TrainPosition,
    &Ctxt__1_EVC.TIU_trainProperties,
    &Ctxt__1_EVC._3_Context_2.NV_raw_out,
    &Ctxt__1_EVC._4_Context_1);
  /* ck_EVC_cabIsOpen */ if (_L1754) {
    /* 3 */ if (Ctxt__1_EVC.init) {
      kcg_copy_ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg(
        &Ctxt__1_EVC.EVC_PersistentData,
        &API_persistentData);
      tmp18 = Ctxt__1_EVC.EVC_PersistentData.lastActiveLevel;
    }
    else {
      kcg_copy_ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg(
        &Ctxt__1_EVC.EVC_PersistentData,
    ...
    kcg_copy_DMI_LevelList_T_DMI_Types_Pkg(
      &Ctxt__1_EVC.EVC_ActiveLevelList,
      &Ctxt__1_EVC.EVC_PersistentData.availableLevelsList);
    Ctxt__1_EVC.init = kcg_false;
  }
  else {
    tmp18 = _L993.level;
    /* last_init_ck_EVC_ActiveLevelList */ if (Ctxt__1_EVC.init20) {
      kcg_copy_DMI_LevelList_T_DMI_Types_Pkg(
        &Ctxt__1_EVC.EVC_ActiveLevelList,
  ...
  kcg_copy_T_Mode_Level_Level_And_Mode_Types_Pkg(
    &Ctxt__1_EVC.ML_ModeAndLevel,
    &Ctxt__1_EVC._5_Context_2.Compatible_Mode_And_Level);
  /* 2 */
  ...
  kcg_copy_TIU_Output_msg_API_TIU_Pkg(
    &API_toTIU,
    &Ctxt__1_EVC._7_Context_2.outTIU_to_API);
  Ctxt__1_EVC.td_events.communicationSessionEstablished = _L813;
  Ctxt__1_EVC.td_events.MoRCreadyFlag = tmp17;
  _L1754 = !Ctxt__1_EVC.Context_5.outTIUStatus.deskOpen;
  ...
  ProvidePositionReport_ProvidePositionReport_Pkg(
    ...
    &_3_mk_struct,
    Ctxt__1_EVC.CALC_TrainPosition.trainRunningDirectionToLRBG,
    Ctxt__1_EVC.probe_PositioningErrors.BG_LinkingConsistencyError,
    Ctxt__1_EVC.probe_MsgErrors.linkedBGError,
    Ctxt__1_EVC.probe_MsgErrors.unlinkedBGError,
    Ctxt__1_EVC.probe_MsgErrors.radioMessageConsistencyError,
    Ctxt__1_EVC.probe_MsgErrors.radioSequenceError,
    kcg_false,
    kcg_false,
    Ctxt__1_EVC.probe_PositioningErrors.twoConsecutiveLinkedBGs_missed,
    Ctxt__1_EVC.probe_PositioningErrors.doubleRepositioningError,
    &_4_mk_struct,
  ...
  kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(
    &Ctxt__1_EVC.rep_P0,
    &Ctxt__1_EVC._8_Context_2.packet0);
  kcg_copy_PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg(
    &Ctxt__1_EVC.rep_P1,
    &Ctxt__1_EVC._8_Context_2.packet1);
  kcg_copy_M_TrainTrackMessageBus_t_TM_TrainTrack_Bus(
    &TM_to_MsgOut,
    &Ctxt__1_EVC._8_Context_2.posReport);
  /* 1 */
  ...
  kcg_copy_morcStatus_T_RCM_Session_Types_Pkg(
    &Ctxt__1_EVC.MoRC_RadioStatus_1,
    &Ctxt__1_EVC._9_Context_1.radioStatus_1);
  kcg_copy_connection_ids_T_Handover_Pkg(
    &Ctxt__1_EVC.MoRC_supervisingRBC_Id,
    &Ctxt__1_EVC._9_Context_1.supervisingRBC);
  Ctxt__1_EVC.EVC_ready = Ctxt__1_EVC._9_Context_1.ready;
  /* 2 */
  ...
  kcg_copy_radioManagementMessage_T_Common_Types_Pkg(
    ...
    &Ctxt__1_EVC._10_Context_2.request_Start_Mobile_Terminal_and_RBC_Registration_to_MoRC);
  Ctxt__1_EVC.PROC_powerUp_to_MoRC = Ctxt__1_EVC._10_Context_2.powerUp_to_MoRC;
  Ctxt__1_EVC.PROC_statusstartofmissionongoing_to_MoRC =
    Ctxt__1_EVC._10_Context_2.statusstartofmissionongoing_to_MoRC;
  Ctxt__1_EVC.PROC_powerOff_to_MoRC =
    Ctxt__1_EVC._10_Context_2.powerOff_to_MoRC;
  Ctxt__1_EVC._L477 =
    Ctxt__1_EVC._10_Context_2.request_MA_FS_SR_OS_LS_SH_to_MA_L2_Management;
  Ctxt__1_EVC.init20 = kcg_false;
  ...
  manageDMI_Output_manage_DMI_Output_Pkg(
    ...
    &Ctxt__1_EVC.MoRC_RadioStatus_1,
    &Ctxt__1_EVC.td_trainData,
    &Ctxt__1_EVC._10_Context_2.DMI_Entry_Request_to_DMI,
    ...
    &Ctxt__1_EVC._5_Context_2.Data_To_DMI_Ack,
    &Ctxt__1_EVC._5_Context_2.announcedLevel,
  ...
  kcg_copy_EVC_to_DMI_Message_int_T_API_DMI_Pkg(
    &API_toDMI,
    &Ctxt__1_EVC._11_Context_2.to_DMI);
  kcg_copy_DMI_TXT_MSGList_status_T_DMI_Types_Pkg(
    &Ctxt__1_EVC.EVC_TextMessageStatusList,
    &Ctxt__1_EVC._11_Context_2.outStatusList);
  debugIinterventionSpeed = (kcg_real)
      Ctxt__1_EVC.DMI_sdmToDMI.interventionSpeed;
  /* 14 */ if (Ctxt__1_EVC._10_Context_2.start_ack_to_TIU) {
    debugPermittedSpeed = (kcg_real) Ctxt__1_EVC.DMI_sdmToDMI.permittedSpeed;
  }
  else {
    debugPermittedSpeed = (kcg_real) 0;
  }
  /* 15 */ if (Ctxt__1_EVC.Context_2.outputMessage.valid &
    (Ctxt__1_EVC.Context_2.outputMessage.source ==
      msrc_Euroradio_Common_Types_Pkg)) {
    Ctxt__1_EVC.MSG_lastRadioMsgTimestamp =
      Ctxt__1_EVC.Context_2.outputMessage.Radio_Common_Header.receivedSystemTime;
  }
  else {
  ...
  kcg_copy_probesBalises_T_xdebugSupport_Pkg(
    ...
    &Ctxt__1_EVC._12_Context_2.baliseInformation);
  /* 2 */
  distanceLastBG_xdebugSupport_Pkg(
    &API_Odometry,
    &Ctxt__1_EVC.Context_2.outputMessage,
    &Ctxt__1_EVC._13_Context_2);
  Ctxt__1_EVC.probe_distBG = Ctxt__1_EVC._13_Context_2.distance;
  Ctxt__1_EVC.probe_BG_afterCheck = Ctxt__1_EVC._13_Context_2.lastBG;
  /* 2 */
  ...
  Ctxt__1_EVC.probe_distMsg = Ctxt__1_EVC._14_Context_2.distance;
  Ctxt__1_EVC.probe_MSGinAfterFilter = Ctxt__1_EVC._14_Context_2.lastMSG;
  Ctxt__1_EVC.probe_LRBG = Ctxt__1_EVC._14_Context_2.lastLRBG;
  /* 2 */
  ...
  setProbes_xdebugSupport_Pkg(
    &API_fromTrack,
    kcg_false,
    &Ctxt__1_EVC._15_Context_2);
  Ctxt__1_EVC.probe_newInput = Ctxt__1_EVC._15_Context_2.isChanged;
  Ctxt__1_EVC.probe_MSG_in = Ctxt__1_EVC._15_Context_2.radioMSG;
  Ctxt__1_EVC.probe_BG_ID = Ctxt__1_EVC._15_Context_2.BG_ID;
  Ctxt__1_EVC.probe_nid_packet1 = Ctxt__1_EVC._15_Context_2.packet_id1;
  Ctxt__1_EVC.probe_nid_packet2 = Ctxt__1_EVC._15_Context_2.packet_id2;
  Ctxt__1_EVC.probe_lastMSG_in = Ctxt__1_EVC._15_Context_2.lastRadioMSG;
  Ctxt__1_EVC.probe_lastBG_ID = Ctxt__1_EVC._15_Context_2.lastBG_ID;
  /* 3 */
  checkGeneralMessage_trainData_pkg(
    &Ctxt__1_EVC.Context_2.outputMessage,
    &Ctxt__1_EVC._16_Context_3);
  /* 1 */
  collectRadioOutput_radioOutput_Pkg(
    &Ctxt__1_EVC._9_Context_1.msgBus_2_RBC_1,
    Ctxt__1_EVC._16_Context_3.genMessageReceived,
    &Ctxt__1_EVC.ML_ModeAndLevel,
    &Ctxt__1_EVC.MoRC_RadioStatus_1,
    &Ctxt__1_EVC._9_Context_1.mobileConnectionCmd_1,
    &Ctxt__1_EVC._9_Context_1.mobileRegistrationCmd_1,
    cOwnVersion,
    API_SystemTime,
    &Ctxt__1_EVC._17_Context_1);
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    &API_toRBC,
    &Ctxt__1_EVC._17_Context_1.toRBC);
  kcg_copy_RadioManagement_T_API_RadioCommunication_Pkg(
    &API_RTM_management,
    &Ctxt__1_EVC._17_Context_1.API_RTM_management);
  Ctxt__1_EVC.MoRC_RadioID_1 = Ctxt__1_EVC._17_Context_1.outRadio;
  Ctxt__1_EVC.MoRC_MN_1 = Ctxt__1_EVC._17_Context_1.outMN;
  /* 3 */
  probe_MsgOut_RadioSupport_Pkg(
    &API_toRBC,
    kcg_true,
    &Ctxt__1_EVC._18_Context_3);
  Ctxt__1_EVC.probe_MSGout = Ctxt__1_EVC._18_Context_3.Msg_0ut;
  Ctxt__1_EVC.probe_TTrain = Ctxt__1_EVC._18_Context_3.outTTrain;
