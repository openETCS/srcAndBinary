...
void Send_M156_init_TM_radio_message(outC_Send_M156_TM_radio_message *outC)
{
  static kcg_int i1;
  static kcg_int i;
...
void Send_M156_reset_TM_radio_messag(outC_Send_M156_TM_radio_message *outC)
{
  ...
  outC_Send_M156_TM_radio_message *outC)
{
  ...
  static M_TrainTrack_compressed_packets _L17;
  ...
  /* 1 */ C_M156_to_header_TM_RBC_convers(Message_156_in, &tmp);
  for (i = 0; i < 50; i++) {
    _L17[i] = 0;
  }
  /* 1 */ Merge_PacketsToMessage_TM_Train(&_L17, &tmp, &tmp1);
