...
{
  /* SDM_Commands_Pkg::CalcDriverOutput::IfBlock1::else */
  static kcg_bool _1_else_clock_IfBlock1;
  /* SDM_Commands_Pkg::CalcDriverOutput::IfBlock1::else::else::then::_L15 */
  static L_internal_real_Type_SDM_Types_Pkg _L15_IfBlock1;
  /* SDM_Commands_Pkg::CalcDriverOutput::IfBlock1::else::else */
  static kcg_bool else_clock_IfBlock1;
  /* SDM_Commands_Pkg::CalcDriverOutput::IfBlock1::else::then::_L8 */
  static L_internal_real_Type_SDM_Types_Pkg _L8_IfBlock1;
  /* SDM_Commands_Pkg::CalcDriverOutput::isCSM */
  static kcg_bool isCSM;
