  ...
  /* SDM_Commands_Pkg::TSM_PositionCond::triggerConds */ TSM_triggerCond_T_SDM_Commands_Pkg *triggerConds)
{
  ...
  _L73 = (*trainLocations).d_maxSafeFrontEndPos <= (*locations).d_I_of_V_est;
  _L62 = (*locations).d_I_of_V_est >= (*trainLocations).d_est_frontendPos;
  ...
  _L73 = (*trainLocations).d_maxSafeFrontEndPos <= (*locations).d_I_of_V_MRSP;
  (*triggerConds).t11 = _L73;
  _L59 = (*trainLocations).d_maxSafeFrontEndPos <= (*locations).d_EBI_of_V_est;
