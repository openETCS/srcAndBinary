...
{
  /* Receive_TrackSide_Msg_Pkg::addTelegram */ kcg_bool _1_cond_iterw;
  /* Receive_TrackSide_Msg_Pkg::addTelegram */ kcg_bool cond_iterw;
  kcg_int i;
  ...
  /* Receive_TrackSide_Msg_Pkg::addTelegram::IfBlock1::else::_L21 */ array_bool_8 _L21_IfBlock1;
