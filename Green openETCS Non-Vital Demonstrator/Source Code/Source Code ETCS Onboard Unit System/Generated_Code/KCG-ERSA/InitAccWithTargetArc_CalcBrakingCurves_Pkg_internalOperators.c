...
{
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc */ ParabolaArc_T_CalcBrakingCurves_types mk_struct;
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc */ A_internal_real_Type_SDM_Types_Pkg tmp1;
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc */ ParabolaCurve_T_CalcBrakingCurves_types tmp;
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc::_L8 */ V_internal_real_Type_SDM_Types_Pkg _L8;
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc::_L9 */ kcg_int _L9;
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc::_L10 */ L_internal_real_Type_SDM_Types_Pkg _L10;
  /* CalcBrakingCurves_Pkg::internalOperators::InitAccWithTargetArc::_L11 */ kcg_int _L11;
