...
void Build_MA_L23_init_TA_MA_new(outC_Build_MA_L23_TA_MA_new *outC)
{
  ...
  /* 1 */ MA_L23_Postprocessing_init_TA_MA_new(&outC->Context_1);
}
...
{
  outC->init = kcg_true;
  /* 1 */ MA_L23_Postprocessing_reset_TA_MA_new(&outC->Context_1);
}
...
{
  /* TA_MA_new::Build_MA_L23 */ kcg_int tmp1;
  /* TA_MA_new::Build_MA_L23 */ L_internal_Type_Obu_BasicTypes_Pkg tmp;
  /* TA_MA_new::Build_MA_L23::_L60 */ P015_OBU_T_TM _L60;
  /* TA_MA_new::Build_MA_L23::_L240 */ kcg_bool _L240;
