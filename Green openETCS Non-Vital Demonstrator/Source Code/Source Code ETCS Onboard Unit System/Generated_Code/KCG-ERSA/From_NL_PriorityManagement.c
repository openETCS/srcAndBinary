...
{
  /* PriorityManagement::From_NL::IfBlock1::else::else */ kcg_bool else_clock_IfBlock1;
  /* PriorityManagement::From_NL::FromNL_To_NewMode */ T_Mode_Level_And_Mode_Types_Pkg FromNL_To_NewMode;
