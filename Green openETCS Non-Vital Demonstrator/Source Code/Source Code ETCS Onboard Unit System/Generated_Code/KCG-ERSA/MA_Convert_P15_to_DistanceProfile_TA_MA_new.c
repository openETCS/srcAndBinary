...
{
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile */ P015_section_enum_T_TM tmp;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile */ AccuDistanceProfileMA_TA_MA_new acc;
  kcg_int i;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L77 */ AccuDistanceProfileMA_TA_MA_new _L77;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L130 */ kcg_bool _L130;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L131 */ DP_or_OL_t_TrackAtlasTypes _L131;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L132 */ kcg_bool _L132;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L133 */ DP_or_OL_t_TrackAtlasTypes _L133;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L145 */ kcg_bool _L145;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L146 */ T_internal_Type_Obu_BasicTypes_Pkg _L146;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile::_L166 */ P015_OBU_sectionlist_enum_T_TM _L166;
  ...
  kcg_copy_AccuDistanceProfileMA_TA_MA_new(
    ...
    (AccuDistanceProfileMA_TA_MA_new *)
      &DEFAULT_AccuDistanceProfileMA_TA_MA_new);
  /* 1 */ for (i = 0; i < 10; i++) {
    kcg_copy_AccuDistanceProfileMA_TA_MA_new(&acc, &_L77);
    /* 1 */
