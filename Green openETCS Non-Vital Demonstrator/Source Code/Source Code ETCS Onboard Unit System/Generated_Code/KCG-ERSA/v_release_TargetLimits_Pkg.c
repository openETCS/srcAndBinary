...
{
  /* TargetLimits_Pkg::v_release */ V_internal_real_Type_SDM_Types_Pkg acc;
  /* TargetLimits_Pkg::v_release */ kcg_bool cond_iterw;
  kcg_int i;
  /* TargetLimits_Pkg::v_release::_L9 */ V_internal_real_Type_SDM_Types_Pkg _L9;
  /* TargetLimits_Pkg::v_release::_L21 */ L_internal_real_Type_SDM_Types_Pkg _L21;
