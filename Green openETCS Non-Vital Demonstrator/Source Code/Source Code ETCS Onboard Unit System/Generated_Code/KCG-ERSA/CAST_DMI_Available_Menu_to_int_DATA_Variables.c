...
{
  /* DATA::Variables::CAST_DMI_Available_Menu_to_int */ DMI_Available_Menu_int_T_DATA tmp;
  /* DATA::Variables::CAST_DMI_Available_Menu_to_int::dmi_available_menu_int */ DMI_Available_Menu_INT_T_DATA dmi_available_menu_int;
