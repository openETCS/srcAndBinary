...
void Procedure_SH_Initiated_By_init_Procedures(
...
void Procedure_SH_Initiated_By_Procedures(
  ...
  outC_Procedure_SH_Initiated_By_Procedures *outC)
{
  /* Procedures::Procedure_SH_Initiated_By_Driver::SH_Initiated_By_Driver */ SSM_ST_SH_Initiated_By_Driver SH_Initiated_By_Driver_state_sel;
  /* Procedures::Procedure_SH_Initiated_By_Driver::SH_Initiated_By_Driver */ SSM_ST_SH_Initiated_By_Driver SH_Initiated_By_Driver_state_act;
  /* Procedures::Procedure_SH_Initiated_By_Driver::SH_Initiated_By_Driver */ kcg_bool SH_Initiated_By_Driver_reset_act;
  /* Procedures::Procedure_SH_Initiated_By_Driver::Loc_Procedure_Possible */ kcg_bool Loc_Procedure_Possible;
