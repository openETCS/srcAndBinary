...
{
  /* manage_TextMessages_Pkg::sendTextMessage */ DMI_TXT_MSG_status_T_DMI_Types_Pkg mk_struct;
  /* manage_TextMessages_Pkg::sendTextMessage::needsStore */ kcg_bool needsStore;
