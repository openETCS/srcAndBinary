...
** Generation date: 2015-11-05T14:49:06
*************************************************************$ */
...
void Manage_TrackSideInformati_init_Manage_TrackSideInformation_Integration_Pkg(
  outC_Manage_TrackSideInformati_Manage_TrackSideInformation_Integration_Pkg *outC)
{
  ...
  for (i = 0; i < 7; i++) {
    ...
    outC->Data_to_From_Track_Packets_at_ML.P_27.diffArray[i].nc_cddiff =
      _40_NC_CDDIFF_Specific_SSP_applicable_to_Cant_Deficiency_80_mm;
...
void Manage_TrackSideInformati_Manage_TrackSideInformation_Integration_Pkg(
  ...
  outC_Manage_TrackSideInformati_Manage_TrackSideInformation_Integration_Pkg *outC)
{
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ positionedBG_T_TrainPosition_Types_Pck tmp4;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool tmp3;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool tmp2;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool tmp1;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ NID_ERRORBG_BG_Types_Pkg tmp;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool _6_op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool _7_op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool _8_op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool _9_op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ NID_C op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ NID_ERRORBG_BG_Types_Pkg _5_op_call;
  ...
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration::trainPositionTest */ trainPosition_T_TrainPosition_Types_Pck trainPositionTest;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration::_L206 */ ReceivedMessage_T_Common_Types_Pkg _L206;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration::_L205 */ ReceivedMessage_T_Common_Types_Pkg _L205;
