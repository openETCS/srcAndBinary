...
{
  /* TA_MA::MA_Convert_P15_to_DistanceProfile */ P015_section_enum_T_TM tmp;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile */ AccuDistanceProfileMA_TA_MA acc;
  kcg_int i;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L77 */ AccuDistanceProfileMA_TA_MA _L77;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L130 */ kcg_bool _L130;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L131 */ DP_or_OL_t_TrackAtlasTypes _L131;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L132 */ kcg_bool _L132;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L133 */ DP_or_OL_t_TrackAtlasTypes _L133;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L145 */ kcg_bool _L145;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L146 */ T_internal_Type_Obu_BasicTypes_Pkg _L146;
  /* TA_MA::MA_Convert_P15_to_DistanceProfile::_L166 */ P015_OBU_sectionlist_enum_T_TM _L166;
  
  kcg_copy_P015_OBU_sectionlist_enum_T_TM(&_L166, &(*Packet15_in).sections);
  /* 1 */ Pack_Endsection_TA_MA(Packet15_in, &tmp);
