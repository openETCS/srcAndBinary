...
{
  /* CalcBrakingCurves_Pkg::internalOperators::InitilizeAccForEBDFootCalc::_L9 */ L_internal_real_Type_SDM_Types_Pkg _L9;
  /* CalcBrakingCurves_Pkg::internalOperators::InitilizeAccForEBDFootCalc::_L11 */ V_internal_real_Type_SDM_Types_Pkg _L11;
