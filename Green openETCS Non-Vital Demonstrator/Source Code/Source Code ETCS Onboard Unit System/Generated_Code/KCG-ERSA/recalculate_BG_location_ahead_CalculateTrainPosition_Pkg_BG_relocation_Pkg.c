...
{
  /* CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_location_ahead */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp3;
  /* CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_location_ahead */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp2;
  /* CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_location_ahead */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp1;
  /* CalculateTrainPosition_Pkg::BG_relocation_Pkg::recalculate_BG_location_ahead */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp;
