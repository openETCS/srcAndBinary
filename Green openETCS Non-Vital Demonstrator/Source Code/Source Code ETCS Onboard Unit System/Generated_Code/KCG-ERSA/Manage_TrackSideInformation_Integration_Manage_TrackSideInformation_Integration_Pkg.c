...
void Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg(
  ...
  outC_Manage_TrackSideInformation_Integration_Manage_TrackSideInformation_Integration_Pkg *outC)
{
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ ReceivedMessage_T_Common_Types_Pkg tmp5;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ ReceivedMessage_T_Common_Types_Pkg tmp4;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ positionedBG_T_TrainPosition_Types_Pck tmp3;
  ...
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ kcg_bool _10_op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ NID_C op_call;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */ NID_ERRORBG_BG_Types_Pkg _6_op_call;
