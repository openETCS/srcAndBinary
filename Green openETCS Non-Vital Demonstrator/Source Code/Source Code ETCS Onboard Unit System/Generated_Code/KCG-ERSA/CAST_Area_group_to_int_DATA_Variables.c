...
{
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else */ kcg_bool _6_else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else::else::else */ kcg_bool _4_else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else::else::else::else::else */ kcg_bool _2_else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else::else::else::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else::else::else::else::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else::else::else::else */ kcg_bool _3_else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1::else::else */ kcg_bool _5_else_clock_IfBlock1;
  /* DATA::Variables::CAST_Area_group_to_int::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* DATA::Variables::CAST_Area_group_to_int::area_group_int */ Area_group_INT_T_DATA area_group_int;
