...
{
  /* TM_lib_internal::BufferOutput_write_only3::_L7 */ kcg_int _L7;
  
  kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
    Message_out,
    (M_TrainTrack_Message_T_TM_radio_messages *)
      &EMPTY_TrainTrackMessage_TM_lib_internal);
  kcg_copy_array_121315(&(*Buffer_Out)[0], (array_121315 *) &(*Message_In)[0]);
  kcg_copy_array_124840(&(*Buffer_Out)[3], (array_124840 *) &(*Buffer_In)[0]);
  _L7 = Stacksize_old + 3;
