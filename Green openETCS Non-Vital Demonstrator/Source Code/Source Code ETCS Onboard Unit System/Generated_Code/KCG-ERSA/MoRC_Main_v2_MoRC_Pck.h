...
typedef struct {
  ...
  outC_requestRadioConnectionSet_MoRC_Pck_Subfunc_Pkg /* 1 */ _2_Context_1;
  outC_registeringToTheRadioNetw_MoRC_Pck_Subfunc_Pkg /* 1 */ _1_Context_1;
  outC_safeRadioConnectionIndica_MoRC_Pck_Subfunc_Pkg /* 1 */ Context_1;
