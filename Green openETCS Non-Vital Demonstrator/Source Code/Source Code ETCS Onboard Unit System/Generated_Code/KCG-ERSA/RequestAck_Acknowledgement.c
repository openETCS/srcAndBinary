...
{
  /* Acknowledgement::RequestAck::SM1 */ _27_SSM_ST_SM1 SM1_state_sel;
  /* Acknowledgement::RequestAck::SM1 */ _27_SSM_ST_SM1 SM1_state_act;
  /* Acknowledgement::RequestAck::Loc_PositionInAckArea */ kcg_bool Loc_PositionInAckArea;
