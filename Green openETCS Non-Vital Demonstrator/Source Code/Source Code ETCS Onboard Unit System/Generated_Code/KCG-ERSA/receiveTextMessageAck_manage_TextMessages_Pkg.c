...
{
  /* manage_TextMessages_Pkg::receiveTextMessageAck::IfBlock2::then::_L6 */ DMI_TXT_MSG_status_T_DMI_Types_Pkg _L6_IfBlock2;
  /* manage_TextMessages_Pkg::receiveTextMessageAck::IfBlock2::then::_L3 */ kcg_int _L3_IfBlock2;
  /* manage_TextMessages_Pkg::receiveTextMessageAck::IfBlock1::else */ kcg_bool else_clock_IfBlock1;
  /* manage_TextMessages_Pkg::receiveTextMessageAck::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* manage_TextMessages_Pkg::receiveTextMessageAck::context */ DMI_context_TXT_MSG_T_DMI_Types_Pkg context;
