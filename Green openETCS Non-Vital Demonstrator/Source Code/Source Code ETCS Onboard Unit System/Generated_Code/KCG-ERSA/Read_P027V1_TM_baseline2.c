  ...
  /* TM_baseline2::Read_P027V1::P027V1_out */ P027V1_OBU_T_TM_baseline2 *P027V1_out)
{
  ...
  /* TM_conversions::CAST_Int_to_Q_DIR::IfBlock1::else::else */ kcg_bool else_clock_1_1_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_DIR::IfBlock1 */ kcg_bool IfBlock1_clock_1_1;
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1::else::else */ kcg_bool _1_else_clock_1_1_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1 */ kcg_bool _2_IfBlock1_clock_1_1;
  /* TM_baseline2::Read_P027V1::_L5 */ CompressedPacketData_T_Common_Types_Pkg _L5;
  ...
  /* TM_baseline2::Read_P027V1::_L182 */ P027V1_OBU_sectionlist_enum_T_TM_baseline2 _L182;
