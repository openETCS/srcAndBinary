...
{
  /* CalcBrakingCurves_Pkg::CalculateBrakingCurve */ BCAccumulator_type_CalcBrakingCurves_Pkg acc;
  /* CalcBrakingCurves_Pkg::CalculateBrakingCurve */ kcg_bool cond_iterw;
  kcg_int i;
