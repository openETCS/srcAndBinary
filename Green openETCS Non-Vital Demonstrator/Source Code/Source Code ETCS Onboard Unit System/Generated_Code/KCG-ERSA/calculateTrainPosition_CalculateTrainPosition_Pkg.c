...
void calculateTrainPosition_CalculateTrainPosition_Pkg(
  ...
  outC_calculateTrainPosition_CalculateTrainPosition_Pkg *outC)
{
  /* CalculateTrainPosition_Pkg::calculateTrainPosition */ positionedBGs_T_TrainPosition_Types_Pck tmp;
  ...
  /* CalculateTrainPosition_Pkg::calculateTrainPosition::BGs_preloc */ positionedBGs_T_TrainPosition_Types_Pck BGs_preloc;
