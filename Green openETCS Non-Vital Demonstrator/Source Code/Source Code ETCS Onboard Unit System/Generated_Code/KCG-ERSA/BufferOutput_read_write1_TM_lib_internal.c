  ...
  *Stacksize_new = Stacksize_old;
  ...
  if (_L35) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      Message_out,
      &(*Message_In)[0]);
    kcg_copy_array__108361(&(*Buffer_Out)[0], &_L32);
  }
  else {
    ...
    kcg_copy_array__108361(&(*Buffer_Out)[0], &_L37);
  }
  kcg_copy_array__113321(&(*Buffer_Out)[1], (array__113321 *) &(*Buffer_In)[0]);
}
