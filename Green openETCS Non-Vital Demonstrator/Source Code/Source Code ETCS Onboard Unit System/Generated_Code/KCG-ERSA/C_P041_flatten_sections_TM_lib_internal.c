  ...
  /* TM_lib_internal::C_P041_flatten_sections::Flattened */ P041_sections_array_flat_T_TM *Flattened)
{
  ...
  kcg_int i;
  /* TM_lib_internal::C_P041_flatten_sections::_L74 */ array_int_3_33 _L74;
  ...
  for (i = 0; i < 99; i++) {
    kcg_copy_P041_sections_array_flat_T_TM(&acc, Flattened);
    /* 1 */ C_P041_fs_flatten_array_TM_lib_internal(i, &acc, &_L74, Flattened);
  }
}
