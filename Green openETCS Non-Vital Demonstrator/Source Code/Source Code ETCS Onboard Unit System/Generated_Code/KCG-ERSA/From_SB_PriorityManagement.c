...
{
  /* PriorityManagement::From_SB::IfBlock1::else::else::else::else::else::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* PriorityManagement::From_SB::IfBlock1::else::else::else::else::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* PriorityManagement::From_SB::FromSB_To_NewMode */ T_Mode_Level_And_Mode_Types_Pkg FromSB_To_NewMode;
  ...
  /* ck_Condition1 */ if (Condition1) {
  ...
  else /* ck_anon_activ */ if (ConditionSB2TR) {
    ...
    /* ck_anon_activ */ if (_1_else_clock_IfBlock1) {
    ...
    else /* ck_anon_activ */ if (Condition10) {
      ...
      else /* ck_anon_activ */ if (Condition60) {
        FromSB_To_NewMode = UN_Level_And_Mode_Types_Pkg;
      }
      else /* ck_anon_activ */ if (Condition58) {
