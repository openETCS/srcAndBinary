  ...
  /* TargetLimits_Pkg::TargetSelector::D_maxsafefront */ L_internal_real_Type_SDM_Types_Pkg *D_maxsafefront)
{
  ...
  kcg_int i;
  /* TargetLimits_Pkg::TargetSelector */ V_internal_real_Type_SDM_Types_Pkg tmp;
  /* TargetLimits_Pkg::TargetSelector::_L29 */ TargetIteratorAkku_TargetLimits_Pkg _L29;
  /* TargetLimits_Pkg::TargetSelector::_L59 */ kcg_bool _L59;
  /* TargetLimits_Pkg::TargetSelector::_L60 */ TargetIteratorAkku_TargetLimits_Pkg _L60;
  /* TargetLimits_Pkg::TargetSelector::_L55 */ kcg_int _L55;
