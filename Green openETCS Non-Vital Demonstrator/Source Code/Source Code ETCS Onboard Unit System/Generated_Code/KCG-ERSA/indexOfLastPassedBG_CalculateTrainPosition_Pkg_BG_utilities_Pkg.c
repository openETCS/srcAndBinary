...
{
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastPassedBG */ kcg_int acc;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastPassedBG */ kcg_bool cond_iterw;
  kcg_int i;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfLastPassedBG */ positionedBG_T_TrainPosition_Types_Pck tmp;
