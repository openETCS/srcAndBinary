...
{
  /* TM_trackside::Write_P135::_L21 */ kcg_int _L21;
  /* TM_trackside::Write_P135::_L22 */ kcg_int _L22;
  /* TM_trackside::Write_P135::_L44 */ CompressedPacketData_T_Common_Types_Pkg _L44;
  /* TM_trackside::Write_P135::_L43 */ MetadataElement_T_Common_Types_Pkg _L43;
  
  *Error = kcg_false;
  /* 1 */ C_P135_tracksim_compr_TM_conversions(Packet135, &_L43, &_L44);
  /* 1 */
