...
{
  /* CheckBGConsistency_Pkg::CheckBGConsistency::IfBlock1::else */ kcg_bool else_clock_IfBlock1;
  ...
  /* CheckBGConsistency_Pkg::CheckBGConsistency::compatibleVersion */ kcg_bool compatibleVersion;
