  ...
  /* TM_lib_internal::BufferOutput_read_write4::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_97166(&(*Buffer_Out)[0], (array_97166 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_97487(&(*Buffer_Out)[0], (array_97487 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_98379(&(*Buffer_Out)[4], (array_98379 *) &(*Buffer_In)[0]);
