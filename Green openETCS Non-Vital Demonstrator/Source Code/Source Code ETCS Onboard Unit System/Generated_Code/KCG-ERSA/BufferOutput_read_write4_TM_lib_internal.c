  ...
  *Stacksize_new = Stacksize_old + 3;
  if (_L34) {
    ...
    kcg_copy_array__113307(
      &(*Buffer_Out)[0],
      (array__113307 *) &(*Message_In)[1]);
    kcg_copy_array__108361(&(*Buffer_Out)[3], &_L40);
  }
  else {
    ...
    kcg_copy_array__112812(
      &(*Buffer_Out)[0],
      (array__112812 *) &(*Message_In)[0]);
  }
  kcg_copy_array__113303(&(*Buffer_Out)[4], (array__113303 *) &(*Buffer_In)[0]);
}
