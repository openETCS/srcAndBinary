...
void MA_Normalize_Sections_loop_TA_MA_new(
  ...
  /* TA_MA_new::MA_Normalize_Sections_loop::ProfileIn */ MovementAuthoritySectionlist_t_TrackAtlasTypes *ProfileIn,
  /* TA_MA_new::MA_Normalize_Sections_loop::pos_BG */ L_internal_Type_Obu_BasicTypes_Pkg pos_BG,
  /* TA_MA_new::MA_Normalize_Sections_loop::ProfileNormalized_LRBG */ MovementAuthoritySectionlist_t_TrackAtlasTypes *ProfileNormalized_LRBG)
{
  /* TA_MA_new::MA_Normalize_Sections_loop */ MovementAuthoritySection_t_TrackAtlasTypes tmp;
  /* TA_MA_new::MA_Normalize_Sections_loop::_L4 */ MovementAuthoritySection_t_TrackAtlasTypes _L4;
