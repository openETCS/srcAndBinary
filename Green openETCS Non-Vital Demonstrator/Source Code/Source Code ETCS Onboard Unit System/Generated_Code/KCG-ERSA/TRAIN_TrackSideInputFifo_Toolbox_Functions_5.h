...
typedef struct {
  ...
  array_120937 /* Toolbox::Functions::TRAIN_TrackSideInputFifo::IfBlock1::then::_L4 */ _L4_IfBlock1;
  array_120937 /* Toolbox::Functions::TRAIN_TrackSideInputFifo::buffer */ buffer;
