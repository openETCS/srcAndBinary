...
void TimingChecker_CheckEuroradioMessage(
  ...
  outC_TimingChecker_CheckEuroradioMessage *outC)
{
  /* CheckEuroradioMessage::TimingChecker */ T_internal_Type_Obu_BasicTypes_Pkg tmp;
  /* CheckEuroradioMessage::TimingChecker::IfBlock1::then::_L24 */ kcg_bool _L24_IfBlock1;
  /* CheckEuroradioMessage::TimingChecker::IfBlock1::then::_L9 */ kcg_bool _L9_IfBlock1;
  /* CheckEuroradioMessage::TimingChecker::IfBlock1::else */ kcg_bool else_clock_IfBlock1;
  /* CheckEuroradioMessage::TimingChecker::IfBlock1::else::else::connectingStatusConnecting */ kcg_bool _1_connectingStatusConnecting_IfBlock1;
  /* CheckEuroradioMessage::TimingChecker::IfBlock1::else::then::connectingStatusConnecting */ kcg_bool connectingStatusConnecting_IfBlock1;
  /* CheckEuroradioMessage::TimingChecker::ignoreTimestamp */ kcg_bool last_ignoreTimestamp;
  /* CheckEuroradioMessage::TimingChecker::lastKnownTTrain */ T_TRAIN last_lastKnownTTrain;
  /* CheckEuroradioMessage::TimingChecker::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* CheckEuroradioMessage::TimingChecker::TimestampKnown */ kcg_bool TimestampKnown;
