...
{
  /* TM_lib_internal::BufferOutput_write_only::IfBlock1::else */ kcg_bool _2_else_clock_IfBlock1;
  /* TM_lib_internal::BufferOutput_write_only::IfBlock1::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* TM_lib_internal::BufferOutput_write_only::IfBlock1::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* TM_lib_internal::BufferOutput_write_only::IfBlock1 */ kcg_bool IfBlock1_clock;
