...
{
  /* Librairies::Mode_Profile_Calculations */ kcg_bool tmp;
  /* Librairies::Mode_Profile_Calculations::IfBlock2::else */ kcg_bool else_clock_IfBlock2;
  /* Librairies::Mode_Profile_Calculations::IfBlock2 */ kcg_bool IfBlock2_clock;
  /* Librairies::Mode_Profile_Calculations::Condition_Ok */ kcg_bool Condition_Ok;
  /* Librairies::Mode_Profile_Calculations::_L35 */ kcg_bool _L35;
