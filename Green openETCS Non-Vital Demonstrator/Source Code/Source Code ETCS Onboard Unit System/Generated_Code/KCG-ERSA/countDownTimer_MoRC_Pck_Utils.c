...
void countDownTimer_MoRC_Pck_Utils(
  ...
  outC_countDownTimer_MoRC_Pck_Utils *outC)
{
  /* MoRC_Pck::Utils::countDownTimer */ kcg_bool tmp1;
  /* MoRC_Pck::Utils::countDownTimer */ kcg_bool tmp;
  /* MoRC_Pck::Utils::countDownTimer::TimerStatus_SM::Counting::_L7 */ kcg_bool _L7_TimerStatus_SM_Counting;
  ...
  /* MoRC_Pck::Utils::countDownTimer::TimerStatus_SM */ SSM_TR_TimerStatus_SM TimerStatus_SM_fired_strong;
