...
{
  /* ComputeModesConditions */ kcg_bool tmp;
  /* ComputeModesConditions::Loc_Service_Brake_Command_SH */ kcg_bool Loc_Service_Brake_Command_SH;
  /* ComputeModesConditions::Loc_Clean_BG_List_SH_Area_SH */ kcg_bool Loc_Clean_BG_List_SH_Area_SH;
  /* ComputeModesConditions::Loc_Service_Brake_Command_OS */ kcg_bool Loc_Service_Brake_Command_OS;
  /* ComputeModesConditions::Loc_Service_Brake_Command_LS */ kcg_bool Loc_Service_Brake_Command_LS;
  /* ComputeModesConditions::Loc_Clean_BG_List_Of_SoM */ kcg_bool Loc_Clean_BG_List_Of_SoM;
  /* ComputeModesConditions::Loc_End_Of_Mission_Procedure_Req_SH */ kcg_bool Loc_End_Of_Mission_Procedure_Req_SH;
  /* ComputeModesConditions::Loc_End_Of_Mission_Procedure_Req_SB */ kcg_bool Loc_End_Of_Mission_Procedure_Req_SB;
  /* ComputeModesConditions::Loc_End_Of_Mission_Procedure_Req_TR */ kcg_bool Loc_End_Of_Mission_Procedure_Req_TR;
  /* ComputeModesConditions::Loc_Clean_BG_List_SH_Area_TR */ kcg_bool Loc_Clean_BG_List_SH_Area_TR;
  /* ComputeModesConditions::Loc_End_Of_Mission_Procedure_Req_SoM */ kcg_bool Loc_End_Of_Mission_Procedure_Req_SoM;
  /* ComputeModesConditions::Loc_Request_For_SH_To_RBC_SH */ kcg_bool Loc_Request_For_SH_To_RBC_SH;
  /* ComputeModesConditions::Loc_SH_Refused_By_RBC_To_DMI_SH */ kcg_bool Loc_SH_Refused_By_RBC_To_DMI_SH;
  /* ComputeModesConditions::Loc_Request_For_SH_To_RBC_TR */ kcg_bool Loc_Request_For_SH_To_RBC_TR;
  /* ComputeModesConditions::Loc_SH_Refused_By_RBC_To_DMI_TR */ kcg_bool Loc_SH_Refused_By_RBC_To_DMI_TR;
  /* ComputeModesConditions::Loc_SH_Refused_By_RBC_To_DMI_SoM */ kcg_bool Loc_SH_Refused_By_RBC_To_DMI_SoM;
  /* ComputeModesConditions::Loc_Request_For_SH_To_RBC_SoM */ kcg_bool Loc_Request_For_SH_To_RBC_SoM;
  /* ComputeModesConditions::Loc_Cond_5_SH */ kcg_bool Loc_Cond_5_SH;
  /* ComputeModesConditions::Loc_Cond_6_SH */ kcg_bool Loc_Cond_6_SH;
  /* ComputeModesConditions::Loc_Cond_50_SH */ kcg_bool Loc_Cond_50_SH;
  /* ComputeModesConditions::Loc_Cond_6_TR */ kcg_bool Loc_Cond_6_TR;
  /* ComputeModesConditions::Loc_Cond_5_TR */ kcg_bool Loc_Cond_5_TR;
  /* ComputeModesConditions::Loc_Cond_50_TR */ kcg_bool Loc_Cond_50_TR;
  /* ComputeModesConditions::Loc_Cond_6_SoM */ kcg_bool Loc_Cond_6_SoM;
  /* ComputeModesConditions::Loc_Cond_5_SoM */ kcg_bool Loc_Cond_5_SoM;
  /* ComputeModesConditions::Loc_Cond_50_SoM */ kcg_bool Loc_Cond_50_SoM;
  /* ComputeModesConditions::Loc_Cond_15_OS */ kcg_bool Loc_Cond_15_OS;
  /* ComputeModesConditions::Loc_Cond_70_LS */ kcg_bool Loc_Cond_70_LS;
  /* ComputeModesConditions::Loc_Cond_70_TR */ kcg_bool Loc_Cond_70_TR;
  /* ComputeModesConditions::Loc_Cond_15_TR */ kcg_bool Loc_Cond_15_TR;
  /* ComputeModesConditions::Loc_Cond_70_SoM */ kcg_bool Loc_Cond_70_SoM;
  /* ComputeModesConditions::Loc_Cond_46_SoM */ kcg_bool Loc_Cond_46_SoM;
  /* ComputeModesConditions::Loc_Cond_15_SoM */ kcg_bool Loc_Cond_15_SoM;
  /* ComputeModesConditions::Loc_Cond_8_TR */ kcg_bool Loc_Cond_8_TR;
  /* ComputeModesConditions::Loc_Cond_8_SoM */ kcg_bool Loc_Cond_8_SoM;
  /* ComputeModesConditions::Loc_Ack_LS_Req_To_Driver_TR */ kcg_bool Loc_Ack_LS_Req_To_Driver_TR;
  /* ComputeModesConditions::Loc_Ack_OS_Req_To_Driver_TR */ kcg_bool Loc_Ack_OS_Req_To_Driver_TR;
  /* ComputeModesConditions::Loc_Ack_SH_Req_To_Driver_TR */ kcg_bool Loc_Ack_SH_Req_To_Driver_TR;
  /* ComputeModesConditions::Loc_Ack_SR_Req_To_Driver_TR */ kcg_bool Loc_Ack_SR_Req_To_Driver_TR;
  /* ComputeModesConditions::Loc_Ack_SR_Req_To_Driver_SoM */ kcg_bool Loc_Ack_SR_Req_To_Driver_SoM;
  /* ComputeModesConditions::Loc_Ack_SH_Req_To_Driver_SoM */ kcg_bool Loc_Ack_SH_Req_To_Driver_SoM;
  /* ComputeModesConditions::Loc_Ack_OS_Req_To_Driver_SoM */ kcg_bool Loc_Ack_OS_Req_To_Driver_SoM;
  /* ComputeModesConditions::Loc_Ack_LS_Req_To_Driver_SoM */ kcg_bool Loc_Ack_LS_Req_To_Driver_SoM;
  /* ComputeModesConditions::Loc_Ack_SH_Req_To_Driver_SH */ kcg_bool Loc_Ack_SH_Req_To_Driver_SH;
  /* ComputeModesConditions::Loc_Ack_OS_Req_To_Driver_OS */ kcg_bool Loc_Ack_OS_Req_To_Driver_OS;
  /* ComputeModesConditions::Loc_Ack_LS_Req_To_Driver_LS */ kcg_bool Loc_Ack_LS_Req_To_Driver_LS;
  /* ComputeModesConditions::Loc_MA_Req_To_RBC_SoM */ kcg_bool Loc_MA_Req_To_RBC_SoM;
  /* ComputeModesConditions::Loc_MA_Req_To_RBC_TR */ kcg_bool Loc_MA_Req_To_RBC_TR;
  /* ComputeModesConditions::Loc_Cond_31_FS */ kcg_bool Loc_Cond_31_FS;
  /* ComputeModesConditions::Loc_Cond_31_TR */ kcg_bool Loc_Cond_31_TR;
