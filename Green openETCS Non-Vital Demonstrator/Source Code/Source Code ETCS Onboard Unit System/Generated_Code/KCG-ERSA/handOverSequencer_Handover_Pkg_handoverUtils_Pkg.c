  ...
  outC_handOverSequencer_Handover_Pkg_handoverUtils_Pkg *outC)
{
  ...
  static kcg_bool sessionWithHandingOverRBC_terminated_IfBlock1_handOver_with_2_Sessions_SM_WaitForHandingOverRBCTerminated;
  ...
  static kcg_bool terminationWithHandingOverRBCOrdered_IfBlock1_handOver_with_2_Sessions_SM_WaitForTerminationOrderFromHandingOverRBC;
  ...
  static kcg_bool sessionWithAcceptingRBCEstablished_IfBlock1_handOver_with_2_Sessions_SM_WaitForSessionWithAcceptingRBCEstablished;
  ...
  if (IfBlock1_clock) {
    ...
    switch (handOver_with_2_Sessions_SM_state_act_IfBlock1) {
      ...
      case SSM_st_WaitForSessionWithAcceptingRBCEstablished_IfBlock1_handOver_with_2_Sessions_SM :
        ...
        outC->sendPositionReport_2_acceptingRBC = kcg_false;
        outC->sendPositionReport_2_handingOverRBC = kcg_false;
        sessionWithAcceptingRBCEstablished_IfBlock1_handOver_with_2_Sessions_SM_WaitForSessionWithAcceptingRBCEstablished =
        ...
        if (sessionWithAcceptingRBCEstablished_IfBlock1_handOver_with_2_Sessions_SM_WaitForSessionWithAcceptingRBCEstablished) {
          outC->handOver_with_2_Sessions_SM_state_nxt_IfBlock1 =
