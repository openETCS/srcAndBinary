...
void SH_Initiated_By_Driver_On_Procedures(
  ...
  outC_SH_Initiated_By_Driver_On_Procedures *outC)
{
  /* Procedures::SH_Initiated_By_Driver_On::SM_SH_Initiated_By_Driver::SH_procedure_possible */ kcg_bool br_1_guard_SM_SH_Initiated_By_Driver_SH_procedure_possible;
  /* Procedures::SH_Initiated_By_Driver_On::SM_SH_Initiated_By_Driver::Issue_SH_Request_L2_L3 */ kcg_bool br_2_guard_SM_SH_Initiated_By_Driver_Issue_SH_Request_L2_L3;
  /* Procedures::SH_Initiated_By_Driver_On::SM_SH_Initiated_By_Driver */ SSM_ST_SM_SH_Initiated_By_Driver SM_SH_Initiated_By_Driver_state_sel;
  /* Procedures::SH_Initiated_By_Driver_On::SM_SH_Initiated_By_Driver */ SSM_ST_SM_SH_Initiated_By_Driver SM_SH_Initiated_By_Driver_state_act;
  /* Procedures::SH_Initiated_By_Driver_On::Loc_Level_2_3 */ kcg_bool Loc_Level_2_3;
