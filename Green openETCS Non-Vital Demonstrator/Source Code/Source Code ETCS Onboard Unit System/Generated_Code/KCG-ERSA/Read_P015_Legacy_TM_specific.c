...
void Read_P015_Legacy_TM_specific(
  ...
  /* TM_specific::Read_P015_Legacy::P015_legacy_out */_5_P15_Level23MovementAuthorities_T_Packet_Types_Pkg *P015_legacy_out)
{
  ...
  if (_L1) {
    ...
    kcg_copy__5_P15_Level23MovementAuthorities_T_Packet_Types_Pkg(
      P015_legacy_out,
      (_5_P15_Level23MovementAuthorities_T_Packet_Types_Pkg *)
