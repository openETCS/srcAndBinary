...
{
  /* TA_Lib_internal::FindStartOfNewSpeedProfileAbs_LOOP */ V_internal_Type_Obu_BasicTypes_Pkg tmp;
  /* TA_Lib_internal::FindStartOfNewSpeedProfileAbs_LOOP::_L4 */ StaticSpeedSection_t_TrackAtlasTypes _L4;
