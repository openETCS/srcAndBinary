...
DMI_vMax_id_INT_T_DATA CAST_DMI_vMax_id_to_int_DATA_Variables(
  /* DATA::Variables::CAST_DMI_vMax_id_to_int::dmi_vmax_id_ct */ DMI_vMax_id_T_DMI_Types_Pkg *dmi_vmax_id_ct)
{
  /* DATA::Variables::CAST_DMI_vMax_id_to_int::_L23 */ kcg_int _L23;
  /* DATA::Variables::CAST_DMI_vMax_id_to_int::_L26 */ kcg_bool _L26;
  /* DATA::Variables::CAST_DMI_vMax_id_to_int::_L25 */ kcg_int _L25;
  /* DATA::Variables::CAST_DMI_vMax_id_to_int::_L28 */ kcg_int _L28;
  /* DATA::Variables::CAST_DMI_vMax_id_to_int::dmi_vmax_id_int */ DMI_vMax_id_INT_T_DATA dmi_vmax_id_int;
...
/* $**************** KCG Version 6.4 (build i21) ****************
** CAST_DMI_vMax_id_to_int_DATA_Variables.c
** Generation date: 2015-12-07T14:47:39
*************************************************************$ */
