...
{
  /* InformationFilter_Pkg::FirstFilter::Exception030405Reject::_L5 */ kcg_bool _L5;
  /* InformationFilter_Pkg::FirstFilter::Exception030405Reject::_L6 */ kcg_bool _L6;
  /* InformationFilter_Pkg::FirstFilter::Exception030405Reject::_L3 */ kcg_bool _L3;
  /* InformationFilter_Pkg::FirstFilter::Exception030405Reject::_L1 */ kcg_bool _L1;
