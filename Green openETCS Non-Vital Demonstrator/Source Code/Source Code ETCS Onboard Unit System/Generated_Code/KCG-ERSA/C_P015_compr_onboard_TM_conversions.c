...
{
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1 */ kcg_bool IfBlock1_clock_2;
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1::else::else */ kcg_bool _1_else_clock_2_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_SCALE::IfBlock1::else */ kcg_bool _2_else_clock_2_IfBlock1;
  /* TM_conversions::CAST_Int_to_Q_DIR::IfBlock1::else */ kcg_bool else_clock_2_IfBlock1;
  /* TM_conversions::C_P015_compr_onboard::nid_packet_ok */ kcg_bool nid_packet_ok;
  /* TM_conversions::C_P015_compr_onboard::_L138 */ array_int_15 _L138;
  /* TM_conversions::C_P015_compr_onboard::_L125 */ array_int_6 _L125;
