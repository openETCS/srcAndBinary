...
void C_int_to_DMI_Train_Running_Number_DATA_Packets_Bothways(
  ...
  /* DATA::Packets::Bothways::C_int_to_DMI_Train_Running_Number::dmi_train_running_number_ct */_23_DMI_Train_Running_Number_T_DMI_Messages_Bothways_Pkg *dmi_train_running_number_ct)
{
