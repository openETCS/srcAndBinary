  ...
  *Stacksize_new = Stacksize_old + 1;
  if (_L34) {
    kcg_copy_M_TrainTrack_Message_T_TM_radio_messages(
      Message_out,
      &(*Message_In)[0]);
    kcg_copy_array__108361(
      &(*Buffer_Out)[0],
      (array__108361 *) &(*Message_In)[1]);
    kcg_copy_array__108361(&(*Buffer_Out)[1], &_L40);
  }
  else {
    ...
    kcg_copy_array__113314(
      &(*Buffer_Out)[0],
      (array__113314 *) &(*Message_In)[0]);
  }
  kcg_copy_array__113317(&(*Buffer_Out)[2], (array__113317 *) &(*Buffer_In)[0]);
}
