  ...
  /* TM_lib_internal::BufferOutput_read_write2::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_99830(&(*Buffer_Out)[0], (array_99830 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_96877(&(*Buffer_Out)[0], (array_96877 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_96935(&(*Buffer_Out)[2], (array_96935 *) &(*Buffer_In)[0]);
