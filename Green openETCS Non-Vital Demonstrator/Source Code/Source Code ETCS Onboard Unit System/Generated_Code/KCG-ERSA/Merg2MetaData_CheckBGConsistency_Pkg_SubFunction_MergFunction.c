...
{
  /* CheckBGConsistency_Pkg::SubFunction::MergFunction::Merg2MetaData */ MetadataElement_T_Common_Types_Pkg tmp1;
  /* CheckBGConsistency_Pkg::SubFunction::MergFunction::Merg2MetaData */ MetadataElement_T_Common_Types_Pkg tmp;
