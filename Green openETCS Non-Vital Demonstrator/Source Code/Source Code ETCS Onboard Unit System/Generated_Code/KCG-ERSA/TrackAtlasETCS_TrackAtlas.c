...
{
  /* TrackAtlas::TrackAtlasETCS */ MRSP_Profile_t_TrackAtlasTypes acc;
  kcg_int i;
  /* TrackAtlas::TrackAtlasETCS::valid_MA */ kcg_bool valid_MA;
  /* TrackAtlas::TrackAtlasETCS::valid_GP */ kcg_bool valid_GP;
  /* TrackAtlas::TrackAtlasETCS::MRSP_export */ MRSP_Profile_t_TrackAtlasTypes MRSP_export;
  /* TrackAtlas::TrackAtlasETCS::_L21 */ P003V1_OBU_T_TM_baseline2 _L21;
  /* TrackAtlas::TrackAtlasETCS::_L78 */ T_Data_From_Track_Mess_Level_And_Mode_Types_Pkg _L78;
  /* TrackAtlas::TrackAtlasETCS::_L82 */ kcg_bool _L82;
  /* TrackAtlas::TrackAtlasETCS::_L83 */ kcg_bool _L83;
  /* TrackAtlas::TrackAtlasETCS::_L84 */ kcg_bool _L84;
  /* TrackAtlas::TrackAtlasETCS::_L85 */ kcg_bool _L85;
  /* TrackAtlas::TrackAtlasETCS::_L101 */ GradientProfile_t_TrackAtlasTypes _L101;
