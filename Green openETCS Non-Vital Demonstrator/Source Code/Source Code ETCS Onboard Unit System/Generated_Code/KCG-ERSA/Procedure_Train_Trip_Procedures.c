...
void Procedure_Train_Trip_Procedures(
  ...
  outC_Procedure_Train_Trip_Procedures *outC)
{
  /* Procedures::Procedure_Train_Trip */ kcg_bool tmp;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip::Trip_Mode_Waiting_Ack */ kcg_bool _2_br_2_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip::Trip_Mode_Waiting_Ack */ kcg_bool _1_br_1_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip::Trip_Mode_Waiting_Ack */ kcg_bool br_2_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip::Trip_Mode_Waiting_Ack */ kcg_bool br_1_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip::Post_Trip_Mode */ kcg_bool br_2_guard_SM_Train_Trip_Post_Trip_Mode;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip::Post_Trip_Mode */ kcg_bool br_1_guard_SM_Train_Trip_Post_Trip_Mode;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip */ SSM_ST_SM_Train_Trip SM_Train_Trip_state_sel;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip */ SSM_ST_SM_Train_Trip SM_Train_Trip_state_act;
  /* Procedures::Procedure_Train_Trip::SM_Train_Trip */ kcg_bool SM_Train_Trip_reset_act;
  ...
  /* sel_SM_Train_Trip */ switch (SM_Train_Trip_state_sel) {
    ...
    case SSM_st_Trip_Mode_Waiting_Ack_SM_Train_Trip :
      ...
      _1_br_1_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack = Current_Level ==
        M_LEVEL_Level_0;
      _2_br_2_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack = Current_Level ==
      ...
      br_2_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack =
        ...
        (_1_br_1_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack |
          _2_br_2_guard_SM_Train_Trip_Trip_Mode_Waiting_Ack);
