...
void handleTraction_output_to_TIU_API_Pkg(
  ...
  outC_handleTraction_output_to_TIU_API_Pkg *outC)
{
  /* output_to_TIU_API_Pkg::handleTraction::tempTractionCutOffStatus */ M_traction_cutoff_command_T_TIU_Types_Pkg tempTractionCutOffStatus;
  /* output_to_TIU_API_Pkg::handleTraction::_L8 */ M_traction_cutoff_command_T_TIU_Types_Pkg _L8;
  /* output_to_TIU_API_Pkg::handleTraction::_L11 */ kcg_bool _L11;
