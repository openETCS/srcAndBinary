...
{
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp9;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp8;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp7;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp6;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp5;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp4;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp3;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp2;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp1;
  /* TA_MRSP_new::Build_MRSP */ SSP_cat_t_TA_MRSP tmp;
  /* TA_MRSP_new::Build_MRSP::_L2 */ SSP_matrix_t_TA_MRSP _L2;
  /* TA_MRSP_new::Build_MRSP::_L21 */ kcg_bool _L21;
