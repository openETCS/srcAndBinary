...
{
  /* TM_conversions::CAST_Q_EMERGENCYSTOP_to_int::IfBlock1::else */ kcg_bool _2_else_clock_IfBlock1;
  /* TM_conversions::CAST_Q_EMERGENCYSTOP_to_int::IfBlock1::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* TM_conversions::CAST_Q_EMERGENCYSTOP_to_int::IfBlock1::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* TM_conversions::CAST_Q_EMERGENCYSTOP_to_int::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* TM_conversions::CAST_Q_EMERGENCYSTOP_to_int::q_emergencystop_int */ kcg_int q_emergencystop_int;
