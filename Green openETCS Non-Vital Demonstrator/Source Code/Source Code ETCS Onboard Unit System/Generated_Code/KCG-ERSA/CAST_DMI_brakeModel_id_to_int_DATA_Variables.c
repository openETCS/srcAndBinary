...
{
  /* DATA::Variables::CAST_DMI_brakeModel_id_to_int::_L23 */ kcg_int _L23;
  /* DATA::Variables::CAST_DMI_brakeModel_id_to_int::_L26 */ kcg_bool _L26;
  /* DATA::Variables::CAST_DMI_brakeModel_id_to_int::_L25 */ kcg_int _L25;
  /* DATA::Variables::CAST_DMI_brakeModel_id_to_int::_L28 */ kcg_int _L28;
  /* DATA::Variables::CAST_DMI_brakeModel_id_to_int::dmi_brakeModel_id_int */ DMI_brakeModel_id_INT_T_DATA dmi_brakeModel_id_int;
