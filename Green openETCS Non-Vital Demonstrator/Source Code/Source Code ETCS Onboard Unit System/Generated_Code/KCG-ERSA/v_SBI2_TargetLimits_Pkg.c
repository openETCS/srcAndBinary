...
{
  /* TargetLimits_Pkg::v_SBI2 */ L_internal_real_Type_SDM_Types_Pkg tmp3;
  /* TargetLimits_Pkg::v_SBI2 */ V_internal_real_Type_SDM_Types_Pkg tmp2;
  /* TargetLimits_Pkg::v_SBI2 */ kcg_bool tmp1;
  /* TargetLimits_Pkg::v_SBI2 */ V_internal_real_Type_SDM_Types_Pkg tmp;
  /* TargetLimits_Pkg::v_SBI2::_L19 */ L_internal_real_Type_SDM_Types_Pkg _L19;
  /* TargetLimits_Pkg::v_SBI2::_L33 */ kcg_bool _L33;
  /* TargetLimits_Pkg::v_SBI2::_L49 */ kcg_real _L49;
  /* TargetLimits_Pkg::v_SBI2::_L48 */ kcg_bool _L48;
  /* TargetLimits_Pkg::v_SBI2::_L47 */ kcg_bool _L47;
  /* TargetLimits_Pkg::v_SBI2::_L54 */ kcg_bool _L54;
