...
void genMsgToBus_RCM_Utils_Pkg_encoders(
  ...
  outC_genMsgToBus_RCM_Utils_Pkg_encoders *outC)
{
  /* RCM_Utils_Pkg::encoders::genMsgToBus */ struct_121988 mk_struct;
  /* RCM_Utils_Pkg::encoders::genMsgToBus */ struct_121988 _1_mk_struct;
  /* RCM_Utils_Pkg::encoders::genMsgToBus */ struct_121988 _2_mk_struct;
  /* RCM_Utils_Pkg::encoders::genMsgToBus */ struct_121988 _3_mk_struct;
