...
{
  /* manage_DMI_Input_Pkg::receiveRequestsModesAndLevel::_L5 */ DMI_To_Modes_T_DMI_Types_Pkg _L5;
  /* manage_DMI_Input_Pkg::receiveRequestsModesAndLevel::_L9 */ DMI_DriverRequest_T_DMI_Types_Pkg _L9;
