...
void Supervise_Events_ProvidePositionReport_Pkg(
  ...
  outC_Supervise_Events_ProvidePositionReport_Pkg *outC)
{
  /* ProvidePositionReport_Pkg::Supervise_Events::_L15 */ kcg_bool _L15;
  /* ProvidePositionReport_Pkg::Supervise_Events::_L16 */ positionedBG_T_TrainPosition_Types_Pck _L16;
