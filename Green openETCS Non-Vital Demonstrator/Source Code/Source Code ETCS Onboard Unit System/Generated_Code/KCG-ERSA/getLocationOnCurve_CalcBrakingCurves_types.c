...
{
  /* CalcBrakingCurves_types::getLocationOnCurve */ ParabolaArc_T_CalcBrakingCurves_types mk_struct;
  /* CalcBrakingCurves_types::getLocationOnCurve */ kcg_int acc;
  kcg_int i;
  /* CalcBrakingCurves_types::searchIdxFloorBackward */ V_internal_real_Type_SDM_Types_Pkg tmp_1;
  /* CalcBrakingCurves_types::getLocationOnCurve */ kcg_real tmp2;
  /* CalcBrakingCurves_types::getLocationOnCurve */ kcg_real tmp1;
  /* CalcBrakingCurves_types::getLocationOnCurve */ kcg_real tmp;
