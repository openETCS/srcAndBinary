  ...
  outC_EVC *outC)
{
  ...
  outC->resetOut = _25_EVC_reset;
  /* last_init_ck_EVC_PersistentData */ if (outC->init13) {
    ...
    tmp21 = outC->EVC_currentNTC;
    kcg_copy_PT0_PositionReport_T_Packet_TrainTypes_Pkg(&_L1219, &outC->rep_P0);
    kcg_copy_PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg(
      &_L1321,
      &outC->rep_P1);
    kcg_copy_trainData_Events_T_trainData_Types_pkg(&tmp20, &outC->td_events);
    tmp19 = outC->DMI_sdmToDMI.location_brake_curve_starting_point;
    _L813 = outC->MoRC_newSessionEstablished;
    EVC_cabIsOpen = outC->EVC_ready;
  ...
  outC->td_events.MoRCreadyFlag = EVC_cabIsOpen;
