...
void EVC(
  ...
  outC_EVC *outC)
{
  static struct__107963 tmp;
  static struct__105890 tmp1;
  static struct__107244 tmp2;
  static struct__107230 tmp3;
  static struct__107224 tmp4;
  static struct__108188 tmp5;
  static struct__108206 tmp6;
  static struct__108168 tmp7;
  static struct__108176 tmp8;
  static struct__107324 tmp9;
  ...
  tmp13 = outC->Context_5.outTIUStatus.valid &
    outC->Context_5.outTIUStatus.deskOpen;
  if (tmp13) {
    if (outC->init) {
      kcg_copy_ps_dataForStartOfMission_T_API_PersistanceStorage_Pkg(
