...
{
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator */ kcg_real tmp;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::v_delta0rsob */ V_internal_real_Type_SDM_Types_Pkg v_delta0rsob;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::_L21 */ V_internal_real_Type_SDM_Types_Pkg _L21;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::_L20 */ kcg_bool _L20;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::_L32 */ L_internal_real_Type_SDM_Types_Pkg _L32;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::_L31 */ kcg_bool _L31;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::_L40 */ kcg_real _L40;
  /* TargetLimits_Pkg::v_ReleaseOnboardIterator::_L50 */ kcg_bool _L50;
