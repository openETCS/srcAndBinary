...
{
  /* RCM_Utils_Pkg::encoders::extractPositionReportFromBus_itr::_L8 */ M_TrainTrack_Message_T_TM_radio_messages _L8;
  /* RCM_Utils_Pkg::encoders::extractPositionReportFromBus_itr::_L89 */ kcg_bool _L89;
