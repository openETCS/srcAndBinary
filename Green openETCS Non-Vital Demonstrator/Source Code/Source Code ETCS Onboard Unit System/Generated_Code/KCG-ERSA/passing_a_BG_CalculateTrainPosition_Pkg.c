...
{
  /* CalculateTrainPosition_Pkg::passing_a_BG */ positionedBG_T_TrainPosition_Types_Pck tmp1;
  /* CalculateTrainPosition_Pkg::passing_a_BG */ positionedBGs_T_TrainPosition_Types_Pck tmp;
