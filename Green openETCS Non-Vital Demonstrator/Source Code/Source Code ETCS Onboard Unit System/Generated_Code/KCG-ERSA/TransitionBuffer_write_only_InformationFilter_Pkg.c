...
{
  /* InformationFilter_Pkg::TransitionBuffer_write_only */ array_104474 tmp;
  ...
  /* 2 */ if (Reset) {
    _L2 = 0 + 1;
    kcg_copy_array_104474(
      &tmp,
      (array_104474 *) &DEFAULT_TransitionBuffer_t_InformationFilter_Pkg[0]);
  }
  else {
    _L2 = Stacksize_old + 1;
    kcg_copy_array_104474(&tmp, (array_104474 *) &(*Buffer_In)[0]);
  }
  kcg_copy_ReceivedMessage_T_Common_Types_Pkg(
    &(&(*Buffer_Out)[0])[0],
    Message_In);
  kcg_copy_array_104474(&(*Buffer_Out)[1], &tmp);
