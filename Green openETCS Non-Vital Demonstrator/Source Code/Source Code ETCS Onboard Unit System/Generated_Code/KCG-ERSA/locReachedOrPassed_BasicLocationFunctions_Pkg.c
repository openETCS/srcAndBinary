...
void locReachedOrPassed_BasicLocationFunctions_Pkg(
  ...
  outC_locReachedOrPassed_BasicLocationFunctions_Pkg *outC)
{
  /* BasicLocationFunctions_Pkg::locReachedOrPassed::_L35 */ kcg_bool _L35;
  /* BasicLocationFunctions_Pkg::locReachedOrPassed::_L40 */ LocWithInAcc_T_Obu_BasicTypes_Pkg _L40;
