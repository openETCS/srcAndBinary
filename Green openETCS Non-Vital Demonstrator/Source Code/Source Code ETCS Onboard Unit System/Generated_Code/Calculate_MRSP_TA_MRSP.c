  ...
  /* TA_MRSP::Calculate_MRSP::MRSP */MRSP_Profile_t_TrackAtlasTypes *MRSP)
{
  static kcg_bool tmp;
  static kcg_int i;
  /* TA_MRSP::Calculate_MRSP::_L1 */
  static SSP_t_list_t_TA_MRSP _L1;
  /* TA_MRSP::Calculate_MRSP::_L4 */
  static SSP_matrix_t_TA_MRSP _L4;
  /* TA_MRSP::Calculate_MRSP::_L3 */
  static SSP_t_matrix_t_TA_MRSP _L3;
  /* TA_MRSP::Calculate_MRSP::_L6 */
  static kcg_int _L6;
  /* TA_MRSP::Calculate_MRSP::_L17 */
  static kcg_int _L17;
