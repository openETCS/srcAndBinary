...
{
  /* CheckMandatoryVariablesAndMA::IfBlock1::else */
  static kcg_bool _9_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else */
  static kcg_bool _7_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else::else */
  static kcg_bool _5_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else::else::else::else */
  static kcg_bool _3_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else::else::else::else::else::else */
  static kcg_bool _1_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else::else::else::else::else::else::else */
  static kcg_bool else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else::else::else::else::else */
  static kcg_bool _2_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else::else::else */
  static kcg_bool _4_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else::else::else */
  static kcg_bool _6_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1::else::else */
  static kcg_bool _8_else_clock_IfBlock1;
  /* CheckMandatoryVariablesAndMA::IfBlock1 */
  static kcg_bool IfBlock1_clock;
  /* CheckMandatoryVariablesAndMA::valid */
