...
typedef struct {
  ...
  Radio_TrainTrack_Message_T_Radio_Types_Pkg /* TrackAtlas::TrackAtlasETCS::MA_request_out */ MA_request_out;
  Radio_TrainTrack_Message_T_Radio_Types_Pkg /* TrackAtlas::TrackAtlasETCS::message147 */ message147;
