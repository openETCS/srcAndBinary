...
{
  static SSP_relevant_target_t_TA_MRSP tmp2;
  static kcg_bool tmp1;
  static kcg_int i;
  static SSP_section_t_TA_MRSP tmp;
  /* TA_MRSP::MRSP_DetermineRelevantSpeedperCat::_L11 */
  static SSP_valid_section_t_TA_MRSP _L11;
  /* TA_MRSP::MRSP_DetermineRelevantSpeedperCat::_L30 */
  static SSP_relevant_target_t_TA_MRSP _L30;
  /* TA_MRSP::MRSP_DetermineRelevantSpeedperCat::ValidSpeed */
  static SSP_s_section_t_TA_MRSP ValidSpeed;
