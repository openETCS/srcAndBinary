...
V_internal_real_Type_SDM_Types_ dV_ebi_for_V_SDM_Types_Pkg(
  /* SDM_Types_Pkg::dV_ebi_for_V::V_input */ V_internal_real_Type_SDM_Types_ V_input)
{
  /* SDM_Types_Pkg::dV_ebi_for_V::_L8 */
  static kcg_real _L8;
  /* SDM_Types_Pkg::dV_ebi_for_V::dv_ebi */
  static V_internal_real_Type_SDM_Types_ dv_ebi;
