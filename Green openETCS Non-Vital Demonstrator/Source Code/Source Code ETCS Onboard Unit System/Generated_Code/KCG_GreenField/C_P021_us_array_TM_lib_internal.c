  ...
  /* TM_lib_internal::C_P021_us_array::sections */ P021_section_enum_T_TM *sections)
{
  ...
  _L16 = i * DIM_P021_n_sections_TM_lib_inte;
  (*sections).d_gradient = /* 1 */
    CAST_Int_to_D_GRADIENT_TM_conve(
      /* 1 */ C_P021_extract_el_section_TM_li(_L16, flat, 0));
  (*sections).q_gdir = /* 1 */
    CAST_Int_to_Q_GDIR_TM_conversio(
      /* 2 */ C_P021_extract_el_section_TM_li(_L16, flat, 1));
  (*sections).g_a = /* 1 */
    CAST_Int_to_G_A_TM_conversions(
      /* 3 */ C_P021_extract_el_section_TM_li(_L16, flat, 2));
  *cont = n_iter_int > i;
}
