  ...
  /* TA_EmergencyStop::NID_EM_Store::Manage_NID_EM_Store::outStore */ NID_EM_Store_T_TA_EmergencyStop *outStore)
{
  ...
  static array_100333 _L2_IfBlock1;
  ...
  static array_100333 _L24_IfBlock1;
  ...
  /* ck_IfBlock1 */ if (IfBlock1_clock) {
    ...
    kcg_copy_array_100333(&(*outStore).items, &_L2_IfBlock1);
    *handled = _L1_IfBlock1.handled;
    ...
    /* ck_anon_activ */ if (else_clock_IfBlock1) {
      ...
      kcg_copy_array_100333(&(*outStore).items, &_L24_IfBlock1);
