...
void C_P015_compr_onboard_TM_convers(
  /* TM_conversions::C_P015_compr_onboard::PacketData */ CompressedPacketData_T_Common_T *PacketData,
  /* TM_conversions::C_P015_compr_onboard::Metadata_Element */ MetadataElement_T_Common_Types_ *Metadata_Element,
  /* TM_conversions::C_P015_compr_onboard::P015_onboard */ P015_OBU_T_TM *P015_onboard)
{
  ...
  _1_else_clock_2_IfBlock1 = _L125[1] == INT_Q_DIR_nomiinal_TM_conversio;
  ...
  /* 2_ck_IfBlock1 */ if (_1_else_clock_2_IfBlock1) {
    (*P015_onboard).q_dir = ENUM_Q_DIR_nominal_TM_conversio;
  }
  else {
    else_clock_2_IfBlock1 = _L125[1] == INT_Q_DIR_reverse_TM_conversion;
    /* 2_ck_anon_activ */ if (else_clock_2_IfBlock1) {
      (*P015_onboard).q_dir = ENUM_Q_DIR_reverse_TM_conversio;
    }
    else {
  ...
  /* 2_ck_IfBlock1 */ if (IfBlock1_clock_2) {
    (*P015_onboard).q_scale = ENUM_Q_SCALE_10cm_TM_conversion;
  }
  else {
  ...
  (*P015_onboard).v_loa = /* 2 */ CAST_Int_to_V_LOA_TM_conversion(_L125[4]);
  (*P015_onboard).t_loa = /* 2 */ CAST_Int_to_T_LOA_TM_conversion(_L125[5]);
  /* 1 */
  C_P015_unflatten_sections_TM_li(
    nid_packet_ok,
    (*PacketData)[21],
...
/* $**************** KCG Version 6.4 (build i21) ****************
** C_P015_compr_onboard_TM_convers.c
** Generation date: 2015-11-11T16:04:21
*************************************************************$ */
