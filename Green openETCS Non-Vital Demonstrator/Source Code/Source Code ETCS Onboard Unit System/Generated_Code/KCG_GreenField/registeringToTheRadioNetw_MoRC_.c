...
void registeringToTheRadioNetw_init_(outC_registeringToTheRadioNetw_ *outC)
{
...
void registeringToTheRadioNetw_reset(outC_registeringToTheRadioNetw_ *outC)
{
  outC->init = kcg_true;
...
void registeringToTheRadioNetw_MoRC_(
  ...
  outC_registeringToTheRadioNetw_ *outC)
{
  ...
  static kcg_bool br_1_guard_Register_SM_Register;
  /* MoRC_Pck::Subfunc_Pkg::registeringToTheRadioNetwork_v2::Register_SM::Reregistering */
  static kcg_bool br_1_guard_Register_SM_Reregist;
  ...
  static mobileRegistrationStatus_T_RCM_ registrationStatus;
  /* MoRC_Pck::Subfunc_Pkg::registeringToTheRadioNetwork_v2::_L149 */
  static P45_RadioNetworkRegistration_T_ _L149;
  ...
  outC->p45_registrationOrderReceived_p = (*p45_registrationOrder).valid &
    _L185;
  /* 6 */
  RisingEdge_digital((*atPowerUpRadioNetworkID).valid, &outC->Context_6);
  _L185 = outC->Context_6.RE_Output | outC->Context_7.RE_Output |
    outC->p45_registrationOrderReceived_p;
  /* 1 */ if (reset) {
    kcg_copy_P45_RadioNetworkRegist(
      &outC->_L153,
      (P45_RadioNetworkRegistration_T_ *) &cNoP45_RadioNetworkRegistration);
    kcg_copy_P45_RadioNetworkRegist(
      &outC->_L173,
      (P45_RadioNetworkRegistration_T_ *) &cNoP45_RadioNetworkRegistration);
    kcg_copy_P45_RadioNetworkRegist(
    ...
    /* 4 */ if (outC->p45_registrationOrderReceived_p) {
      kcg_copy_P45_RadioNetworkRegist(&outC->_L153, &_L149);
    }
    ...
    /* 4 */ if ((*atPowerUpRadioNetworkID).valid) {
      kcg_copy_P45_RadioNetworkRegist(&outC->_L163, atPowerUpRadioNetworkID);
    }
    ...
    /* 4 */ if (_L185) {
      /* 6 */ if (outC->p45_registrationOrderReceived_p) {
        kcg_copy_P45_RadioNetworkRegist(
          &outC->lastReceivedRadioNetworkID,
          &outC->_L153);
      }
  ...
  triggerRegistrationOfMobile = outC->lastReceivedRadioNetworkID.valid &
    (_L185 | (*eventsAndPhases).triggerDecisionThatNoRadioNetwo);
  _L185 = (*connectionStatus).valid & (((*connectionStatus).status ==
        mcs_connecting_RCM_Types_Pkg) | ((*connectionStatus).status ==
        mcs_connected_RCM_Types_Pkg));
  br_1_guard_Register_SM_Register = ((*sessionStatus).phase ==
      sp_establishing_RCM_Session_Typ) | ((*sessionStatus).phase ==
      sp_terminating_RCM_Session_Type) | ((*sessionStatus).phase ==
      sp_maintaining_RCM_Session_Type);
  br_1_guard_Register_SM_Reregist = outC->lastReceivedRadioNetworkID.valid &
    (outC->lastReceivedRadioNetworkID.nid_mn !=
  ...
  /* init_Register_SM */ if (outC->init) {
    ...
    outC->orderRegistrationDelayed = (triggerRegistrationOfMobile & (_L185 |
          (br_1_guard_Register_SM_Register & (*sessionStatus).valid)) &
        br_1_guard_Register_SM_Reregist) | (!outC->resetDelayedOrderFlag &
    ...
    ((*mobileRegistrationContext).valid &
      (((*mobileRegistrationContext).status == mrs_unregistered_RCM_Types_Pkg) |
        ((((*mobileRegistrationContext).status ==
          ...
          br_1_guard_Register_SM_Reregist))) & ((*sessionStatus).valid &
      !br_1_guard_Register_SM_Register);
  /* 1 */
  FallingEdge_digital(
    (kcg_bool)
      (br_1_guard_Register_SM_Register | ((*connectionStatus).status ==
          mcs_connecting_RCM_Types_Pkg) | ((*connectionStatus).status ==
          mcs_connected_RCM_Types_Pkg) | _L185),
    &outC->Context_1);
  ...
  /* sel_Register_SM */ switch (Register_SM_state_sel) {
    case SSM_st_Reregistering_Register_S :
      outC->resetDelayedOrderFlag = kcg_false;
      br_1_guard_Register_SM_Reregist = registrationStatus ==
        mrs_unregistered_RCM_Types_Pkg;
      if (br_1_guard_Register_SM_Reregist) {
        _L313 = kcg_true;
        Register_SM_state_act = SSM_st_Registering_Register_SM;
      }
      else {
        _L313 = kcg_false;
        Register_SM_state_act = SSM_st_Reregistering_Register_S;
      }
      break;
    ...
    case SSM_st_Registering_Register_SM :
      br_1_guard_Register_SM_Register = orderRegistrationImmediately |
        (outC->orderRegistrationDelayed & triggerRegistrationOfMobile);
      _L313 = kcg_false;
      if (br_1_guard_Register_SM_Register) {
        outC->resetDelayedOrderFlag = kcg_true;
        Register_SM_state_act = SSM_st_Reregistering_Register_S;
      }
      else {
  ...
  /* act_Register_SM */ switch (Register_SM_state_act) {
    ...
    case SSM_st_Reregistering_Register_S :
      registrationStatus = mrs_registering_RCM_Types_Pkg;
      outC->Register_SM_state_nxt = SSM_st_Reregistering_Register_S;
      break;
...
/* $**************** KCG Version 6.4 (build i21) ****************
** registeringToTheRadioNetw_MoRC_.c
** Generation date: 2015-12-07T14:50:21
*************************************************************$ */
