...
typedef struct {
  ...
  StaticSpeedProfile_t_TrackAtlas /* TA_MRSP_new::Build_MRSP::SSP */ SSP;
  /* -----------------------  no local probes  ----------------------- */
...
extern void Build_MRSP_TA_MRSP_new(
  /* TA_MRSP_new::Build_MRSP::MessageIn */ ReceivedMessage_T_Common_Types_ *MessageIn,
  /* TA_MRSP_new::Build_MRSP::TrainDataIn */ FromTIU_t_TrackAtlasTypes TrainDataIn,
  /* TA_MRSP_new::Build_MRSP::ModeAndLevel_in */ T_Mode_Level_Level_And_Mode_Typ *ModeAndLevel_in,
  /* TA_MRSP_new::Build_MRSP::train_length */ L_internal_Type_Obu_BasicTypes_ train_length,
  /* TA_MRSP_new::Build_MRSP::train_position */ trainPosition_T_TrainPosition_T *train_position,
  /* TA_MRSP_new::Build_MRSP::balisegroups */ positionedBGs_T_TrainPosition_T *balisegroups,
