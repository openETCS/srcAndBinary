...
void sendBrakesToDMI_init_manage_DMI(outC_sendBrakesToDMI_manage_DMI *outC)
{
  outC->init = kcg_true;
  outC->rem_brakeCommand.valid = kcg_true;
  outC->rem_brakeCommand.m_servicebrake_cm = brake_signal_command_not_define;
  outC->rem_brakeCommand.m_emergencybrake_cm = brake_signal_command_not_define;
...
void sendBrakesToDMI_reset_manage_DM(outC_sendBrakesToDMI_manage_DMI *outC)
{
  outC->init = kcg_true;
}
...
void sendBrakesToDMI_manage_DMI_Outp(
...
{
  /* manage_DMI_Output_Pkg::sendBrakesToDMI */
  static M_brake_signal_command_T_TIU_Ty tmp;
  ...
  /* last_init_ck_loc_brakeCommand */ if (outC->init) {
    outC->init = kcg_false;
    tmp = cInitBrakeCommand_manage_DMI_Ou.m_emergencybrake_cm;
  }
  else {
  ...
  /* ck_applyBrake */ if (applyBrake) {
    kcg_copy_DMI_Icons_T_DMI_Messag(
      &outC->dmi_iconRequest,
      (DMI_Icons_T_DMI_Messages_EVC_to *) &cIconRequestEB_manage_DMI_Outpu);
    ...
    /* ck_anon_activ */ if (else_clock_IfBlock1) {
      kcg_copy_DMI_Icons_T_DMI_Messag(
        &outC->dmi_iconRequest,
        (DMI_Icons_T_DMI_Messages_EVC_to *) &cIconClearEB_manage_DMI_Output_);
      outC->dmi_iconRequest.system_clock = inSystemTime;
    }
    else {
      kcg_copy_DMI_Icons_T_DMI_Messag(
        &outC->dmi_iconRequest,
        (DMI_Icons_T_DMI_Messages_EVC_to *) &cEmptyIconRequest_manage_DMI_Ou);
    }
  }
  kcg_copy_Brake_command_T_TIU_Ty(&outC->rem_brakeCommand, brakeCommand);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** sendBrakesToDMI_manage_DMI_Outp.c
** Generation date: 2015-11-12T17:51:53
*************************************************************$ */
