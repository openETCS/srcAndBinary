...
#include "C_P058_to_legacy_t_TM_conversio.h"

/* TM_conversions::C_P058_to_legacy_t */
void C_P058_to_legacy_t_TM_conversio(
  /* TM_conversions::C_P058_to_legacy_t::P058_in */ P058_OBU_T_TM *P058_in,
  /* TM_conversions::C_P058_to_legacy_t::P058_legacy_out */ P58_PositionReportParameters_T_ *P058_legacy_out)
{
  /* TM_conversions::C_P058_to_legacy_t */
  static IterPacket58List_T_Packet_Types tmp;
  static kcg_int i;
  ...
  /* 1 */ for (i = 0; i < 2; i++) {
    /* 1 */ C_P058_to_legacy_loop_TM_conver(i, &(*P058_in).sections, &tmp[i]);
  }
  kcg_copy_IterPacket58List_T_Pac(&(*P058_legacy_out).iterPacket58List, &tmp);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** C_P058_to_legacy_t_TM_conversio.c
** Generation date: 2015-11-12T17:51:54
*************************************************************$ */
