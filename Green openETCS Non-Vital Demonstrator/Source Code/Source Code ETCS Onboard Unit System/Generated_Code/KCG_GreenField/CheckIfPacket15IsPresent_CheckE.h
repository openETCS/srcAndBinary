...
*************************************************************$ */
#ifndef _CheckIfPacket15IsPresent_Check
#define _CheckIfPacket15IsPresent_Check
...
extern kcg_bool CheckIfPacket15IsPresent_CheckE(
  /* CheckEuroradioMessage::SubFunctions::CheckIfPacket15IsPresent::rtmMessage */ ReceivedMessage_T_Common_Types_ *rtmMessage);

#endif /* _CheckIfPacket15IsPresent_Check */
/* $**************** KCG Version 6.4 (build i21) ****************
** CheckIfPacket15IsPresent_CheckE.h
** Generation date: 2015-11-03T14:28:11
*************************************************************$ */
