...
void MoRC_Main_v2_init_MoRC_Pck(outC_MoRC_Main_v2_MoRC_Pck *outC)
{
  ...
  outC->m38_initiationOfACommunicationS = kcg_true;
  outC->m39_AckOfTerminationOfACommunic = kcg_true;
...
{
  /* MoRC_Pck::MoRC_Main_v2 */
  static sessionCmd_T_RCM_Session_Types_ tmp;
  ...
  static m38_initiationOfACommunicationS _2_m38_initiationOfACommunicati;
  /* MoRC_Pck::MoRC_Main_v2::m39_AckOfTerminationOfACommunicationSession */
  static m39_AckOfTerminationOfACommunic _1_m39_AckOfTerminationOfACommu;
  /* MoRC_Pck::MoRC_Main_v2::m32_SystemVersion */
  static m32_RBC_RIU_SystemVersion_T_RCM m32_SystemVersion;
  ...
  /* 1 */
  dec_m38_RCM_Utils_Pkg_decoders(msg_in, &_2_m38_initiationOfACommunicati);
  ...
  /* 1 */
  dec_m39_RCM_Utils_Pkg_decoders(msg_in, &_1_m39_AckOfTerminationOfACommu);
  /* 1 */ dec_m32_RCM_Utils_Pkg_decoders(msg_in, kcg_true, &m32_SystemVersion);
  /* 1 */
  ...
  initiateSession_v2_MoRC_Pck_Sub(
    ...
    eventsAndPhases,
    &p42_sessionManagement,
    &_2_m38_initiationOfACommunicati,
    &_L26,
    &_L14,
    &_L27,
    (sessionStatus_T_RCM_Session_Typ *) &cNoSessionStatus_RCM_Session_Ty,
  ...
  sessionSequencer_v2_MoRC_Pck_Su(
    &tmp,
    &p42_sessionManagement,
    &_1_m39_AckOfTerminationOfACommu,
    &m32_SystemVersion,
    &_L14,
  ...
  outC->p42_sessionManagementReceived_p = p42_sessionManagement.valid;
  outC->m32_SystemVersionReceived_p = m32_SystemVersion.valid;
  outC->m38_initiationOfACommunicationS = _2_m38_initiationOfACommunicati.valid;
  outC->m39_AckOfTerminationOfACommunic = _1_m39_AckOfTerminationOfACommu.valid;
}
