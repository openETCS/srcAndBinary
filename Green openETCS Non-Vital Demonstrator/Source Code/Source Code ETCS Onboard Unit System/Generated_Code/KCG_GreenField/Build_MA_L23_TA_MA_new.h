...
typedef struct {
  ...
  MovementAuthority_t_TrackAtlasT /* TA_MA_new::Build_MA_L23::MA_absolute */ MA_absolute;
  L_internal_Type_Obu_BasicTypes_ /* TA_MA_new::Build_MA_L23::currentEOA */ currentEOA;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- initialization variables  ------------------ */
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  MovementAuthority_t_TrackAtlasT /* TA_MA_new::Build_MA_L23::_L237 */ _L237;
