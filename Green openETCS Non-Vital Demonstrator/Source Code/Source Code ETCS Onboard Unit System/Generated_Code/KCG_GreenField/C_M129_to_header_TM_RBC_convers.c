...
void C_M129_to_header_TM_RBC_convers(
  /* TM_RBC_conversions::C_M129_to_header::Message_Data_in */ M_129_T_TM_radio_messages *Message_Data_in,
  /* TM_RBC_conversions::C_M129_to_header::Message_Header_Out */ M_TrainTrack_MessageHd_T_TM_rad *Message_Header_Out)
{
...
/* $**************** KCG Version 6.4 (build i21) ****************
** C_M129_to_header_TM_RBC_convers.c
** Generation date: 2015-11-03T14:28:13
*************************************************************$ */
