...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_TrainTrackMessageBus_t_TM_Tra /* TM_radio_messages::Send_M146::MessageBus_out */ MessageBus_out;
...
} outC_Send_M146_TM_radio_message;
...
extern void Send_M146_reset_TM_radio_messag(
  outC_Send_M146_TM_radio_message *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Send_M146_init_TM_radio_message(
  outC_Send_M146_TM_radio_message *outC);
