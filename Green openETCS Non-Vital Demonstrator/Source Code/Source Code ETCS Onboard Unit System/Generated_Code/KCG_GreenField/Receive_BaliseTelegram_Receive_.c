...
void Receive_BaliseTelegram_init_Rec(outC_Receive_BaliseTelegram_Rec *outC)
{
  static kcg_int i1;
  static kcg_int i;
  ...
  outC->outTrackMessage_for_check.telegramHeaders.centerOfBalisePosition.BG_centerDetectionInaccuraccura.nominal =
    0;
  outC->outTrackMessage_for_check.telegramHeaders.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_min =
    0;
  outC->outTrackMessage_for_check.telegramHeaders.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_max =
    0;
  ...
  /* 1 */ BuildBGMessage_init_Receive_Tra(&outC->Context_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Receive_BaliseTelegram_reset_Re(outC_Receive_BaliseTelegram_Rec *outC)
{
  /* 1 */ BuildBGMessage_reset_Receive_Tr(&outC->Context_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

/* Receive_TrackSide_Msg_Pkg::Receive_BaliseTelegram */
void Receive_BaliseTelegram_Receive_(
  ...
  outC_Receive_BaliseTelegram_Rec *outC)
{
  ...
  kcg_copy_RadioMessage_T_Radio_T(
  ...
  /* 1 */
  BuildBGMessage_Receive_TrackSid(
    reset,
    telegramPresent,
    &mk_struct,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Receive_BaliseTelegram_Receive_.c
** Generation date: 2015-11-03T14:28:12
*************************************************************$ */
