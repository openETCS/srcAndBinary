...
typedef struct {
  ...
  kcg_bool /* Toolbox::TrainModules::TIU::serviceBrakeActivated_To_Environment */ serviceBrakeActivated_To_Enviro;
  kcg_bool /* Toolbox::TrainModules::TIU::emergencyBrakeActivated_To_Environment */ emergencyBrakeActivated_To_Envi;
  kcg_bool /* Toolbox::TrainModules::TIU::tractionCutOff_To_Environment */ tractionCutOff_To_Environment;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- initialization variables  ------------------ */
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  M_brake_signal_command_T_TIU_Ty /* Toolbox::TrainModules::TIU::serviceBrakeCommandTmp */ serviceBrakeCommandTmp;
  M_brake_signal_command_T_TIU_Ty /* Toolbox::TrainModules::TIU::emergencyBrakeCommandTmp */ emergencyBrakeCommandTmp;
  M_traction_cutoff_command_T_TIU /* Toolbox::TrainModules::TIU::cutoffCommand */ cutoffCommand;
