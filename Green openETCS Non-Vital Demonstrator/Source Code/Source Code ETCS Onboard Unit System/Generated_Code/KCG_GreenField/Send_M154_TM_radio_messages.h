...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  M_TrainTrackMessageBus_t_TM_Tra /* TM_radio_messages::Send_M154::MessageBus_out */ MessageBus_out;
...
} outC_Send_M154_TM_radio_message;
...
extern void Send_M154_reset_TM_radio_messag(
  outC_Send_M154_TM_radio_message *outC);
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

#ifndef KCG_USER_DEFINED_INIT
extern void Send_M154_init_TM_radio_message(
  outC_Send_M154_TM_radio_message *outC);
