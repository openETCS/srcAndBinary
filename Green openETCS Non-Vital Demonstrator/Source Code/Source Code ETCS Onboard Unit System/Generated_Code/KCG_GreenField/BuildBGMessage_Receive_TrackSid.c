...
void BuildBGMessage_init_Receive_Tra(outC_BuildBGMessage_Receive_Tra *outC)
{
  static kcg_int i1;
  static kcg_int i;
  ...
  outC->storeCollector.balisePosition.BG_centerDetectionInaccuraccura.nominal =
    0;
  outC->storeCollector.balisePosition.BG_centerDetectionInaccuraccura.d_min = 0;
  outC->storeCollector.balisePosition.BG_centerDetectionInaccuraccura.d_max = 0;
  ...
  outC->storeCollector.positionFirstContact.odometerOfBaliseDetection.motionDirection =
    unknownDirection_Obu_BasicTypes;
  outC->storeCollector.positionFirstContact.BG_centerDetectionInaccuraccura.nominal =
    0;
  outC->storeCollector.positionFirstContact.BG_centerDetectionInaccuraccura.d_min =
    0;
  outC->storeCollector.positionFirstContact.BG_centerDetectionInaccuraccura.d_max =
    0;
  ...
  outC->storeAdditionalTelegram.position.odometerOfBaliseDetection.motionDirection =
    unknownDirection_Obu_BasicTypes;
  outC->storeAdditionalTelegram.position.BG_centerDetectionInaccuraccura.nominal =
    0;
  outC->storeAdditionalTelegram.position.BG_centerDetectionInaccuraccura.d_min =
    0;
  outC->storeAdditionalTelegram.position.BG_centerDetectionInaccuraccura.d_max =
    0;
  ...
  outC->outBGMessage.centerOfBalisePosition.odometerOfBaliseDetection.motionDirection =
    unknownDirection_Obu_BasicTypes;
  outC->outBGMessage.centerOfBalisePosition.BG_centerDetectionInaccuraccura.nominal =
    0;
  outC->outBGMessage.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_min =
    0;
  outC->outBGMessage.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_max =
    0;
}
...
void BuildBGMessage_reset_Receive_Tr(outC_BuildBGMessage_Receive_Tra *outC)
{
  outC->init = kcg_true;
}
...
void BuildBGMessage_Receive_TrackSid(
...
{
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */
  static TelegramStore_T_Receive_TrackSi tmp5;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */
  static Telegram_T_BG_Types_Pkg tmp4;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */
  static centerOfBalisePosition_T_BG_Typ tmp3;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */
  ...
  static centerOfBalisePosition_T_BG_Typ _L12_IfBlock4;
  ...
  static BGCollector_T_Receive_TrackSide last_storeCollector;
  ...
  static BGCollector_T_Receive_TrackSide tempCollectorStore;
  ...
  /* ck_reset */ if (reset) {
    ...
    /* last_init_ck_storeAdditionalTelegram */ if (outC->init) {
      kcg_copy_TelegramStore_T_Receiv(
        &tmp5,
        (TelegramStore_T_Receive_TrackSi *) &cEmptyStore_Receive_TrackSide_M);
    }
    else {
      kcg_copy_TelegramStore_T_Receiv(&tmp5, &outC->storeAdditionalTelegram);
    }
    /* 3 */
    manageAdditionalTelegram_Receiv(
      inDecodedTelegram,
  ...
  /* last_init_ck_storeBGTelegramArray */ if (outC->init) {
    kcg_copy_BGCollector_T_Receive_(
      &last_storeCollector,
      (BGCollector_T_Receive_TrackSide *) &cEmptyCollector_Receive_TrackSi);
    outC->init = kcg_false;
  ...
  /* ck_telegramPresent */ if (telegramPresent) {
    /* ck_reset */ if (reset) {
      ...
      kcg_copy_Telegram_T_BG_Types_Pk(&tmp4, &_L11_IfBlock4);
      kcg_copy_centerOfBalisePosition(&tmp3, &_L12_IfBlock4);
    }
    /* 1 */
    manageTelegram_Receive_TrackSid(
      &tmp4,
      &tmp3,
      &last_storeCollector,
      &last_storeBGTelegramArray,
    ...
    /* ck_IfBlock3 */ if (IfBlock3_clock_IfBlock1) {
      /* 3 */
      checkOdometry_Receive_TrackSide(
        inActualOdometry,
        &last_storeCollector,
        &BGisComplete,
        &tmp,
  ...
  /* ck_BGisComplete */ if (BGisComplete) {
    ...
    kcg_copy_TelegramArray_T_BG_Typ(
      ...
      &tempBGTelegramArray);
    /* 1 */
    updateCollectorSendMessage_Rece(&tempCollectorStore, &outC->storeCollector);
...
/* $**************** KCG Version 6.4 (build i21) ****************
** BuildBGMessage_Receive_TrackSid.c
** Generation date: 2015-11-03T14:28:12
*************************************************************$ */
