...
typedef struct {
  ...
  GradientProfile_t_TrackAtlasTyp /* TA_Gradient_new::GP_Postprocessing::GP */ GP;
  /* -----------------------  no local probes  ----------------------- */
  /* -------------------- initialization variables  ------------------ */
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  GradientProfile_t_TrackAtlasTyp /* TA_Gradient_new::GP_Postprocessing::_L4 */ rem__L4;
...
extern void GP_Postprocessing_TA_Gradient_n(
  /* TA_Gradient_new::GP_Postprocessing::Profile_in */ GradientProfile_t_TrackAtlasTyp *Profile_in,
  /* TA_Gradient_new::GP_Postprocessing::pos_LRBG */ L_internal_Type_Obu_BasicTypes_ pos_LRBG,
  /* TA_Gradient_new::GP_Postprocessing::pos_prvLRBG */ L_internal_Type_Obu_BasicTypes_ pos_prvLRBG,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** GP_Postprocessing_TA_Gradient_n.h
** Generation date: 2015-12-07T14:50:18
*************************************************************$ */
