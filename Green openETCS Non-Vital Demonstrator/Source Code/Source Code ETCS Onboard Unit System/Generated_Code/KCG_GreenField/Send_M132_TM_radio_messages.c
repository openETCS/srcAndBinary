...
void Send_M132_init_TM_radio_message(outC_Send_M132_TM_radio_message *outC)
{
  static kcg_int i1;
  static kcg_int i;
...
void Send_M132_reset_TM_radio_messag(outC_Send_M132_TM_radio_message *outC)
{
  ...
  outC_Send_M132_TM_radio_message *outC)
{
  ...
  /* 1 */
  C_P009_train_compr_TM_TrainToTr(
    P009,
    (P009_TrainTrack_int_TM_TrainToT *) &(&tmp1[0])[17]);
  for (i = 0; i < 30; i++) {
    (&tmp1[20])[i] = 0;
  }
  /* 2 */ C_M132_to_header_TM_RBC_convers(Message_132_in, &tmp);
