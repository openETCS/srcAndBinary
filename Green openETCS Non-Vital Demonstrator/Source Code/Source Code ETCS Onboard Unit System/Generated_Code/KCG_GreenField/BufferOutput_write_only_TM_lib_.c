...
void BufferOutput_write_only_TM_lib_(
  /* TM_lib_internal::BufferOutput_write_only::Buffer_In */ M_TrainTrackRadioOutputBuffer_t *Buffer_In,
  /* TM_lib_internal::BufferOutput_write_only::Stacksize_old */ kcg_int Stacksize_old,
  /* TM_lib_internal::BufferOutput_write_only::Message_In */ M_TrainTrackMessageBus_t_TM_Tra *Message_In,
  /* TM_lib_internal::BufferOutput_write_only::Bus_Size */ kcg_int Bus_Size,
  /* TM_lib_internal::BufferOutput_write_only::Buffer_Out */ M_TrainTrackRadioOutputBuffer_t *Buffer_Out,
  /* TM_lib_internal::BufferOutput_write_only::Stacksize_new */ kcg_int *Stacksize_new,
  /* TM_lib_internal::BufferOutput_write_only::Message_out */ M_TrainTrack_Message_T_TM_radio *Message_out)
{
  ...
  /* ck_IfBlock1 */ if (IfBlock1_clock) {
    /* 1 */
    BufferOutput_write_only1_TM_lib(
      Buffer_In,
      Stacksize_old,
      Message_In,
      Buffer_Out,
    ...
    /* ck_anon_activ */ if (_2_else_clock_IfBlock1) {
      /* 1 */
      BufferOutput_write_only2_TM_lib(
        Buffer_In,
        Stacksize_old,
        Message_In,
        Buffer_Out,
      ...
      /* ck_anon_activ */ if (_1_else_clock_IfBlock1) {
        /* 1 */
        BufferOutput_write_only3_TM_lib(
          Buffer_In,
          Stacksize_old,
          Message_In,
          Buffer_Out,
        ...
        /* ck_anon_activ */ if (else_clock_IfBlock1) {
          /* 1 */
          BufferOutput_write_only4_TM_lib(
            Buffer_In,
            Stacksize_old,
            Message_In,
            Buffer_Out,
          ...
          /* 1 */
          BufferOutput_write_only5_TM_lib(
            Buffer_In,
            Stacksize_old,
            Message_In,
            Buffer_Out,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** BufferOutput_write_only_TM_lib_.c
** Generation date: 2015-11-11T16:04:22
*************************************************************$ */
