...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_maintaining_a_Session_MoRC_Pck_Subfunc_Pkg /* 1 */ _12_Context_1;
  outC_terminateAndEstablishSession_MoRC_Pck_Subfunc_Pkg /* 1 */ _11_Context_1;
  outC_establish_a_Session_MoRC_Pck_Subfunc_Pkg /* 2 */ _10_Context_2;
  outC_terminating_a_CommunicationSession_MoRC_Pck_Subfunc_Pkg /* 1 */ _9_Context_1;
  outC_initiate_a_Session_MoRC_Pck_Subfunc_Pkg /* 1 */ _8_Context_1;
  outC_FallingEdge_digital /* 1 */ _7_Context_1;
  outC_initiateTerminatingASession_MoRC_Pck_Subfunc_Pkg /* 1 */ _6_Context_1;
  outC_registeringToTheRadioNetwork_MoRC_Pck_Subfunc_Pkg /* 1 */ _5_Context_1;
  outC_RisingEdge_digital /* 1 */ _4_Context_1;
  outC_FallingEdge_digital /* 2 */ _3_Context_2;
  outC_RisingEdge_digital /* 2 */ _2_Context_2;
  outC_safeRadioConnectionIndication_MoRC_Pck_Subfunc_Pkg /* 1 */ _1_Context_1;
