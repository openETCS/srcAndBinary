  ...
  /* TA_SSP::Update_SSP_then_LRBG::new_profile_out */SSP_cat_t_TA_MRSP *new_profile_out)
{
  ...
  /* TA_SSP::Update_SSP_then_LRBG::_L6 */
  static SSP_cat_t_TA_MRSP _L6;
  /* TA_SSP::Update_SSP_then_LRBG::_L7 */
  static V_internal_Type_Obu_BasicTypes_Pkg _L7;
  /* TA_SSP::Update_SSP_then_LRBG::_L8 */
  static SSP_section_t_TA_MRSP _L8;
  /* TA_SSP::Update_SSP_then_LRBG::_L9 */
  static SSP_section_t_TA_MRSP _L9;
