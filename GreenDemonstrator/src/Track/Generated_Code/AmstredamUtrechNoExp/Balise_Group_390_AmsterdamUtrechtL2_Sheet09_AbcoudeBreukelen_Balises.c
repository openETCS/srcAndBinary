...
void Balise_Group_390_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
  ...
  /* AmsterdamUtrechtL2::Sheet09_AbcoudeBreukelen_Balises::Balise_Group_390::BG_message_out */CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* 1 */
  Balise_390_1_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG390_header_B1_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_390_0_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises(
    &tmp,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_390_AmsterdamUtrechtL2_Sheet09_AbcoudeBreukelen_Balises.c
** Generation date: 2015-07-22T11:03:51
*************************************************************$ */
