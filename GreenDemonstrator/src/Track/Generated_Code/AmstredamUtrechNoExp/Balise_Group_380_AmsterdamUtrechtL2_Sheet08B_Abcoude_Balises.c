...
void Balise_Group_380_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
  ...
  /* AmsterdamUtrechtL2::Sheet08B_Abcoude_Balises::Balise_Group_380::BG_message_out */CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* 1 */
  Balise_380_1_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG380_header_B1_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_380_0_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises(
    &tmp,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_380_AmsterdamUtrechtL2_Sheet08B_Abcoude_Balises.c
** Generation date: 2015-07-22T11:03:51
*************************************************************$ */
