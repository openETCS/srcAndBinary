...
void Balise_Group_410_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
  ...
  /* AmsterdamUtrechtL2::Sheet12_Breukelen_Balises::Balise_Group_410::BG_message_out */CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* 1 */
  Balise_410_0_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG410_header_B0_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_410_1_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises(
    &tmp,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_410_AmsterdamUtrechtL2_Sheet12_Breukelen_Balises.c
** Generation date: 2015-07-22T11:03:51
*************************************************************$ */
