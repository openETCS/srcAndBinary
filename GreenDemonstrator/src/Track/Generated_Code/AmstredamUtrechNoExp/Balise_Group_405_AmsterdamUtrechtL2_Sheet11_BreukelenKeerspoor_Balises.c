...
void Balise_Group_405_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
  ...
  /* AmsterdamUtrechtL2::Sheet11_BreukelenKeerspoor_Balises::Balise_Group_405::BG_message_out */CompressedBaliseMessage_TM *BG_message_out)
{
  ...
  /* 1 */
  Balise_405_1_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
    &tmp1,
    (BaliseTelegramHeader_int_T_TM *) &BG405_header_B1_Balises426,
    0,
    &tmp);
  /* 1 */
  Balise_405_0_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises(
    &tmp,
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** Balise_Group_405_AmsterdamUtrechtL2_Sheet11_BreukelenKeerspoor_Balises.c
** Generation date: 2015-07-22T11:03:51
*************************************************************$ */
