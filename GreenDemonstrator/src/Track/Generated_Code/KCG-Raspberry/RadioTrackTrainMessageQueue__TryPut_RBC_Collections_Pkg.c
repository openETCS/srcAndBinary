...
{
  array__47140 tmp1;
  RadioTrackTrainMessageQueueEntries_T tmp;
  /* RBC_Collections_Pkg::RadioTrackTrainMessageQueue__TryPut::hasCapacity */ kcg_bool hasCapacity;
  ...
  if (hasCapacity) {
    ...
    RadioTrackTrainMessageQueue__GetEntries_RBC_Collections_Pkg(
      ...
      &tmp);
    kcg_copy_array__51418(&tmp1[1], (array__51418 *) &tmp[0]);
    /* 1 */
