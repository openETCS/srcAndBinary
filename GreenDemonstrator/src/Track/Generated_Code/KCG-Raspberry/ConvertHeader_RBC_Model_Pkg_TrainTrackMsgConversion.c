...
{
  Q_EMERGENCYSTOP tmp;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertHeader::Decode_NID_TEXTMESSAGE */ kcg_bool Decode_NID_TEXTMESSAGE_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertHeader::Decode_Emergency_Stop */ kcg_bool Decode_Emergency_Stop_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertHeader::Decode_xT_TRAIN */ kcg_bool Decode_xT_TRAIN_clock;
  /* RBC_Model_Pkg::TrainTrackMsgConversion::ConvertHeader::Decode_Q_MARQSTREASON */ kcg_bool Decode_Q_MARQSTREASON_clock;
