...
void RBC__ProcessRevocationOfEmergencyStop_RBC_Model_Pkg(
  ...
  outC_RBC__ProcessRevocationOfEmergencyStop_RBC_Model_Pkg *outC)
{
  RadioTrackTrainMessageQueueEntry_T tmp5;
  NID_MESSAGE tmp4;
  Radio_TrainTrack_Header_T_Radio_Types_Pkg tmp3;
  NID_MESSAGE tmp2;
  M_ACK tmp1;
  Radio_TrackTrain_Header_T_TM tmp;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM::AWAIT_ACKNOWLEDGEMENT::_L3 */ Radio_TrackTrain_Header_T_TM _L3_REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM_AWAIT_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM::TRY_PROCESS_ACKNOWLEDGEMENT::_L23 */ Radio_TrackTrain_Header_T_TM _L23_REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM::TRY_PROCESS_ACKNOWLEDGEMENT::IfBlock1 */ kcg_bool IfBlock1_clock_REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::invalidAck */ kcg_bool last_invalidAck;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::revocationMessageWasSentTimestamp */ T_TRAIN last_revocationMessageWasSentTimestamp;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::ackRequired */ kcg_bool last_ackRequired;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM */ SSM_ST_REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM_state_sel;
  /* RBC_Model_Pkg::RBC__ProcessRevocationOfEmergencyStop::REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM */ SSM_ST_REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM REVOCATION_OF_EMERGENCY_STOP_MESSAGE_SM_state_act;
