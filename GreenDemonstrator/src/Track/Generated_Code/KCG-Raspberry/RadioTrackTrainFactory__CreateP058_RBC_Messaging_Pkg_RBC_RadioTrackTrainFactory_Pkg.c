...
void RadioTrackTrainFactory__CreateP058_RBC_Messaging_Pkg_RBC_RadioTrackTrainFactory_Pkg(
  ...
  /* RBC_Messaging_Pkg::RBC_RadioTrackTrainFactory_Pkg::RadioTrackTrainFactory__CreateP058::inIncrementalDistancesAndQualifiers */array__47228 *inIncrementalDistancesAndQualifiers,
...
{
  /* 1 */
  RadioTrackTrainPacket058__Create_RBC_Messaging_Pkg_RBC_RadioTrackTrain_Pkg_RBC_RadioTrackTrainPacket058_Pkg(
    in_Q_DIR,
    in_Q_SCALE,
    in_T_CYCLOC,
    in_D_CYCLOC,
