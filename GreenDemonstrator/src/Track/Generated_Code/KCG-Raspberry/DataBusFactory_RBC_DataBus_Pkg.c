...
void DataBusFactory_RBC_DataBus_Pkg(
  ...
  outC_DataBusFactory_RBC_DataBus_Pkg *outC)
{
  DynamicConfig_T tmp4;
  array__47265 tmp3;
  RadioTrackTrainMessageQueue_T tmp2;
  Clock_T tmp1;
  CompressedRadioMessage_TM tmp;
  kcg_int times;
  /* RBC_DataBus_Pkg::DataBusFactory::_L3 */ kcg_bool _L3;
  ...
  if (_L3) {
    ...
    kcg_copy_array__47265(
      &tmp3,
      (array__47265 *) &DIAG_MSG_DEFAULT_ARRAY_RBC_Diagnostic_Pkg);
    ...
    kcg_copy_array__47265(&tmp3, &(*inDataBus).diagnostic);
  ...
  kcg_copy_array__47265(&outC->outDataBus.diagnostic, &tmp3);
