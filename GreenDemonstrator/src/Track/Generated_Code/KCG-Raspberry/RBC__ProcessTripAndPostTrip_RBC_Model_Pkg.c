  ...
  outC_RBC__ProcessTripAndPostTrip_RBC_Model_Pkg *outC)
{
  ...
  CompressedRadioMessage_TM tmp4;
  NID_LRBG tmp3;
  PosData_T tmp2;
  NID_MESSAGE tmp1;
  Radio_TrainTrack_Header_T_Radio_Types_Pkg tmp;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM::MODE_POST_TRIP::_L25 */ Radio_TrackTrain_Header_T_TM _L25_TRIP_AND_POST_TRIP_SM_MODE_POST_TRIP;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM::TRY_PROCESS_ACKNOWLEDGEMENT::_L16 */ Radio_TrackTrain_Header_T_TM _L16_TRIP_AND_POST_TRIP_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM::TRY_PROCESS_ACKNOWLEDGEMENT::IfBlock1 */ kcg_bool IfBlock1_clock_TRIP_AND_POST_TRIP_SM_TRY_PROCESS_ACKNOWLEDGEMENT;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::invalidAck */ kcg_bool last_invalidAck;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::recognitionMessageWasSentTimestamp */ T_TRAIN last_recognitionMessageWasSentTimestamp;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM */ SSM_ST_TRIP_AND_POST_TRIP_SM TRIP_AND_POST_TRIP_SM_state_sel;
  /* RBC_Model_Pkg::RBC__ProcessTripAndPostTrip::TRIP_AND_POST_TRIP_SM */ SSM_ST_TRIP_AND_POST_TRIP_SM TRIP_AND_POST_TRIP_SM_state_act;
