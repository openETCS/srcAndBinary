...
{
  /* TM_conversions::CAST_Int_to_M_AXLELOADCAT::IfBlock1::else */ kcg_bool _10_else_clock_IfBlock1;
  /* TM_conversions::CAST_Int_to_M_AXLELOADCAT::IfBlock1::else::else::else */ kcg_bool _8_else_clock_IfBlock1;
  ...
  /* TM_conversions::CAST_Int_to_M_AXLELOADCAT::IfBlock1::else::else::else::else */ kcg_bool _7_else_clock_IfBlock1;
  /* TM_conversions::CAST_Int_to_M_AXLELOADCAT::IfBlock1::else::else */ kcg_bool _9_else_clock_IfBlock1;
