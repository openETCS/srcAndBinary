...
void RBC__ProcessModeAndLevel_RBC_Model_Pkg(
  ...
  outC_RBC__ProcessModeAndLevel_RBC_Model_Pkg *outC)
{
  /* RBC_Model_Pkg::RBC__ProcessModeAndLevel::IfBlock1::else */ kcg_bool else_clock_IfBlock1;
  /* RBC_Model_Pkg::RBC__ProcessModeAndLevel::_L2 */ outPackets_T_Common_Types_Pkg _L2;
  /* RBC_Model_Pkg::RBC__ProcessModeAndLevel::_L3 */ PT0_PositionReport_T_Packet_TrainTypes_Pkg _L3;
  /* RBC_Model_Pkg::RBC__ProcessModeAndLevel::_L4 */ PT1_PositionReport_2BG_T_Packet_TrainTypes_Pkg _L4;
  /* RBC_Model_Pkg::RBC__ProcessModeAndLevel::_L9 */ M_MODE _L9;
  /* RBC_Model_Pkg::RBC__ProcessModeAndLevel::_L24 */ M_LEVEL _L24;
