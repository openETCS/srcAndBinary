...
{
  /* RBC_Config_Pkg::PosRepParams__CountIncrementalDistancesAndQualifiers::outNumberOfIncrementalDistancesAndQualifiers */ N_ITER outNumberOfIncrementalDistancesAndQualifiers;
