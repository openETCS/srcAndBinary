...
{
  P046_sections_array_flat_T_TM tmp;
  kcg_int i;
  /* TM_lib_internal::C_P046_flatten_sections::_L74 */ array_int_2_33 _L74;
  ...
  for (i = 0; i < 99; i++) {
    kcg_copy_P046_sections_array_flat_T_TM(&tmp, Flattened);
    /* 1 */ C_P046_fs_flatten_array_TM_lib_internal(i, &tmp, &_L74, Flattened);
  }
}
