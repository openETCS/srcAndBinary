  ...
  /* TM_lib_internal::BufferOutput_read_write2::Message_out */ M_TrainTrack_Message_T_TM_radio *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_104262(
      &(*Buffer_Out)[0],
      (array_104262 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_101236(
      &(*Buffer_Out)[0],
      (array_101236 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_101287(&(*Buffer_Out)[2], (array_101287 *) &(*Buffer_In)[0]);
