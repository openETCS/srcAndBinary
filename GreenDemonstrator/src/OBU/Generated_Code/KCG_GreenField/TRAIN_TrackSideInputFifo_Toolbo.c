...
void TRAIN_TrackSideInputFifo_init_T(outC_TRAIN_TrackSideInputFifo_T *outC)
{
  static kcg_int i1;
  static kcg_int i;
  ...
  for (i1 = 0; i1 < 5; i1++) {
    ...
    outC->buffer[i1].btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.nominal =
      0;
    outC->buffer[i1].btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_min =
      0;
    outC->buffer[i1].btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_max =
      0;
    ...
    outC->_L4_IfBlock1[i1].btm_msg.centerOfBalisePosition.odometerOfBaliseDetection.motionDirection =
      unknownDirection_Obu_BasicTypes;
    outC->_L4_IfBlock1[i1].btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.nominal =
      0;
    outC->_L4_IfBlock1[i1].btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_min =
      0;
    outC->_L4_IfBlock1[i1].btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_max =
      0;
  ...
  outC->outData.btm_msg.api_header.m_version = M_VERSION_Previous_versions_acc;
  ...
  outC->outData.btm_msg.centerOfBalisePosition.odometerOfBaliseDetection.motionDirection =
    unknownDirection_Obu_BasicTypes;
  outC->outData.btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.nominal =
    0;
  outC->outData.btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_min =
    0;
  outC->outData.btm_msg.centerOfBalisePosition.BG_centerDetectionInaccuraccura.d_max =
    0;
...
void TRAIN_TrackSideInputFifo_reset_(outC_TRAIN_TrackSideInputFifo_T *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
}
...
void TRAIN_TrackSideInputFifo_Toolbo(
  ...
  outC_TRAIN_TrackSideInputFifo_T *outC)
{
  ...
  /* ck_inValid */ if (inValid) {
    ...
    if ((0 <= entry) & (entry < 5)) {
      kcg_copy_API_TrackSideInput_T_A(&outC->_L4_IfBlock1[entry], inData);
    }
    kcg_copy_array_102442(&outC->buffer, &outC->_L4_IfBlock1);
  ...
  if ((0 <= entry) & (entry < 5)) {
    kcg_copy_API_TrackSideInput_T_A(&outC->outData, &outC->buffer[entry]);
  }
  else {
    kcg_copy_API_TrackSideInput_T_A(
      &outC->outData,
...
/* $**************** KCG Version 6.4 (build i21) ****************
** TRAIN_TrackSideInputFifo_Toolbo.c
** Generation date: 2015-11-13T13:31:17
*************************************************************$ */
