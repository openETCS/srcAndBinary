...
void FIFO_init_InformationFilter_Pkg(outC_FIFO_InformationFilter_Pkg *outC)
{
  static kcg_int i1;
  static kcg_int i;
  ...
  for (i1 = 0; i1 < 3; i1++) {
    ...
    outC->_L4_IfBlock1[i1].BG_Common_Header.bgPosition.motionDirection =
      unknownDirection_Obu_BasicTypes;
    outC->_L4_IfBlock1[i1].BG_Common_Header.BG_centerDetectionInaccuraccura.nominal =
      0;
    outC->_L4_IfBlock1[i1].BG_Common_Header.BG_centerDetectionInaccuraccura.d_min =
      0;
    outC->_L4_IfBlock1[i1].BG_Common_Header.BG_centerDetectionInaccuraccura.d_max =
      0;
    outC->_L4_IfBlock1[i1].BG_Common_Header.q_nvlocacc = 0;
    outC->_L4_IfBlock1[i1].BG_Common_Header.noCoordinateSystemHasBeenAssign =
      kcg_true;
  ...
  outC->outData.BG_Common_Header.m_version = M_VERSION_Previous_versions_acc;
  ...
  outC->outData.BG_Common_Header.bgPosition.motionDirection =
    unknownDirection_Obu_BasicTypes;
  outC->outData.BG_Common_Header.BG_centerDetectionInaccuraccura.nominal = 0;
  outC->outData.BG_Common_Header.BG_centerDetectionInaccuraccura.d_min = 0;
  outC->outData.BG_Common_Header.BG_centerDetectionInaccuraccura.d_max = 0;
  outC->outData.BG_Common_Header.q_nvlocacc = 0;
  outC->outData.BG_Common_Header.noCoordinateSystemHasBeenAssign = kcg_true;
  ...
  outC->outData.Radio_Common_Header.m_ack = M_ACK_No_acknowledgement_requir;
  ...
  outC->outData.Radio_Common_Header.m_version = M_VERSION_Previous_versions_acc;
  for (i1 = 0; i1 < 30; i1++) {
...
void FIFO_reset_InformationFilter_Pk(outC_FIFO_InformationFilter_Pkg *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
}
...
void FIFO_InformationFilter_Pkg_Comm(
  ...
  outC_FIFO_InformationFilter_Pkg *outC)
{
  ...
  /* ck_inValid */ if (inValid) {
    ...
    kcg_copy_array_102295(&outC->buffer, &outC->_L4_IfBlock1);
  ...
  if ((0 <= entry) & (entry < 3)) {
    kcg_copy_ReceivedMessage_T_Comm(&outC->outData, &outC->buffer[entry]);
  }
  else {
    kcg_copy_ReceivedMessage_T_Comm(
      &outC->outData,
