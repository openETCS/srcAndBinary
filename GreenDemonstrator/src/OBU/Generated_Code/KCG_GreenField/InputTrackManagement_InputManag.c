...
void InputTrackManagement_InputManag(
  /* InputManagement::InputTrackManagement::Data_From_Track_Packets */ T_Data_From_Track_Packet_Level_ *Data_From_Track_Packets,
  /* InputManagement::InputTrackManagement::Data_From_Track_Messages */ T_Data_From_Track_Mess_Level_An *Data_From_Track_Messages,
  /* InputManagement::InputTrackManagement::Data_From_Track_MASSPGradient */ T_Data_From_Track_MASSPGradient *Data_From_Track_MASSPGradient,
  /* InputManagement::InputTrackManagement::Data_From_Track_To_Mode */ T_Data_From_Track_To_Mode_Level *Data_From_Track_To_Mode,
  /* InputManagement::InputTrackManagement::Data_From_Track_to_Level */ T_Data_From_Track_To_Level_Leve *Data_From_Track_to_Level)
{
  /* InputManagement::InputTrackManagement::Loc_conditionalTransitions */
  static T_LevelTransition_PriorityTable Loc_conditionalTransitions;
  /* InputManagement::InputTrackManagement::Loc_Emergency_Stop_Message_Received */
  static kcg_bool Loc_Emergency_Stop_Message_Rece;
  /* InputManagement::InputTrackManagement::Loc_Reversing_Data */
  static T_Reversing_Data_Level_And_Mode Loc_Reversing_Data;
  ...
  /* 1 */
  Input_MA_SSP_Gradient_InputMana(
  ...
  Input_Modes_InputManagement(
    ...
    &Loc_Emergency_Stop_Message_Rece);
