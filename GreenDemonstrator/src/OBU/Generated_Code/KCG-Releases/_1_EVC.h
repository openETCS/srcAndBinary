...
typedef struct {
  ...
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_probe_MsgOut_RadioSupport_Pkg /* 3 */ _17_Context_3;
  outC_collectRadioOutput_radioOutput_Pkg /* 1 */ _16_Context_1;
  outC_checkGeneralMessage_trainData_pkg /* 3 */ _15_Context_3;
  outC_setProbes_xdebugSupport_Pkg /* 2 */ _14_Context_2;
  outC_distanceLastMSG_xdebugSupport_Pkg /* 2 */ _13_Context_2;
  outC_distanceLastBG_xdebugSupport_Pkg /* 2 */ _12_Context_2;
  outC_setProbesBalises_xdebugSupport_Pkg /* 2 */ _11_Context_2;
