  ...
  /* TM_lib_internal::BufferOutput_read_write5::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_97398(&(*Buffer_Out)[0], (array_97398 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_97601(&(*Buffer_Out)[0], (array_97601 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_98074(&(*Buffer_Out)[5], (array_98074 *) &(*Buffer_In)[0]);
