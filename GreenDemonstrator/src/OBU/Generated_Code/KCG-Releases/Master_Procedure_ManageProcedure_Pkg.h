...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  struct_97531 /* ManageProcedure_Pkg::Master_Procedure */ _2_fby_ck_fby;
  struct_97531 /* ManageProcedure_Pkg::Master_Procedure */ fby_ck_fby;
  ...
  _34_SSM_ST_SM1 /* ManageProcedure_Pkg::Master_Procedure::SM1 */ SM1_state_nxt;
