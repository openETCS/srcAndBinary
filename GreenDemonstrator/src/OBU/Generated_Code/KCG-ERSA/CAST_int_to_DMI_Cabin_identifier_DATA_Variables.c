...
{
  /* DATA::Variables::CAST_int_to_DMI_Cabin_identifier::IfBlock1::else */ kcg_bool else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_Cabin_identifier::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* DATA::Variables::CAST_int_to_DMI_Cabin_identifier::dmi_cabin_identifier_ct */ DMI_Cabin_Identifier_T_DMI_Types_Pkg dmi_cabin_identifier_ct;
