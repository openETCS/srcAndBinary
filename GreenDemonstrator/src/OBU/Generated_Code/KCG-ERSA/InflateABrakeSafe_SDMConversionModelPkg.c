...
{
  /* SDMConversionModelPkg::InflateABrakeSafe */ kcg_int acc1;
  /* SDMConversionModelPkg::InflateABrakeSafe */ kcg_int acc;
  /* SDMConversionModelPkg::InflateABrakeSafe::_L9 */ V_internal_Type_Obu_BasicTypes_Pkg _L9;
  /* SDMConversionModelPkg::InflateABrakeSafe::_L31 */ array_real_100_13 _L31;
  /* SDMConversionModelPkg::InflateABrakeSafe::_L35 */ A_internal_Type_Obu_BasicTypes_Pkg _L35;
  /* SDMConversionModelPkg::InflateABrakeSafe::_L37 */ array_real_13 _L37;
  kcg_int i;
