  ...
  outC_CmdTrainSupervisionStatus_SDM_Commands_Pkg *outC)
{
  ...
  /* SDM_Commands_Pkg::CmdTrainSupervisionStatus::modeInterplay::CSM::CSM::WarningStatus */ kcg_bool br_1_guard_modeInterplay_CSM_CSM_WarningStatus;
  /* SDM_Commands_Pkg::CmdTrainSupervisionStatus::modeInterplay::CSM::CSM::OverspeedStatus */ kcg_bool br_1_guard_modeInterplay_CSM_CSM_OverspeedStatus;
  /* SDM_Commands_Pkg::CmdTrainSupervisionStatus::modeInterplay::CSM::CSM::NormalStatus */ kcg_bool br_1_guard_modeInterplay_CSM_CSM_NormalStatus;
  ...
  /* SDM_Commands_Pkg::CmdTrainSupervisionStatus::triggeredEB */ kcg_bool last_triggeredEB;
  /* SDM_Commands_Pkg::CmdTrainSupervisionStatus::revokedEB */ kcg_bool last_revokedEB;
