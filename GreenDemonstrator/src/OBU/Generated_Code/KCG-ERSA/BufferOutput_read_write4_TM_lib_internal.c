  ...
  /* TM_lib_internal::BufferOutput_read_write4::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_121413(
      &(*Buffer_Out)[0],
      (array_121413 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_121800(
      &(*Buffer_Out)[0],
      (array_121800 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_122934(&(*Buffer_Out)[4], (array_122934 *) &(*Buffer_In)[0]);
