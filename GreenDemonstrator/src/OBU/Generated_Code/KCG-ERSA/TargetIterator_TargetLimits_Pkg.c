...
{
  /* TargetLimits_Pkg::TargetIterator */ V_internal_real_Type_SDM_Types_Pkg tmp1;
  /* TargetLimits_Pkg::TargetIterator */ kcg_bool tmp;
  ...
  /* TargetLimits_Pkg::TargetIterator::_L74 */ bec_t_TargetLimits_Pkg _L74;
  /* TargetLimits_Pkg::TargetIterator::_L73 */ T_trac_t_TargetLimits_Pkg _L73;
  /* TargetLimits_Pkg::TargetIterator::_L72 */ V_internal_real_Type_SDM_Types_Pkg _L72;
  /* TargetLimits_Pkg::TargetIterator::_L71 */ V_internal_real_Type_SDM_Types_Pkg _L71;
  /* TargetLimits_Pkg::TargetIterator::_L102 */ kcg_bool _L102;
  /* TargetLimits_Pkg::TargetIterator::_L111 */ kcg_real _L111;
  /* TargetLimits_Pkg::TargetIterator::_L110 */ kcg_bool _L110;
