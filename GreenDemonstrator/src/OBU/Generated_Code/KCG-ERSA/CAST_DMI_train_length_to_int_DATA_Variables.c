...
{
  /* DATA::Variables::CAST_DMI_train_length_to_int::_L23 */ kcg_int _L23;
  /* DATA::Variables::CAST_DMI_train_length_to_int::_L26 */ kcg_bool _L26;
  /* DATA::Variables::CAST_DMI_train_length_to_int::_L25 */ kcg_int _L25;
  /* DATA::Variables::CAST_DMI_train_length_to_int::_L28 */ kcg_int _L28;
  /* DATA::Variables::CAST_DMI_train_length_to_int::_L30 */ kcg_int _L30;
  /* DATA::Variables::CAST_DMI_train_length_to_int::dmi_train_length_int */ DMI_train_length_INT_T_DATA dmi_train_length_int;
