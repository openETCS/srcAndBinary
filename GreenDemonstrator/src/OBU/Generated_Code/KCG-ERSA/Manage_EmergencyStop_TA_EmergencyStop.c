...
void Manage_EmergencyStop_TA_EmergencyStop(
  ...
  outC_Manage_EmergencyStop_TA_EmergencyStop *outC)
{
  /* TA_EmergencyStop::Manage_EmergencyStop */ M_147_T_TM_radio_messages tmp2;
  /* TA_EmergencyStop::Manage_EmergencyStop */ P000_TM_TrainToTrack tmp1;
  /* TA_EmergencyStop::Manage_EmergencyStop */ P001_TM_TrainToTrack tmp;
  /* TA_EmergencyStop::Manage_EmergencyStop::receivedMsg16 */ kcg_bool receivedMsg16;
  /* TA_EmergencyStop::Manage_EmergencyStop::receivedMsg15 */ kcg_bool receivedMsg15;
  /* TA_EmergencyStop::Manage_EmergencyStop::receivedMsg18 */ kcg_bool receivedMsg18;
  /* TA_EmergencyStop::Manage_EmergencyStop::sendMsg147 */ kcg_bool sendMsg147;
  /* TA_EmergencyStop::Manage_EmergencyStop::nid_em */ NID_EM nid_em;
  /* TA_EmergencyStop::Manage_EmergencyStop::q_scale */ Q_SCALE q_scale;
  /* TA_EmergencyStop::Manage_EmergencyStop::d_ref */ D_REF d_ref;
  /* TA_EmergencyStop::Manage_EmergencyStop::q_dir */ Q_DIR q_dir;
  /* TA_EmergencyStop::Manage_EmergencyStop::d_emergencystop */ D_EMERGENCYSTOP d_emergencystop;
