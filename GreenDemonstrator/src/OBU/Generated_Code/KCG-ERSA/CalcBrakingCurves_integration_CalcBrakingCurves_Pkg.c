...
void CalcBrakingCurves_integration_CalcBrakingCurves_Pkg(
  ...
  outC_CalcBrakingCurves_integration_CalcBrakingCurves_Pkg *outC)
{
  /* CalcBrakingCurves_Pkg::CalcBrakingCurves_integration */ kcg_bool cond_iterw;
  /* CalcBrakingCurves_Pkg::CalcBrakingCurves_integration */ ParabolaCurve_T_CalcBrakingCurves_types _2_op_call;
  /* CalcBrakingCurves_Pkg::CalcBrakingCurves_integration */ kcg_bool _3_op_call;
  /* CalcBrakingCurves_Pkg::CalcBrakingCurves_integration */ ParabolaCurve_T_CalcBrakingCurves_types op_call;
  /* CalcBrakingCurves_Pkg::CalcBrakingCurves_integration */ kcg_bool _1_op_call;
  /* CalcBrakingCurves_Pkg::CalcBrakingCurves_integration::emptyCurve */ ParabolaCurve_T_CalcBrakingCurves_types emptyCurve;
