...
{
  /* TM_conversions::CAST_Int_to_M_AIRTIGHT::IfBlock1::else */ kcg_bool else_clock_IfBlock1;
  /* TM_conversions::CAST_Int_to_M_AIRTIGHT::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* TM_conversions::CAST_Int_to_M_AIRTIGHT::m_airtight */ M_AIRTIGHT m_airtight;
