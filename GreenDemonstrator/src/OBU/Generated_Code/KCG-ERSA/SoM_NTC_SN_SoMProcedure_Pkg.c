...
{
  /* SoMProcedure_Pkg::SoM_NTC_SN::Level_NTC_and_Mode_SN */ SSM_ST_Level_NTC_and_Mode_SN Level_NTC_and_Mode_SN_state_sel;
  /* SoMProcedure_Pkg::SoM_NTC_SN::Level_NTC_and_Mode_SN */ SSM_ST_Level_NTC_and_Mode_SN Level_NTC_and_Mode_SN_state_act;
