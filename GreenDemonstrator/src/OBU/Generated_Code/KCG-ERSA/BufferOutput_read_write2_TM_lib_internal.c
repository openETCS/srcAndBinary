  ...
  /* TM_lib_internal::BufferOutput_read_write2::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_124889(
      &(*Buffer_Out)[0],
      (array_124889 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_120967(
      &(*Buffer_Out)[0],
      (array_120967 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_121035(&(*Buffer_Out)[2], (array_121035 *) &(*Buffer_In)[0]);
