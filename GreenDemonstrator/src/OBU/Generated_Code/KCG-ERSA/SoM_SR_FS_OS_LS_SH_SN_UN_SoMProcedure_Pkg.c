  ...
  outC_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg *outC)
{
  ...
  outC->init = kcg_true;
  outC->SM1_state_nxt = _41_SSM_st_State1_SM1;
}
...
void SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg(
  ...
  outC_SoM_SR_FS_OS_LS_SH_SN_UN_SoMProcedure_Pkg *outC)
{
  /* SoMProcedure_Pkg::SoM_SR_FS_OS_LS_SH_SN_UN::SM1 */ _42_SSM_ST_SM1 SM1_state_sel;
  /* SoMProcedure_Pkg::SoM_SR_FS_OS_LS_SH_SN_UN::SM1 */ _42_SSM_ST_SM1 SM1_state_act;
  
  outC->request_Mode_Change_SB_to_FS_to_Level_and_Mode_Management = kcg_false;
  /* init_SM1 */ if (outC->init) {
    outC->init = kcg_false;
    SM1_state_sel = _41_SSM_st_State1_SM1;
  }
  else {
    SM1_state_sel = outC->SM1_state_nxt;
  }
  /* sel_SM1 */ switch (SM1_state_sel) {
    case _41_SSM_st_State1_SM1 :
      outC->request_MA_FS_SR_OS_LS_SH_to_MA_L2_Management = kcg_true;
