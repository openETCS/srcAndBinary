...
void Output_To_DMI_OutputManagement(
  ...
  outC_Output_To_DMI_OutputManagement *outC)
{
  /* OutputManagement::Output_To_DMI */ kcg_bool tmp1;
  /* OutputManagement::Output_To_DMI */ kcg_bool tmp;
  /* OutputManagement::Output_To_DMI::IfBlock1::else */ kcg_bool _7_else_clock_IfBlock1;
  /* OutputManagement::Output_To_DMI::IfBlock1::else::else::else */ kcg_bool _5_else_clock_IfBlock1;
  /* OutputManagement::Output_To_DMI::IfBlock1::else::else::else::else::else */ kcg_bool _3_else_clock_IfBlock1;
  /* OutputManagement::Output_To_DMI::IfBlock1::else::else::else::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* OutputManagement::Output_To_DMI::IfBlock1::else::else::else::else::else::else */ kcg_bool _2_else_clock_IfBlock1;
  /* OutputManagement::Output_To_DMI::IfBlock1::else::else::else::else */ kcg_bool _4_else_clock_IfBlock1;
  /* OutputManagement::Output_To_DMI::IfBlock1::else::else */ kcg_bool _6_else_clock_IfBlock1;
