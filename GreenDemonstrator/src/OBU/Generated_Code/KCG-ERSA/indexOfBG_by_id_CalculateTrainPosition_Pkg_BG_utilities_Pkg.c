...
{
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_by_id */ kcg_int acc;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_by_id */ kcg_bool cond_iterw;
  kcg_int i;
  /* CalculateTrainPosition_Pkg::BG_utilities_Pkg::indexOfBG_by_id */ positionedBG_T_TrainPosition_Types_Pck tmp;
