...
void BuildBGMessage_Receive_TrackSide_Msg_Pkg(
  ...
  outC_BuildBGMessage_Receive_TrackSide_Msg_Pkg *outC)
{
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */ TelegramStore_T_Receive_TrackSide_Msg_Pkg tmp5;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */ Telegram_T_BG_Types_Pkg tmp4;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */ centerOfBalisePosition_T_BG_Types_Pkg tmp3;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */ kcg_bool tmp2;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */ kcg_bool tmp1;
  /* Receive_TrackSide_Msg_Pkg::BuildBGMessage */ kcg_bool tmp;
