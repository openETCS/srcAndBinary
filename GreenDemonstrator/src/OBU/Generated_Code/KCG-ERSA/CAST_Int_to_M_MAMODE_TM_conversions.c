...
{
  /* TM_conversions::CAST_Int_to_M_MAMODE::IfBlock1::else */ kcg_bool _1_else_clock_IfBlock1;
  /* TM_conversions::CAST_Int_to_M_MAMODE::IfBlock1::else::else */ kcg_bool else_clock_IfBlock1;
  /* TM_conversions::CAST_Int_to_M_MAMODE::IfBlock1 */ kcg_bool IfBlock1_clock;
  /* TM_conversions::CAST_Int_to_M_MAMODE::m_mamode */ M_MAMODE m_mamode;
