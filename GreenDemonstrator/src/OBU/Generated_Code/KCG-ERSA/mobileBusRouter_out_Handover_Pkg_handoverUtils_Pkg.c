...
void mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg(
  ...
  outC_mobileBusRouter_out_Handover_Pkg_handoverUtils_Pkg *outC)
{
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out */ M_TrainTrackMessageBus_t_TM_TrainTrack_Bus tmp3;
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out */ M_TrainTrackMessageBus_t_TM_TrainTrack_Bus tmp2;
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out */ M_TrainTrackMessageBus_t_TM_TrainTrack_Bus tmp1;
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out */ M_TrainTrackMessageBus_t_TM_TrainTrack_Bus tmp;
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out::IfBlock1::else::_L294 */ kcg_bool _L294_IfBlock1;
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out::IfBlock1::else::_L295 */ M_TrainTrack_Message_T_TM_radio_messages _L295_IfBlock1;
  /* Handover_Pkg::handoverUtils_Pkg::mobileBusRouter_out::IfBlock1 */ kcg_bool IfBlock1_clock;
