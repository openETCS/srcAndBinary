...
{
  /* InputManagement::InputTrackManagement::Loc_conditionalTransitions */ T_LevelTransition_PriorityTable_Level_And_Mode_Types_Pkg Loc_conditionalTransitions;
  /* InputManagement::InputTrackManagement::Loc_Emergency_Stop_Message_Received */ kcg_bool Loc_Emergency_Stop_Message_Received;
  /* InputManagement::InputTrackManagement::Loc_Reversing_Data */ T_Reversing_Data_Level_And_Mode_Types_Pkg Loc_Reversing_Data;
  /* InputManagement::InputTrackManagement::Loc_RBC_Authorized_SR */ kcg_bool Loc_RBC_Authorized_SR;
  /* InputManagement::InputTrackManagement::Loc_RCB_Ack_And_EB_Revocked */ kcg_bool Loc_RCB_Ack_And_EB_Revocked;
  /* InputManagement::InputTrackManagement::Loc_Stop_If_In_SR */ kcg_bool Loc_Stop_If_In_SR;
