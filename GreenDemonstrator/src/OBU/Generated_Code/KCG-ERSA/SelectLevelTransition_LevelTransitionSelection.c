...
void SelectLevelTransition_LevelTransitionSelection(
  ...
  outC_SelectLevelTransition_LevelTransitionSelection *outC)
{
  /* LevelTransitionSelection::SelectLevelTransition::Loc_conditionnal */ T_LevelTransition_Level_And_Mode_Types_Pkg Loc_conditionnal;
  /* LevelTransitionSelection::SelectLevelTransition::Loc_driver */ T_LevelTransition_Level_And_Mode_Types_Pkg Loc_driver;
  /* LevelTransitionSelection::SelectLevelTransition::Loc_Normal */ T_LevelTransition_Level_And_Mode_Types_Pkg Loc_Normal;
  /* LevelTransitionSelection::SelectLevelTransition::last_level_transition */ T_LevelTransition_Level_And_Mode_Types_Pkg last_level_transition;
  /* LevelTransitionSelection::SelectLevelTransition::Loc_Normal_Available */ kcg_bool Loc_Normal_Available;
  /* LevelTransitionSelection::SelectLevelTransition::Loc_Conditionnal_Available */ kcg_bool Loc_Conditionnal_Available;
  /* LevelTransitionSelection::SelectLevelTransition::_L24 */ kcg_bool _L24;
