...
{
  /* CalculateTrainPosition_Pkg::passedBG_2_positionedBG */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp3;
  /* CalculateTrainPosition_Pkg::passedBG_2_positionedBG */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp2;
  /* CalculateTrainPosition_Pkg::passedBG_2_positionedBG */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp1;
  /* CalculateTrainPosition_Pkg::passedBG_2_positionedBG */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp;
  ...
  /* ck_ifAnnouncedOrABGWasPreviouslyPassed */ if (ifAnnouncedOrABGWasPreviouslyPassed_clock) {
    *foundNotWhereAnnounced = kcg_false;
    ...
    _4_else_clock_ifAnnouncedOrABGWasPreviouslyPassed = !BG_wasAnnounced &
      (*previouslyPassedLinkedBG).valid;
    /* ck_anon_activ */ if (_4_else_clock_ifAnnouncedOrABGWasPreviouslyPassed) {
      *foundNotWhereAnnounced = kcg_false;
      /* 5 */
      ...
      /* ck_anon_activ */ if (else_clock_ifAnnouncedOrABGWasPreviouslyPassed) {
        ...
        *foundNotWhereAnnounced = !_L10_ifAnnouncedOrABGWasPreviouslyPassed;
        /* 4 */ if (_L10_ifAnnouncedOrABGWasPreviouslyPassed) {
          kcg_copy_LocWithInAcc_T_Obu_BasicTypes_Pkg(
            &(*passedPositionedBG).location,
            &_L9_ifAnnouncedOrABGWasPreviouslyPassed);
        }
