...
{
  /* TM_radio_messages::Send_M154 */ M_TrainTrack_Message_T_TM_radio_messages tmp1;
  /* TM_radio_messages::Send_M154 */ M_TrainTrack_MessageHd_T_TM_radio_messages tmp;
  /* TM_radio_messages::Send_M154::_L7 */ M_TrainTrack_compressed_packets_T_TM_radio_messages _L7;
  /* TM_radio_messages::Send_M154::_L17 */ kcg_int _L17;
  /* TM_radio_messages::Send_M154::_L16 */ kcg_bool _L16;
  kcg_int i;
