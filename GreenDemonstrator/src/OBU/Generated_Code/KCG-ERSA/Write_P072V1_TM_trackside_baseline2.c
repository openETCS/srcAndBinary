...
{
  /* TM_trackside_baseline2::Write_P072V1::_L21 */ kcg_int _L21;
  /* TM_trackside_baseline2::Write_P072V1::_L22 */ kcg_int _L22;
  /* TM_trackside_baseline2::Write_P072V1::_L44 */ CompressedPacketData_T_Common_Types_Pkg _L44;
  /* TM_trackside_baseline2::Write_P072V1::_L43 */ MetadataElement_T_Common_Types_Pkg _L43;
  
  *Error = kcg_false;
  /* 1 */
  C_P072V1_tracksim_compr_TM_conversions_baseline2(Packet72V1, &_L43, &_L44);
  /* 1 */
