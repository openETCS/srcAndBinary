...
{
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop */ kcg_int tmp4;
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop */ kcg_int tmp3;
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop */ G_internal_Type_Obu_BasicTypes_Pkg tmp2;
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop */ L_internal_Type_Obu_BasicTypes_Pkg tmp1;
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop */ P021_section_enum_T_TM tmp;
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop::_L123 */ P021_section_enum_T_TM _L123;
  /* TA_Gradient_new::GP_Convert_P21_to_DistanceProfile_loop::_L143 */ Gradient_section_t_TrackAtlasTypes _L143;
