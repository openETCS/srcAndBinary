...
{
  /* CalcBrakingCurves_Pkg::internalOperators::nextIndex::_L6 */ kcg_int _L6;
  /* CalcBrakingCurves_Pkg::internalOperators::nextIndex::_L16 */ kcg_int _L16;
  /* CalcBrakingCurves_Pkg::internalOperators::nextIndex::_L21 */ kcg_int _L21;
  /* CalcBrakingCurves_Pkg::internalOperators::nextIndex::nextIndex */ kcg_int nextIndex;
