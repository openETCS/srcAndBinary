  ...
  /* TM_lib_internal::BufferOutput_read_write5::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_121788(
      &(*Buffer_Out)[0],
      (array_121788 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_122056(
      &(*Buffer_Out)[0],
      (array_122056 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_122647(&(*Buffer_Out)[5], (array_122647 *) &(*Buffer_In)[0]);
