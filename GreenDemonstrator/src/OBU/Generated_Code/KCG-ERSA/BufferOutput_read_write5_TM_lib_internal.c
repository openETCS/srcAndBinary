  ...
  /* TM_lib_internal::BufferOutput_read_write5::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_121432(
      &(*Buffer_Out)[0],
      (array_121432 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_121700(
      &(*Buffer_Out)[0],
      (array_121700 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_122297(&(*Buffer_Out)[5], (array_122297 *) &(*Buffer_In)[0]);
