...
{
  /* Conditions::ToFullSupervision */ kcg_bool tmp2;
  /* Conditions::ToFullSupervision */ kcg_bool tmp1;
  /* Conditions::ToFullSupervision */ M_LEVEL tmp;
  /* Conditions::ToFullSupervision::FS_Data_Condition */ kcg_bool FS_Data_Condition;
