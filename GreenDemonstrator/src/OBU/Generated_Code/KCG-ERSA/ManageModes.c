...
{
  /* ManageModes */ T_Mode_Level_And_Mode_Types_Pkg tmp;
  /* ManageModes::_L153 */ kcg_bool _L153;
  /* ManageModes::_L155 */ kcg_bool _L155;
  /* ManageModes::_L156 */ kcg_bool _L156;
  /* ManageModes::_L161 */ kcg_bool _L161;
  /* ManageModes::_L162 */ kcg_bool _L162;
  /* ManageModes::_L163 */ kcg_bool _L163;
  /* ManageModes::_L164 */ kcg_bool _L164;
  /* ManageModes::_L169 */ kcg_bool _L169;
  /* ManageModes::_L170 */ kcg_bool _L170;
  /* ManageModes::_L173 */ kcg_bool _L173;
  /* ManageModes::_L174 */ kcg_bool _L174;
  /* ManageModes::_L175 */ kcg_bool _L175;
  /* ManageModes::_L177 */ kcg_bool _L177;
  /* ManageModes::_L179 */ kcg_bool _L179;
  /* ManageModes::_L180 */ kcg_bool _L180;
  /* ManageModes::_L181 */ kcg_bool _L181;
  /* ManageModes::_L182 */ kcg_bool _L182;
  /* ManageModes::_L183 */ kcg_bool _L183;
  /* ManageModes::_L184 */ kcg_bool _L184;
  /* ManageModes::_L185 */ kcg_bool _L185;
  /* ManageModes::_L210 */ kcg_bool _L210;
  /* ManageModes::_L212 */ T_Mode_Profile_Level_And_Mode_Types_Pkg _L212;
  /* ManageModes::_L213 */ kcg_bool _L213;
  /* ManageModes::_L214 */ kcg_bool _L214;
  /* ManageModes::_L215 */ kcg_bool _L215;
  /* ManageModes::_L216 */ kcg_bool _L216;
  /* ManageModes::_L217 */ kcg_bool _L217;
  /* ManageModes::_L221 */ kcg_bool _L221;
  /* ManageModes::_L222 */ kcg_bool _L222;
  /* ManageModes::_L223 */ T_Reversing_Data_Level_And_Mode_Types_Pkg _L223;
  /* ManageModes::_L235 */ kcg_bool _L235;
  /* ManageModes::_L231 */ kcg_bool _L231;
  /* ManageModes::_L229 */ kcg_bool _L229;
  /* ManageModes::_L227 */ kcg_bool _L227;
  /* ManageModes::_L226 */ kcg_bool _L226;
  /* ManageModes::_L254 */ kcg_bool _L254;
  /* ManageModes::_L261 */ kcg_bool _L261;
  /* ManageModes::_L260 */ Speed_T_Obu_BasicTypes_Pkg _L260;
  /* ManageModes::_L259 */ trainPosition_T_TrainPosition_Types_Pck _L259;
  /* ManageModes::_L258 */ kcg_bool _L258;
  /* ManageModes::_L257 */ kcg_bool _L257;
  /* ManageModes::_L256 */ kcg_bool _L256;
  /* ManageModes::_L232 */ kcg_bool _L232;
  /* ManageModes::_L277 */ kcg_bool _L277;
  /* ManageModes::_L278 */ kcg_bool _L278;
  /* ManageModes::_L279 */ kcg_bool _L279;
  /* ManageModes::_L280 */ kcg_bool _L280;
  /* ManageModes::_L281 */ kcg_bool _L281;
  /* ManageModes::_L282 */ kcg_bool _L282;
  /* ManageModes::_L283 */ kcg_bool _L283;
  /* ManageModes::_L284 */ kcg_bool _L284;
  /* ManageModes::_L285 */ kcg_bool _L285;
