...
{
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop */ kcg_bool tmp2;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop */ T_SECTIONTIMER tmp1;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop */ kcg_int tmp;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop::section_d */ kcg_int section_d;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop::_L227 */ P015_section_enum_T_TM _L227;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop::_L252 */ MovementAuthoritySection_t_TrackAtlasTypes _L252;
  /* TA_MA_new::MA_Convert_P15_to_DistanceProfile_loop::_L281 */ kcg_bool _L281;
