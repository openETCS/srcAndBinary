...
{
  /* PriorityManagement::From_LS::IfBlock1::else::else::else::else::else::else::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* PriorityManagement::From_LS::IfBlock1::else::else::else::else::else::else::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* PriorityManagement::From_LS::IfBlock1::else::else::else::else::else::else */ kcg_bool _2_else_clock_IfBlock1;
  /* PriorityManagement::From_LS::FromLS_To_NewMode */ T_Mode_Level_And_Mode_Types_Pkg FromLS_To_NewMode;
