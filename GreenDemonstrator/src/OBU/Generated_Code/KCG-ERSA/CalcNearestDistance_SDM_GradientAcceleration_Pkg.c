...
{
  /* SDM_GradientAcceleration_Pkg::CalcNearestDistance::_L5 */ L_internal_real_Type_SDM_Types_Pkg _L5;
  /* SDM_GradientAcceleration_Pkg::CalcNearestDistance::_L6 */ kcg_bool _L6;
  /* SDM_GradientAcceleration_Pkg::CalcNearestDistance::_L9 */ L_internal_real_Type_SDM_Types_Pkg _L9;
  /* SDM_GradientAcceleration_Pkg::CalcNearestDistance::_L10 */ kcg_bool _L10;
