...
{
  /* SDMModelPkg::ABrakeFactory */ ASafe_T_CalcBrakingCurves_types tmp1;
  /* SDMModelPkg::ABrakeFactory */ av_MergedMap_t_SDMConversionModelPkg tmp;
  /* SDMModelPkg::ABrakeFactory::_L10 */ a_Brake_t_SDMConversionModelPkg _L10;
