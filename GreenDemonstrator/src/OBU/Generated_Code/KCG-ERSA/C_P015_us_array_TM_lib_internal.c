...
{
  /* TM_lib_internal::C_P015_us_array::_L16 */ kcg_int _L16;
  
  (*sections).valid = kcg_true;
  _L16 = i * DIM_P015_n_sections_TM_lib_internal;
  (*sections).l_section = /* 1 */
    CAST_Int_to_L_SECTION_TM_conversions(
      /* 1 */ C_P015_extract_el_section_TM_lib_internal(_L16, flat, 0));
  (*sections).q_sectiontimer = /* 1 */
    CAST_Int_to_Q_SECTIONTIMER_TM_conversions(
      /* 2 */ C_P015_extract_el_section_TM_lib_internal(_L16, flat, 1));
  (*sections).t_sectiontimer = /* 1 */
    CAST_Int_to_T_SECTIONTIMER_TM_conversions(
      /* 3 */ C_P015_extract_el_section_TM_lib_internal(_L16, flat, 2));
  (*sections).d_sectiontimerstoploc = /* 2 */
    CAST_Int_to_D_SECTIONTIMERSTOPLOC_TM_conversions(
      /* 4 */ C_P015_extract_el_section_TM_lib_internal(_L16, flat, 3));
  *cont = n_iter_int > i;
}
