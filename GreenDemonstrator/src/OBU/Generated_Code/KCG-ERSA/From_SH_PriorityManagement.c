...
{
  /* PriorityManagement::From_SH::IfBlock1::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* PriorityManagement::From_SH::FromSH_To_NewMode */ T_Mode_Level_And_Mode_Types_Pkg FromSH_To_NewMode;
