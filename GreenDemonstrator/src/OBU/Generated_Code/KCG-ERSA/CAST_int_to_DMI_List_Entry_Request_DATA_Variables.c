...
{
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else */ kcg_bool _13_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else */ kcg_bool _11_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else */ kcg_bool _9_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else::else */ kcg_bool _7_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else::else::else::else */ kcg_bool _5_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool _3_else_clock_IfBlock1;
  ...
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool _2_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else::else::else::else::else */ kcg_bool _4_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else::else::else */ kcg_bool _6_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else::else::else */ kcg_bool _8_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else::else::else */ kcg_bool _10_else_clock_IfBlock1;
  /* DATA::Variables::CAST_int_to_DMI_List_Entry_Request::IfBlock1::else::else */ kcg_bool _12_else_clock_IfBlock1;
  ...
  /* ck_IfBlock1 */ if (IfBlock1_clock) {
    ...
    _13_else_clock_IfBlock1 = dmi_list_entry_request_int ==
