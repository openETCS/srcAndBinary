...
void manageDMI_Output_manage_DMI_Output_Pkg(
  ...
  outC_manageDMI_Output_manage_DMI_Output_Pkg *outC)
{
  /* manage_DMI_Output_Pkg::manageDMI_Output */ DMI_Track_Description_T_DMI_Messages_EVC_to_DMI_Pkg tmp2;
  /* manage_DMI_Output_Pkg::manageDMI_Output */ DMI_EVC_Level_Data_T_DMI_Messages_EVC_to_DMI_Pkg tmp1;
  /* manage_DMI_Output_Pkg::manageDMI_Output */ DMI_Train_Data_T_DMI_Messages_Bothways_Pkg tmp;
  /* manage_DMI_Output_Pkg::manageDMI_Output::doTrainData */ kcg_bool doTrainData;
  /* manage_DMI_Output_Pkg::manageDMI_Output::levelUpdate */ kcg_bool levelUpdate;
  /* manage_DMI_Output_Pkg::manageDMI_Output::_L31 */ DMI_Menu_Request_T_DMI_Messages_EVC_to_DMI_Pkg _L31;
  /* manage_DMI_Output_Pkg::manageDMI_Output::_L30 */ DMI_Entry_Request_T_DMI_Messages_EVC_to_DMI_Pkg _L30;
  /* manage_DMI_Output_Pkg::manageDMI_Output::_L77 */ DMI_Text_Message_T_DMI_Messages_EVC_to_DMI_Pkg _L77;
  ...
  cyclicReportToDMI_manage_DMI_Output_Pkg(
    ...
    inNTC,
    (kcg_bool)
      ((*dmi_trackDescription).MRSP_updated |
        (*dmi_trackDescription).Gradient_profile_updated),
    &outC->Context_1);
  /* 1 */
