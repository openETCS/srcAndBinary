...
void nextGen_Msg136_radioOutput_Pkg(
  ...
  outC_nextGen_Msg136_radioOutput_Pkg *outC)
{
  /* radioOutput_Pkg::nextGen_Msg136 */ M_136_T_TM_radio_messages tmp4;
  /* radioOutput_Pkg::nextGen_Msg136 */ P000_TM_TrainToTrack tmp3;
  /* radioOutput_Pkg::nextGen_Msg136 */ P001_TM_TrainToTrack tmp2;
  /* radioOutput_Pkg::nextGen_Msg136 */ P004_TM_TrainToTrack tmp1;
  /* radioOutput_Pkg::nextGen_Msg136 */ P005_TM_TrainToTrack tmp;
