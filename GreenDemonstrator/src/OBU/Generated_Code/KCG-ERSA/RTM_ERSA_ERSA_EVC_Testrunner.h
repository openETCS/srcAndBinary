...
typedef struct {
  ...
  kcg_bool init3;
  /* ----------------------- local memories  ------------------------- */
  struct_121580 /* ERSA_EVC_Testrunner::RTM_ERSA */ _1_fby_RTM_ERSA_ERSA_EVC_Testrunner;
  struct_121580 /* ERSA_EVC_Testrunner::RTM_ERSA */ fby_RTM_ERSA_ERSA_EVC_Testrunner;
