...
void processHandingOver_Handover_Pkg_handoverUtils_Pkg(
  ...
  outC_processHandingOver_Handover_Pkg_handoverUtils_Pkg *outC)
{
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver */ positionedBG_T_TrainPosition_Types_Pck tmp1;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver */ LocWithInAcc_T_Obu_BasicTypes_Pkg tmp;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::p131_RBCTransitionOrder_dec */ p131_q_rbcTransitionOrder_T_Handover_Pkg p131_RBCTransitionOrder_dec;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::locationOfRBCTransition */ LocWithInAcc_T_Obu_BasicTypes_Pkg locationOfRBCTransition;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L1 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L1;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L38 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L38;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L37 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L37;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L36 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L36;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L35 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L35;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L45 */ morcStatus_T_RCM_Session_Types_Pkg _L45;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L44 */ morcStatus_T_RCM_Session_Types_Pkg _L44;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L89 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L89;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L174 */ kcg_bool _L174;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L173 */ kcg_bool _L173;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L172 */ kcg_int _L172;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L176 */ NID_BG _L176;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L175 */ NID_C _L175;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L196 */ kcg_bool _L196;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L212 */ LocWithInAcc_T_Obu_BasicTypes_Pkg _L212;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L226 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L226;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L228 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L228;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L229 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L229;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L243 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L243;
  /* Handover_Pkg::handoverUtils_Pkg::processHandingOver::_L246 */ msgFromTrack_T_RCM_MsgTypes_Pkg _L246;
