...
void MA_Request_Supervision_TA_MA_Request(
  ...
  outC_MA_Request_Supervision_TA_MA_Request *outC)
{
  /* TA_MA_Request::MA_Request_Supervision */ kcg_bool tmp1;
  /* TA_MA_Request::MA_Request_Supervision */ kcg_bool tmp;
  /* TA_MA_Request::MA_Request_Supervision::SM1 */ _24_SSM_ST_SM1 SM1_state_sel;
  /* TA_MA_Request::MA_Request_Supervision::SM1 */ _24_SSM_ST_SM1 SM1_state_act;
  /* TA_MA_Request::MA_Request_Supervision::_L81 */ kcg_bool _L81;
