...
{
  /* PriorityManagement::From_PT::IfBlock1::else::else::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* PriorityManagement::From_PT::IfBlock1::else::else::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* PriorityManagement::From_PT::FromPT_To_NewMode */ T_Mode_Level_And_Mode_Types_Pkg FromPT_To_NewMode;
