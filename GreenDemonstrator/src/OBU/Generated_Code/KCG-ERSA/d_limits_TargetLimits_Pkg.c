...
{
  /* TargetLimits_Pkg::d_limits */ kcg_bool tmp1;
  /* TargetLimits_Pkg::d_limits */ L_internal_real_Type_SDM_Types_Pkg tmp;
  /* TargetLimits_Pkg::d_limits::_L31 */ kcg_bool _L31;
  /* TargetLimits_Pkg::d_limits::_L37 */ kcg_bool _L37;
