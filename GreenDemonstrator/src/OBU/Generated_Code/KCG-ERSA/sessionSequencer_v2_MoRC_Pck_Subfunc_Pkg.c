...
void sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg(
  ...
  outC_sessionSequencer_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2 */ sessionCmd_T_RCM_Session_Types_Pkg tmp1;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2 */ kcg_bool tmp;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::sessionTerminated::_L29 */ kcg_bool _L29_Session_SM_sessionTerminated;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L17 */ kcg_bool _L17_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L16 */ kcg_bool _L16_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L1 */ p42_sessionManagement_T_RCM_MsgTypes_Pkg _L1_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L2 */ kcg_bool _L2_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L3 */ kcg_bool _L3_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L4 */ kcg_bool _L4_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L5 */ kcg_bool _L5_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L7 */ kcg_bool _L7_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession::_L8 */ sessionStatus_T_RCM_Session_Types_Pkg _L8_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::establishingSession */ kcg_bool br_2_clock_Session_SM_establishingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM::maintainingSession::_L3 */ kcg_bool _L3_Session_SM_maintainingSession;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::sessionStatus_l */ sessionStatus_T_RCM_Session_Types_Pkg last_sessionStatus_l;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM */ SSM_ST_Session_SM Session_SM_state_act;
  /* MoRC_Pck::Subfunc_Pkg::sessionSequencer_v2::Session_SM */ kcg_bool Session_SM_reset_sel;
