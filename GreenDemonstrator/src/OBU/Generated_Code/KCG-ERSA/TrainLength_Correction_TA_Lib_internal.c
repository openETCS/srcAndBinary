...
{
  /* TA_Lib_internal::TrainLength_Correction */ StaticSpeedSection_t_TrackAtlasTypes tmp;
  /* TA_Lib_internal::TrainLength_Correction::corrected_distance */ L_internal_Type_Obu_BasicTypes_Pkg corrected_distance;
