...
{
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else */ kcg_bool _14_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else */ kcg_bool _12_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else */ kcg_bool _10_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else */ kcg_bool _8_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else */ kcg_bool _6_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool _4_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool _2_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool _1_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else::else::else::else */ kcg_bool _3_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else::else::else */ kcg_bool _5_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else::else::else */ kcg_bool _7_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else::else::else */ kcg_bool _9_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else::else::else */ kcg_bool _11_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1::else::else */ kcg_bool _13_else_clock_IfBlock1;
  /* TM_conversions::CAST_M_MODE_to_int::IfBlock1 */ kcg_bool IfBlock1_clock;
