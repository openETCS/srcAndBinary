...
void M039_to_Radio_Track_Train_H_TM_RBC_conversions_legacy(
  /* TM_RBC_conversions_legacy::M039_to_Radio_Track_Train_H::M039_in */M_039_T_TM_radio_messages *M039_in,
  /* TM_RBC_conversions_legacy::M039_to_Radio_Track_Train_H::Radio_Track_Train_Hd_out */Radio_TrackTrain_Header_T_Radio_Types_Pkg *Radio_Track_Train_Hd_out)
{
  ...
  (*Radio_Track_Train_Hd_out).nid_message = (*M039_in).nid_message;
  (*Radio_Track_Train_Hd_out).t_train = (*M039_in).t_train;
  (*Radio_Track_Train_Hd_out).m_ack = (*M039_in).m_ack;
  (*Radio_Track_Train_Hd_out).nid_lrbg = (*M039_in).nid_lrbg;
...
/* $*************** KCG Version 6.1.3 (build i6) ****************
** M039_to_Radio_Track_Train_H_TM_RBC_conversions_legacy.c
** Generation date: 2015-10-19T14:37:59
*************************************************************$ */
