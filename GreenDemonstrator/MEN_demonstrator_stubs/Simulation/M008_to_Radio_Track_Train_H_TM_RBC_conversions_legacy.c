...
void M008_to_Radio_Track_Train_H_reset_TM_RBC_conversions_legacy(
  ...
  outC_M008_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
  ...
  kcg_copy_M_008_T_TM_radio_messages(&outC->_L1, M008_in);
  outC->_L24 = outC->_L1.t_train_received;
  ...
  outC->_L14.t_train_reference = outC->_L24;
