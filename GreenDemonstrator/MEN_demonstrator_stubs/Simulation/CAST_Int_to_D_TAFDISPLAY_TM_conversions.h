...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  D_TAFDISPLAY /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::d_tafdisplay */ d_tafdisplay;
  /* -----------------------  no local probes  ----------------------- */
  ...
  kcg_int /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L7 */ _L7;
  kcg_int /* TM_conversions::CAST_Int_to_D_TAFDISPLAY::_L6 */ _L6;
