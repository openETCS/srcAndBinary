...
void CAST_Int_to_Q_SECTIONTIMER_TM_conversions(
  ...
  outC_CAST_Int_to_Q_SECTIONTIMER_TM_conversions *outC)
{
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::q_sectiontimer */ Q_SECTIONTIMER _2_q_sectiontimer;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::error */ kcg_bool error1;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::q_sectiontimer */ Q_SECTIONTIMER q_sectiontimer;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::error */ kcg_bool error;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::q_sectiontimer */ Q_SECTIONTIMER _3_q_sectiontimer;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::error */ kcg_bool error4;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::q_sectiontimer */ Q_SECTIONTIMER _5_q_sectiontimer;
  /* TM_conversions::CAST_Int_to_Q_SECTIONTIMER::error */ kcg_bool error6;
  kcg_bool noname;
  ...
  if (outC->IfBlock1_clock) {
    ...
    outC->_L4_IfBlock1 = ENUM_Q_SECTIONTIMER_sectiontimer_TM_conversions;
    _2_q_sectiontimer = outC->_L4_IfBlock1;
    outC->q_sectiontimer = _2_q_sectiontimer;
    outC->error = error1;
  }
  else {
    ...
    if (outC->else_clock_IfBlock1) {
      ...
      outC->_L3_IfBlock1 = ENUM_Q_SECTIONTIMER_no_sectiontimer_TM_conversions;
      _5_q_sectiontimer = outC->_L3_IfBlock1;
      error = error6;
      ...
      outC->_L1_IfBlock1 = ENUM_Q_SECTIONTIMER_sectiontimer_TM_conversions;
      _3_q_sectiontimer = outC->_L1_IfBlock1;
      error = error4;
      q_sectiontimer = _3_q_sectiontimer;
    }
    outC->q_sectiontimer = q_sectiontimer;
    outC->error = error;
  }
