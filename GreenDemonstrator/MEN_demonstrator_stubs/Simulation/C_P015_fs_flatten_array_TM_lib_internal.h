...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P015_sections_array_flat_T_TM /* TM_lib_internal::C_P015_fs_flatten_array::flat */ flat;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P015_sections_array_flat_T_TM /* TM_lib_internal::C_P015_fs_flatten_array::_L1 */ _L1;
  kcg_int /* TM_lib_internal::C_P015_fs_flatten_array::_L3 */ _L3;
  kcg_int /* TM_lib_internal::C_P015_fs_flatten_array::_L5 */ _L5;
  kcg_int /* TM_lib_internal::C_P015_fs_flatten_array::_L6 */ _L6;
  P015_sections_array_flat_T_TM /* TM_lib_internal::C_P015_fs_flatten_array::_L7 */ _L7;
  kcg_int /* TM_lib_internal::C_P015_fs_flatten_array::_L8 */ _L8;
  P015_OBU_sectionlist_array_T_TM /* TM_lib_internal::C_P015_fs_flatten_array::_L2 */ _L2;
  kcg_int /* TM_lib_internal::C_P015_fs_flatten_array::_L10 */ _L10;
  kcg_int /* TM_lib_internal::C_P015_fs_flatten_array::_L154 */ _L154;
