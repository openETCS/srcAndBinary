...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  D_STARTOL /* TM_conversions::CAST_Int_to_D_STARTOL::d_startol */ d_startol;
  /* -----------------------  no local probes  ----------------------- */
  ...
  kcg_int /* TM_conversions::CAST_Int_to_D_STARTOL::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_Int_to_D_STARTOL::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_Int_to_D_STARTOL::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_Int_to_D_STARTOL::_L7 */ _L7;
  kcg_int /* TM_conversions::CAST_Int_to_D_STARTOL::_L6 */ _L6;
