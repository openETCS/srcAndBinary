...
{
  /* 1 */ CAST_Int_to_M_ERROR_reset_TM_conversions(&outC->_2_Context_1);
  ...
  outC_C_compr_P004_TM_TrainToTrack *outC)
{
  ...
  outC->_L3 = outC->_L1[1];
  outC->_L2 = outC->_L1[0];
  /* 1 */ Decode_NID_PACKET_TM_TrainToTrack(outC->_L2, 4, &outC->Context_1);
  ...
  /* 1 */ CAST_Int_to_M_ERROR_TM_conversions(outC->_L76, &outC->_2_Context_1);
  outC->_L71 = outC->_2_Context_1.m_error;
