...
void C_P045_tracksim_compr_reset_TM_conversions(
  ...
  outC_C_P045_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_P045_trackside_int_T_TM(&outC->_L1, P045_from_track);
  outC->_L393 = outC->_L1.NID_MN;
  ...
  T_Build_Metadata_Packet_ID_TM_lib_internal(
    ...
    &outC->Context_1);
  outC->_L396 = outC->Context_1.nid_packet_meta;
  outC->_L388 = DIM_MaxElementsPacket045_TM;
  outC->_L373[0] = outC->_L387;
  outC->_L373[1] = outC->_L395;
  outC->_L373[2] = outC->_L394;
  outC->_L373[3] = outC->_L393;
  outC->_L336 = 0;
  for (i = 0; i < 496; i++) {
  ...
  outC->_L206 = 0;
  outC->_L204.nid_packet = outC->_L396;
