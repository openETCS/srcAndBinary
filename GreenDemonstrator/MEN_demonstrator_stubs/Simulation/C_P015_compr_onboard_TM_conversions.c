  ...
  outC_C_P015_compr_onboard_TM_conversions *outC)
{
  ...
  /* 2 */ CAST_Int_to_D_ENDTIMERSTA_reset_TM_conversions(&outC->_3_Context_2);
  ...
  outC_C_P015_compr_onboard_TM_conversions *outC)
{
  ...
  /* 2 */
  CAST_Int_to_D_SECTIONTIME_TM_conversions(outC->_L107, &outC->Context_2);
  ...
  /* 2 */
  CAST_Int_to_D_ENDTIMERSTA_TM_conversions(outC->_L110, &outC->_3_Context_2);
