...
void M032_to_Radio_Track_Train_H_reset_TM_RBC_conversions_legacy(
  outC_M032_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
}

/* TM_RBC_conversions_legacy::M032_to_Radio_Track_Train_H */
void M032_to_Radio_Track_Train_H_TM_RBC_conversions_legacy(
  ...
  outC_M032_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
  ...
  kcg_copy_M_032_T_TM_radio_messages(&outC->_L1, M032_in);
  outC->_L26 = outC->_L1._1_m_version;
  ...
  outC->_L14._1_m_version = outC->_L26;
