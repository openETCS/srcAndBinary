...
void C_header_to_M045_reset_TM_RBC_conversions(
  outC_C_header_to_M045_TM_RBC_conversions *outC)
{
  ...
  /* 1 */ CAST_Int_to_Q_ORIENTATION_reset_TM_conversions(&outC->_3_Context_1);
...
void C_header_to_M045_TM_RBC_conversions(
  ...
  outC_C_header_to_M045_TM_RBC_conversions *outC)
{
  ...
  /* 1 */
  CAST_Int_to_Q_ORIENTATION_TM_conversions(outC->_L8, &outC->_3_Context_1);
  outC->_L29 = outC->_3_Context_1.q_orientation;
  _4_noname = outC->_L12;
  _3_noname = outC->_L11;
  _2_noname = outC->_L10;
  _1_noname = outC->_L9;
  ...
  outC->_L26.q_orientation = outC->_L29;
  kcg_copy_M_045_T_TM_radio_messages(&outC->message_out, &outC->_L26);
}
