...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  kcg_int /* TM_conversions::CAST_NID_ENGINE_to_int::nid_ctraction_int */ nid_ctraction_int;
  /* -----------------------  no local probes  ----------------------- */
  ...
  NID_CTRACTION /* TM_conversions::CAST_NID_ENGINE_to_int::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_NID_ENGINE_to_int::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_NID_ENGINE_to_int::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_NID_ENGINE_to_int::_L10 */ _L10;
  kcg_int /* TM_conversions::CAST_NID_ENGINE_to_int::_L11 */ _L11;
