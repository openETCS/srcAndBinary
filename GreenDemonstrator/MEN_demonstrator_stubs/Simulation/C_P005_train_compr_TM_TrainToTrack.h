...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  P005_TrainTrack_int_TM_TrainToTrack /* TM_TrainToTrack::C_P005_train_compr::P005_int */ P005_int;
  /* -----------------------  no local probes  ----------------------- */
  /* -----------------  no initialization variables  ----------------- */
  /* -----------------------  no local memory  ----------------------- */
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_CAST_L_PACKET_to_int_TM_conversions /* 1 */ _3_Context_1;
  outC_CAST_NID_OPERATIONAL_to_int_TM_conversions /* 1 */ _2_Context_1;
  outC_Encode_NID_PACKET_TM_TrainToTrack /* 1 */ _1_Context_1;
  outC_CAST_NID_PACKET_to_int_TM_conversions /* 1 */ Context_1;
  /* ----------------- no clocks of observable data ------------------ */
  /* -------------------- (-debug) no assertions  -------------------- */
  /* ------------------- (-debug) local variables -------------------- */
  P005_TM_TrainToTrack /* TM_TrainToTrack::C_P005_train_compr::_L1 */ _L1;
  NID_OPERATIONAL /* TM_TrainToTrack::C_P005_train_compr::_L5 */ _L5;
  L_PACKET /* TM_TrainToTrack::C_P005_train_compr::_L4 */ _L4;
  NID_PACKET /* TM_TrainToTrack::C_P005_train_compr::_L3 */ _L3;
  kcg_bool /* TM_TrainToTrack::C_P005_train_compr::_L2 */ _L2;
  array_int_3 /* TM_TrainToTrack::C_P005_train_compr::_L68 */ _L68;
  kcg_int /* TM_TrainToTrack::C_P005_train_compr::_L69 */ _L69;
  kcg_int /* TM_TrainToTrack::C_P005_train_compr::_L70 */ _L70;
  kcg_int /* TM_TrainToTrack::C_P005_train_compr::_L71 */ _L71;
  kcg_int /* TM_TrainToTrack::C_P005_train_compr::_L89 */ _L89;
