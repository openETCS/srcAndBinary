...
void C_header_to_M015_reset_TM_RBC_conversions(
  outC_C_header_to_M015_TM_RBC_conversions *outC)
{
  /* 1 */ CAST_Int_to_M_ACK_reset_TM_conversions(&outC->_7_Context_1);
  /* 1 */ CAST_Int_to_NID_LRBG_reset_TM_conversions(&outC->_6_Context_1);
  /* 1 */ CAST_Int_to_NID_EM_reset_TM_conversions(&outC->_5_Context_1);
  /* 1 */ CAST_Int_to_D_REF_reset_TM_conversions(&outC->_4_Context_1);
  /* 1 */ CAST_Int_to_D_EMERGENCYSTOP_reset_TM_conversions(&outC->_3_Context_1);
  ...
  outC_C_header_to_M015_TM_RBC_conversions *outC)
{
  ...
  outC->_L37 = outC->Context_1.nid_message;
  /* 1 */ CAST_Int_to_T_TRAIN_TM_conversions(outC->_L5, &outC->_1_Context_1);
  outC->_L36 = outC->_1_Context_1.t_train;
  /* 1 */ CAST_Int_to_L_MESSAGE_TM_conversions(outC->_L4, &outC->_2_Context_1);
  outC->_L35 = outC->_2_Context_1.l_message;
  /* 1 */
  CAST_Int_to_D_EMERGENCYSTOP_TM_conversions(outC->_L12, &outC->_3_Context_1);
  outC->_L33 = outC->_3_Context_1.d_emergencystop;
  outC->q_dir_int_1 = outC->_L11;
  outC->_L12_1 = outC->q_dir_int_1;
  outC->q_dir_in_1 = outC->_L12_1;
  outC->_14_IfBlock1_clock_1 = outC->q_dir_in_1 ==
    INT_Q_DIR_nomiinal_TM_conversions;
  if (outC->_14_IfBlock1_clock_1) {
    outC->_L4_122_IfBlock1 = ENUM_Q_DIR_nominal_TM_conversions;
    _22_q_dir_1 = outC->_L4_122_IfBlock1;
    outC->q_dir_1 = _22_q_dir_1;
  }
  else {
    outC->_21_else_clock_1_IfBlock1 = outC->q_dir_in_1 ==
      INT_Q_DIR_reverse_TM_conversions;
    if (outC->_21_else_clock_1_IfBlock1) {
      outC->_L3_115_IfBlock1 = ENUM_Q_DIR_reverse_TM_conversions;
      q_dir_1 = outC->_L3_115_IfBlock1;
      _20_q_dir_1 = q_dir_1;
    }
    else {
      ...
      if (outC->_16_else_clock_1_IfBlock1) {
        outC->_L2_119_IfBlock1 = ENUM_Q_DIR_both_TM_conversions;
        _17_q_dir_1 = outC->_L2_119_IfBlock1;
        _14_q_dir_1 = _17_q_dir_1;
      }
      else {
        outC->_L2_117_IfBlock1 = ENUM_Q_DIR_both_TM_conversions;
        _15_q_dir_1 = outC->_L2_117_IfBlock1;
  ...
  /* 1 */ CAST_Int_to_D_REF_TM_conversions(outC->_L10, &outC->_4_Context_1);
  outC->_L31 = outC->_4_Context_1.d_ref;
  ...
  if (outC->IfBlock1_clock_1) {
    outC->_L2_111_IfBlock1 = ENUM_Q_SCALE_10cm_TM_conversions;
    _10_q_scale_1 = outC->_L2_111_IfBlock1;
    outC->q_scale_1 = _10_q_scale_1;
  }
  else {
    outC->_10_else_clock_1_IfBlock1 = outC->q_scale_in_1 ==
    ...
    if (outC->_10_else_clock_1_IfBlock1) {
      ...
      if (outC->else_clock_1_IfBlock1) {
        outC->_L1_19_IfBlock1 = ENUM_Q_SCALE_10m_TM_conversions;
        _5_q_scale_1 = outC->_L1_19_IfBlock1;
        _2_q_scale_1 = _5_q_scale_1;
      }
      else {
        outC->_L1_18_IfBlock1 = ENUM_Q_SCALE_10cm_TM_conversions;
        _3_q_scale_1 = outC->_L1_18_IfBlock1;
  ...
  /* 1 */ CAST_Int_to_NID_EM_TM_conversions(outC->_L8, &outC->_5_Context_1);
  outC->_L29 = outC->_5_Context_1.nid_em;
  noname = outC->_L13;
  /* 1 */ CAST_Int_to_NID_LRBG_TM_conversions(outC->_L7, &outC->_6_Context_1);
  outC->_L28 = outC->_6_Context_1.NID_LRBG_out;
  /* 1 */ CAST_Int_to_M_ACK_TM_conversions(outC->_L6, &outC->_7_Context_1);
  outC->_L27 = outC->_7_Context_1.m_ack;
  outC->_L2 = outC->_L1.valid;
  outC->_L26.valid = outC->_L2;
  outC->_L26.nid_message = outC->_L37;
  outC->_L26.l_message = outC->_L35;
  outC->_L26.t_train = outC->_L36;
  ...
  if (outC->IfBlock1_clock_1) {
    outC->_L3_112_IfBlock1 = kcg_false;
    _9_error_1 = outC->_L3_112_IfBlock1;
  ...
  noname_1 = outC->_L4_1;
  if (outC->_14_IfBlock1_clock_1) {
    outC->_L5_123_IfBlock1 = kcg_false;
    _21_error_1 = outC->_L5_123_IfBlock1;
    outC->_13_error_1 = _21_error_1;
  }
  else {
    if (outC->_21_else_clock_1_IfBlock1) {
      ...
      if (outC->_16_else_clock_1_IfBlock1) {
        outC->_L4_120_IfBlock1 = kcg_false;
        _18_error_1 = outC->_L4_120_IfBlock1;
        _13_error_1 = _18_error_1;
      }
      else {
        outC->_L1_118_IfBlock1 = kcg_true;
        _16_error_1 = outC->_L1_118_IfBlock1;
        _13_error_1 = _16_error_1;
      }
      _19_error_1 = _13_error_1;
    }
    outC->_13_error_1 = _19_error_1;
  }
  outC->_L13_1 = outC->_13_error_1;
