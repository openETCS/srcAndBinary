...
void M009_to_Radio_Track_Train_H_reset_TM_RBC_conversions_legacy(
  ...
  outC_M009_to_Radio_Track_Train_H_TM_RBC_conversions_legacy *outC)
{
  ...
  kcg_copy_M_009_T_TM_radio_messages(&outC->_L1, M009_in);
  ...
  outC->_L27 = default_t_train_reference_TM_RBC_conversions_legacy;
  outC->_L26 = default_radioDevice_TM_RBC_conversions_legacy;
  ...
  noname = outC->_L2;
  outC->_L14.radioDevice = outC->_L26;
  ...
  outC->_L14.t_train_reference = outC->_L27;
  ...
  outC->_L14._1_m_version = outC->_L23;
