...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  L_TAFDISPLAY /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::l_tafdisplay */ l_tafdisplay;
  /* -----------------------  no local probes  ----------------------- */
  ...
  kcg_int /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L1 */ _L1;
  kcg_bool /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L9 */ _L9;
  kcg_bool /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L8 */ _L8;
  kcg_int /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L10 */ _L10;
  kcg_int /* TM_conversions::CAST_Int_to_L_TAFDISPLAY::_L11 */ _L11;
