...
void C_header_to_M006_reset_TM_RBC_conversions(
...
void C_header_to_M006_TM_RBC_conversions(
  ...
  outC_C_header_to_M006_TM_RBC_conversions *outC)
{
  ...
  outC->_L32 = outC->Context_1.nid_message;
  /* 1 */ CAST_Int_to_T_TRAIN_TM_conversions(outC->_L5, &outC->_1_Context_1);
  outC->_L31 = outC->_1_Context_1.t_train;
  ...
  outC->_L26.t_train = outC->_L31;
  outC->_L26.m_ack = outC->_L27;
  outC->_L26.nid_lrbg = outC->_L28;
  kcg_copy_M_006_T_TM_radio_messages(&outC->message_out, &outC->_L26);
}

/* $*************** KCG Version 6.1.3 (build i6) ****************
** C_header_to_M006_TM_RBC_conversions.c
** Generation date: 2015-10-19T14:35:58
*************************************************************$ */
