...
typedef struct {
  /* ---------------------------  outputs  --------------------------- */
  MetadataElement_T_Common_Types_Pkg /* TM_conversions::C_P255_tracksim_compr::Header */ Header;
  CompressedPacketData_T_Common_Types_Pkg /* TM_conversions::C_P255_tracksim_compr::P005_compressed */ P005_compressed;
  /* -----------------------  no local probes  ----------------------- */
  ...
  P255_trackside_int_T_TM /* TM_conversions::C_P255_tracksim_compr::_L1 */ _L1;
  MetadataElement_T_Common_Types_Pkg /* TM_conversions::C_P255_tracksim_compr::_L204 */ _L204;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L206 */ _L206;
  array_int_499 /* TM_conversions::C_P255_tracksim_compr::_L209 */ _L209;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L212 */ _L212;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L213 */ _L213;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L336 */ _L336;
  kcg_bool /* TM_conversions::C_P255_tracksim_compr::_L214 */ _L214;
  Q_DIR /* TM_conversions::C_P255_tracksim_compr::_L356 */ _L356;
  array_int_1 /* TM_conversions::C_P255_tracksim_compr::_L373 */ _L373;
  array_int_500 /* TM_conversions::C_P255_tracksim_compr::_L383 */ _L383;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L387 */ _L387;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L388 */ _L388;
  kcg_int /* TM_conversions::C_P255_tracksim_compr::_L389 */ _L389;
  nid_packet_meta_TM /* TM_conversions::C_P255_tracksim_compr::_L390 */ _L390;
} outC_C_P255_tracksim_compr_TM_conversions;

/* ===========  node initialization and cycle functions  =========== */
/* TM_conversions::C_P255_tracksim_compr */
extern void C_P255_tracksim_compr_TM_conversions(
  /* TM_conversions::C_P255_tracksim_compr::P255_from_track */P255_trackside_int_T_TM *P255_from_track,
  outC_C_P255_tracksim_compr_TM_conversions *outC);

extern void C_P255_tracksim_compr_reset_TM_conversions(
  outC_C_P255_tracksim_compr_TM_conversions *outC);
