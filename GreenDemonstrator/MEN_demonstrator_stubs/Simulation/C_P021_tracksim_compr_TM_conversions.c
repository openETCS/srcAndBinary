  ...
  outC_C_P021_tracksim_compr_TM_conversions *outC)
{
  ...
  /* 1 */ C_P021_flatten_sections_reset_TM_lib_internal(&outC->_1_Context_1);
  ...
  outC_C_P021_tracksim_compr_TM_conversions *outC)
{
  ...
  kcg_copy_array__19689(&outC->_L385[0], &outC->_L386);
  ...
  for (i1 = 0; i1 < 1; i1++) {
    outC->_L376[i1] = outC->_L370;
  }
  kcg_copy_array_int_4(&outC->_L381[0], &outC->_L373);
  kcg_copy_array_int_1(&outC->_L381[4], &outC->_L376);
  /* 1 */
  C_P021_flatten_sections_TM_lib_internal(&outC->_L385, &outC->_1_Context_1);
