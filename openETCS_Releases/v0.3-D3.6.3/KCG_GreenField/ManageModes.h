...
typedef struct {
  ...
  T_Data_To_DMI_Level_And_Mode_Ty /* ManageModes::Data_To_DMI */ Data_To_DMI;
  T_Data_To_BG_Management_Level_A /* ManageModes::Data_To_BG_Management */ Data_To_BG_Management;
  /* -----------------------  no local probes  ----------------------- */
