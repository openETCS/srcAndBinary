...
void Procedure_LimitedSupervision_in(outC_Procedure_LimitedSupervisi *outC)
{
...
void Procedure_LimitedSupervision_re(outC_Procedure_LimitedSupervisi *outC)
{
...
void Procedure_LimitedSupervision_Pr(
...
/* $**************** KCG Version 6.4 (build i21) ****************
** Procedure_LimitedSupervision_Pr.c
** Generation date: 2015-11-05T08:54:04
*************************************************************$ */
