...
typedef struct {
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  L_internal_Type_Obu_BasicTypes_ /* TrackAtlas::TrackAtlasETCS::_L94 */ _L94;
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Manage_MA_Request_TA_MA_Re /* 1 */ _4_Context_1;
  outC_Build_GradientProfile_TA_G /* 1 */ _3_Context_1;
