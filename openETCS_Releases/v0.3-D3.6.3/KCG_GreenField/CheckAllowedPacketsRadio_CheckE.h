...
*************************************************************$ */
#ifndef _CheckAllowedPacketsRadio_Check
#define _CheckAllowedPacketsRadio_Check
...
extern kcg_bool CheckAllowedPacketsRadio_CheckE(
  /* CheckEuroradioMessage::CheckAllowedPacketsRadio::rtmMessage */ ReceivedMessage_T_Common_Types_ *rtmMessage);

#endif /* _CheckAllowedPacketsRadio_Check */
/* $**************** KCG Version 6.4 (build i21) ****************
** CheckAllowedPacketsRadio_CheckE.h
** Generation date: 2015-11-05T08:54:03
*************************************************************$ */
