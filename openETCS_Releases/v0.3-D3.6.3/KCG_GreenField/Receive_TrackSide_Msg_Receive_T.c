...
void Receive_TrackSide_Msg_init_Rece(outC_Receive_TrackSide_Msg_Rece *outC)
{
  static kcg_int i1;
  static kcg_int i;
  ...
  /* 1 */ Receive_BaliseTelegram_init_Rec(&outC->Context_1);
}
#endif /* KCG_USER_DEFINED_INIT */


#ifndef KCG_NO_EXTERN_CALL_TO_RESET
void Receive_TrackSide_Msg_reset_Rec(outC_Receive_TrackSide_Msg_Rece *outC)
{
  /* 1 */ Receive_BaliseTelegram_reset_Re(&outC->Context_1);
}
#endif /* KCG_NO_EXTERN_CALL_TO_RESET */

/* Receive_TrackSide_Msg_Pkg::Receive_TrackSide_Msg */
void Receive_TrackSide_Msg_Receive_T(
  ...
  outC_Receive_TrackSide_Msg_Rece *outC)
{
  ...
  /* ck_isRadioMsg */ if (isRadioMsg) {
    /* 1 */
    Receive_RadioMsg_Receive_TrackS(
      API_TrackSide_Msg,
      &outC->outTrackMessage_for_check);
  }
  else {
    /* 1 */
    Receive_BaliseTelegram_Receive_(
      reset,
      inActualOdometry,
      API_TrackSide_Msg,
      &outC->Context_1);
    kcg_copy_TrackSide_ForCheck_T_C(
      &outC->outTrackMessage_for_check,
