...
{
  /* TargetLimits_Pkg::TargetIterator */
  static V_internal_real_Type_SDM_Types_ tmp1;
  /* TargetLimits_Pkg::TargetIterator */
  static kcg_bool tmp;
  /* TargetLimits_Pkg::TargetIterator::_L2 */
  static L_internal_real_Type_SDM_Types_ _L2;
  ...
  static V_internal_real_Type_SDM_Types_ _L72;
  /* TargetLimits_Pkg::TargetIterator::_L71 */
  static V_internal_real_Type_SDM_Types_ _L71;
  ...
  *goOn = invalid_TargetManagement_types != (*target).targetType;
  /* 1 */
  surplusTractionDeltas_TargetLim(
    trainData_int,
    odometry,
    T_b,
    (*target).speed,
  ...
  tmp = /* 1 */
    isLEValid_TargetLimits_Pkg(
      ...
      _L2);
  /* 1 */ if (tmp) {
    kcg_copy_TargetIteratorAkku_Tar(Akku_out, Akku_in);
  }
  else {
    (*Akku_out).SBI2 = _L2;
    ...
    (*Akku_out).V_est = _L71;
    kcg_copy_T_trac_t_TargetLimits_(&(*Akku_out).T, &_L73);
    (*Akku_out).V_ura = _L72;
