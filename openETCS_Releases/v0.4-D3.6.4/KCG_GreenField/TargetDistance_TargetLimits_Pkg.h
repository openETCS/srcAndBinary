...
*************************************************************$ */
#ifndef _TargetDistance_TargetLimits_Pk
#define _TargetDistance_TargetLimits_Pk
...
extern L_internal_real_Type_SDM_Types_ TargetDistance_TargetLimits_Pkg(
...
#endif /* _TargetDistance_TargetLimits_Pk */
/* $**************** KCG Version 6.4 (build i21) ****************
