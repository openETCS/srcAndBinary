  ...
  outC_Master_Procedure_ManagePro *outC)
{
  ...
  /* ManageProcedure_Pkg::Master_Procedure::SM1::Awakness_of_Train::SM3::Second_Validation_of_Train_Number_from_Driver */
  static kcg_bool _3_br_2_guard_SM1_Awakness_of_T;
  ...
  static kcg_bool _5_br_1_guard_SM1_Awakness_of_T;
  ...
  /* ManageProcedure_Pkg::Master_Procedure::SM1::Awakness_of_Train::SM3::first_Validation_for_Train_Number */
  static kcg_bool _7_br_2_guard_SM1_Awakness_of_T;
  /* ManageProcedure_Pkg::Master_Procedure::SM1::Awakness_of_Train::SM3::first_Validation_for_Train_Number */
  static kcg_bool _8_br_3_guard_SM1_Awakness_of_T;
  /* ManageProcedure_Pkg::Master_Procedure::SM1::Awakness_of_Train */
  ...
  static _199_SSM_ST_SM1 SM1_state_sel;
  /* ManageProcedure_Pkg::Master_Procedure::SM1 */
  static _199_SSM_ST_SM1 SM1_state_act;
  /* ManageProcedure_Pkg::Master_Procedure::SM1 */
  static kcg_bool SM1_reset_act;
  /* ManageProcedure_Pkg::Master_Procedure::SM1 */
  static _201_SSM_TR_SM1 SM1_fired_strong;
  ...
  /* sel_SM1 */ switch (SM1_state_sel) {
    case SSM_st_SoM_NTC_SN_SM1 :
      ...
      SM1_fired_strong = _200_SSM_TR_no_trans_SM1;
      if (M_LEVEL_Level0) {
        /* 1 */ SoM_NTC_SN_reset_SoMProcedure_P(&outC->_1_Context_1);
      }
      break;
  ...
  M_LEVEL_Level0 = (*StatusModeandLevel_from_Level_a).level == M_LEVEL_Level_0;
  M_LEVEL_Level1 = (*StatusModeandLevel_from_Level_a).level == M_LEVEL_Level_1;
      ...
      /* sel_SM3 */ switch (SM3_state_sel_SM1_Awakness_of_T) {
        ...
        case SSM_st_Second_Validation_of_Tra :
          ...
          if (_2_br_1_guard_SM1_Awakness_of_T) {
            ...
            /* cb_anon_sm */ if (_3_br_2_guard_SM1_Awakness_of_T) {
              _L261 = kcg_true;
            }
            else {
              _L261 = kcg_false;
            ...
            outC->sendingTrainData_to_RBC = last_sendingTrainData_to_RBC;
            if (_3_br_2_guard_SM1_Awakness_of_T) {
              SM3_state_act_SM1_Awakness_of_T = SSM_st_Waiting_of_Start_from_Dr;
            }
            else {
        ...
        case SSM_st_Waiting_for_RBC_Establis :
          ...
          _L69 = kcg_false;
          _L67 = kcg_false;
          _4_br_1_guard_SM1_Awakness_of_T = (*mobileStatus).session.phase ==
        ...
        case SSM_st_request_Level_SM1_Awakne :
          ...
          _L240 = kcg_false;
          _L69 = kcg_false;
          _5_br_1_guard_SM1_Awakness_of_T = M_LEVEL_Level2 | M_LEVEL_Level3;
          outC->sendingPositionReport_to_RBC = last_sendingPositionReport_to_R;
          outC->sendingTrainData_to_RBC = last_sendingTrainData_to_RBC;
          if (_5_br_1_guard_SM1_Awakness_of_T) {
            _L67 = kcg_true;
            SM3_state_act_SM1_Awakness_of_T = SSM_st_Waiting_for_Mobile_termi;
          }
          else {
        ...
        case SSM_st_first_Validation_for_Tra :
          ...
          if (_6_br_1_guard_SM1_Awakness_of_T) {
            ...
            /* cb_anon_sm */ if (_7_br_2_guard_SM1_Awakness_of_T) {
              _L262 = kcg_true;
              _L255 = kcg_false;
            }
            else {
              _L262 = kcg_false;
              /* cb_anon_sm */ if (_8_br_3_guard_SM1_Awakness_of_T) {
                _L255 = kcg_true;
              }
              else {
                _L255 = kcg_false;
            ...
            if (_7_br_2_guard_SM1_Awakness_of_T) {
              SM3_state_act_SM1_Awakness_of_T = SSM_st_Waiting_for_driver_selec;
            }
            else if (_8_br_3_guard_SM1_Awakness_of_T) {
              SM3_state_act_SM1_Awakness_of_T = SSM_st_Validation_of_Train_Data;
            }
            else {
  ...
  /* 3 */ if (_L67) {
    ...
    kcg_copy_Radio_TrackTrain_Heade(
      ...
      (Radio_TrackTrain_Header_T_Radio *) &cNID_BG_Radio_Header_ManageProc);
