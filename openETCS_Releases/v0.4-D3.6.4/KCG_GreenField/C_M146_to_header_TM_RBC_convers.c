...
#include "C_M146_to_header_TM_RBC_convers.h"

/* TM_RBC_conversions::C_M146_to_header */
void C_M146_to_header_TM_RBC_convers(
  ...
  /* TM_RBC_conversions::C_M146_to_header::Message_Header_Out */ M_TrainTrack_MessageHd_T_TM_rad *Message_Header_Out)
{
  ...
  (*Message_Header_Out).field1 = /* 1 */
    CAST_T_TRAIN_to_int_TM_conversi((*Message_Data_in).t_train_req);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** C_M146_to_header_TM_RBC_convers.c
** Generation date: 2015-12-03T13:39:52
*************************************************************$ */
