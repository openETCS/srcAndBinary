  ...
  /* TA_SSP_new::SSP_Normalize_Profile_loop::ProfileNormalized_LRBG */ StaticSpeedProfile_t_TrackAtlas *ProfileNormalized_LRBG)
{
  ...
  /* TA_SSP_new::SSP_Normalize_Profile_loop::_L4 */
  static StaticSpeedSection_t_TrackAtlas _L4;
  /* TA_SSP_new::SSP_Normalize_Profile_loop::_L10 */
  static kcg_int _L10;
  /* TA_SSP_new::SSP_Normalize_Profile_loop::_L49 */
  ...
  if ((0 <= i) & (i < 50)) {
    ...
    kcg_copy_StaticSpeedSection_t_T(
      &_L4,
      (StaticSpeedSection_t_TrackAtlas *) &DEFAULT_SSP_section_TA_SSP_new);
  }
  /* 1 */ if (_L4.valid) {
