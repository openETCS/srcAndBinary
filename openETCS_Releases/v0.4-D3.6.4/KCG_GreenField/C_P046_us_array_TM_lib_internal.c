...
{
  /* TM_lib_internal::C_P046_us_array::_L16 */
  static kcg_int _L16;
  
  (*sections).valid = kcg_true;
  _L16 = i * DIM_P046_n_sections_TM_lib_inte;
  (*sections).m_leveltr = /* 1 */
    CAST_Int_to_M_LEVELTR_TM_conver(
      /* 1 */ C_P046_extract_el_section_TM_li(_L16, flat, 0));
  (*sections).nid_ntc = /* 1 */
    CAST_Int_to_NID_NTC_TM_conversi(
      /* 2 */ C_P046_extract_el_section_TM_li(_L16, flat, 1));
  *cont = n_iter_int > i;
}
