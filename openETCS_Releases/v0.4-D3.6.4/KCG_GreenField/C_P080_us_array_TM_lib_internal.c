...
{
  /* TM_lib_internal::C_P080_us_array::_L16 */
  static kcg_int _L16;
  
  (*sections).valid = kcg_true;
  _L16 = i * DIM_P080_n_sections_TM_lib_inte;
  (*sections).d_mamode = /* 1 */
    CAST_Int_to_D_MAMODE_TM_convers(
      /* 1 */ C_P080_extract_el_section_TM_li(_L16, flat, 0));
  (*sections).m_mamode = /* 1 */
    CAST_Int_to_M_MAMODE_TM_convers(
      /* 2 */ C_P080_extract_el_section_TM_li(_L16, flat, 1));
  (*sections).v_mamode = /* 1 */
    CAST_Int_to_NID_C_TM_conversion(
      /* 3 */ C_P080_extract_el_section_TM_li(_L16, flat, 2));
  (*sections).l_mamode = /* 1 */
    CAST_Int_to_L_MAMODE_TM_convers(
      /* 4 */ C_P080_extract_el_section_TM_li(_L16, flat, 3));
  (*sections).l_ackmamode = /* 1 */
    CAST_Int_to_L_ACKMAMODE_TM_conv(
      /* 5 */ C_P080_extract_el_section_TM_li(_L16, flat, 4));
  (*sections).q_mamode = /* 2 */
    CAST_Int_to_Q_MAMODE_TM_convers(
      /* 6 */ C_P080_extract_el_section_TM_li(_L16, flat, 5));
  *cont = n_iter_int > i;
}
