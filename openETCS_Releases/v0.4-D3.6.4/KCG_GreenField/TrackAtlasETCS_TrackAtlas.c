...
void TrackAtlasETCS_init_TrackAtlas(outC_TrackAtlasETCS_TrackAtlas *outC)
{
  ...
  /* 1 */ Manage_MA_Request_init_TA_MA_Re(&outC->_5_Context_1);
  /* 1 */ Build_GradientProfile_init_TA_G(&outC->_4_Context_1);
...
{
  outC->init = kcg_true;
  /* 1 */ Manage_MA_Request_reset_TA_MA_R(&outC->_5_Context_1);
  /* 1 */ Build_GradientProfile_reset_TA_(&outC->_4_Context_1);
  ...
  outC_TrackAtlasETCS_TrackAtlas *outC)
{
  ...
  kcg_copy_GradientProfile_t_Trac(&_L101, &outC->_4_Context_1.GP);
  ...
  /* 1 */ for (i = 0; i < 110; i++) {
    kcg_copy_MRSP_Profile_t_TrackAt(&acc, &MRSP_export);
    /* 1 */
  ...
  /* 1 */
  GradientProfile_to_DMI_TA_Expor(
    outC->EoA,
    &_L101,
  ...
  Manage_MA_Request_TA_MA_Request(
    ...
    ModeAndLevel_in,
    &outC->_5_Context_1);
  kcg_copy_M_TrainTrackMessageBus(&outC->bus_out, &outC->_5_Context_1.bus_out);
}
