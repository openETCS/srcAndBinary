...
#include "kcg_types.h"
#include "C_P003V1_OBU_P003_OBU_TM_conver.h"
...
typedef struct {
  ...
  DataForModeAndLevel_t_TrackAtla /* TrackAtlas::TrackAtlasETCS::To_ModeAndLevel */ To_ModeAndLevel;
  DataForDMI_t_TrackAtlasTypes /* TrackAtlas::TrackAtlasETCS::to_DMI */ to_DMI;
  DataForSupervision_nextGen_t_Tr /* TrackAtlas::TrackAtlasETCS::to_Supervision */ to_Supervision;
  MovementAuthority_t_TrackAtlasT /* TrackAtlas::TrackAtlasETCS::MA_onboard_out */ MA_onboard_out;
  M_TrainTrackMessageBus_t_TM_Tra /* TrackAtlas::TrackAtlasETCS::bus_out */ bus_out;
  Radio_TrainTrack_Message_T_TM_t /* TrackAtlas::TrackAtlasETCS::message147 */ message147;
  ...
  kcg_bool init;
  /* ----------------------- local memories  ------------------------- */
  L_internal_Type_Obu_BasicTypes_ /* TrackAtlas::TrackAtlasETCS::EoA */ EoA;
  /* ---------------------  sub nodes' contexts  --------------------- */
  outC_Manage_MA_Request_TA_MA_Re /* 1 */ _5_Context_1;
  outC_Build_GradientProfile_TA_G /* 1 */ _4_Context_1;
  outC_Build_MRSP_TA_MRSP_new /* 1 */ _3_Context_1;
  outC_Build_MA_L23_TA_MA_new /* 1 */ _2_Context_1;
  outC_StoreRaw_NV_TA_Storage /* 1 */ _1_Context_1;
  outC_Manage_EmergencyStop_TA_Em /* 1 */ Context_1;
...
extern void TrackAtlasETCS_TrackAtlas(
  ...
  /* TrackAtlas::TrackAtlasETCS::balisegroups */ positionedBGs_T_TrainPosition_T *balisegroups,
