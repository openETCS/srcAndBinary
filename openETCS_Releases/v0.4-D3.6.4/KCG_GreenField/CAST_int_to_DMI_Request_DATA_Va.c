...
#include "CAST_int_to_DMI_Request_DATA_Va.h"

/* DATA::Variables::CAST_int_to_DMI_Request */
DMI_Request_T_DMI_Types_Pkg CAST_int_to_DMI_Request_DATA_Va(
  /* DATA::Variables::CAST_int_to_DMI_Request::dmi_request_int */ kcg_int dmi_request_int)
{
  ...
  IfBlock1_clock = dmi_request_int == INT_DMI_Request_T_End_of_NTC_da;
  /* ck_IfBlock1 */ if (IfBlock1_clock) {
    dmi_reqest_ct = ENUM_DMI_Request_T_End_of_NTC_d;
  }
  else {
    _36_else_clock_IfBlock1 = dmi_request_int ==
      INT_DMI_Request_T_Hide_tunnel_s;
    /* ck_anon_activ */ if (_36_else_clock_IfBlock1) {
      dmi_reqest_ct = ENUM_DMI_Request_T_Hide_tunnel_;
    }
    else {
      _35_else_clock_IfBlock1 = dmi_request_int ==
        INT_DMI_Request_T_Language_chan;
      /* ck_anon_activ */ if (_35_else_clock_IfBlock1) {
        dmi_reqest_ct = ENUM_DMI_Request_T_Language_cha;
      }
      else {
        _34_else_clock_IfBlock1 = dmi_request_int ==
          INT_DMI_Request_T_Level_entry_r;
        /* ck_anon_activ */ if (_34_else_clock_IfBlock1) {
          dmi_reqest_ct = ENUM_DMI_Request_T_Level_entry_;
        }
        else {
          _33_else_clock_IfBlock1 = dmi_request_int ==
            INT_DMI_Request_T_Maintain_shun;
          /* ck_anon_activ */ if (_33_else_clock_IfBlock1) {
            dmi_reqest_ct = ENUM_DMI_Request_T_Maintain_shu;
          }
          else {
            ...
            /* ck_anon_activ */ if (_32_else_clock_IfBlock1) {
              ...
              _31_else_clock_IfBlock1 = dmi_request_int ==
                INT_DMI_Request_T_Non_leading_e;
              /* ck_anon_activ */ if (_31_else_clock_IfBlock1) {
                dmi_reqest_ct = ENUM_DMI_Request_T_Non_leading_;
              }
              else {
                _30_else_clock_IfBlock1 = dmi_request_int ==
                  INT_DMI_Request_T_NTC_data_entr;
                /* ck_anon_activ */ if (_30_else_clock_IfBlock1) {
                  dmi_reqest_ct = ENUM_DMI_Request_T_NTC_data_ent;
                }
                else {
                  ...
                  /* ck_anon_activ */ if (_29_else_clock_IfBlock1) {
                    ...
                    _28_else_clock_IfBlock1 = dmi_request_int ==
                      INT_DMI_Request_T_Override_rout;
                    /* ck_anon_activ */ if (_28_else_clock_IfBlock1) {
                      dmi_reqest_ct = ENUM_DMI_Request_T_Override_rou;
                    }
                    else {
                      _27_else_clock_IfBlock1 = dmi_request_int ==
                        INT_DMI_Request_T_Radio_network;
                      /* ck_anon_activ */ if (_27_else_clock_IfBlock1) {
                        dmi_reqest_ct = ENUM_DMI_Request_T_Radio_networ;
                      }
                      else {
                        _26_else_clock_IfBlock1 = dmi_request_int ==
                          INT_DMI_Request_T_Remove_VBC_re;
                        /* ck_anon_activ */ if (_26_else_clock_IfBlock1) {
                          dmi_reqest_ct = ENUM_DMI_Request_T_Remove_VBC_r;
                        }
                        else {
                          _25_else_clock_IfBlock1 = dmi_request_int ==
                            INT_DMI_Request_T_Request_for_A;
                          /* ck_anon_activ */ if (_25_else_clock_IfBlock1) {
                            dmi_reqest_ct = ENUM_DMI_Request_T_Request_for_;
                          }
                          else {
                                    ...
                                    /* ck_anon_activ */ if (_20_else_clock_IfBlock1) {
                                      ...
                                      /* ck_anon_activ */ if (_19_else_clock_IfBlock1) {
                                        ...
                                        _18_else_clock_IfBlock1 =
                                          dmi_request_int ==
                                          INT_DMI_Request_T_Request_isola;
                                        /* ck_anon_activ */ if (_18_else_clock_IfBlock1) {
                                          dmi_reqest_ct =
                                            ENUM_DMI_Request_T_Request_isol;
                                        }
                                        else {
                                          _17_else_clock_IfBlock1 =
                                            dmi_request_int ==
                                            INT_DMI_Request_T_Request_to_co;
                                          /* ck_anon_activ */ if (_17_else_clock_IfBlock1) {
                                            dmi_reqest_ct =
                                              ENUM_DMI_Request_T_Request_to_c;
                                          }
                                          else {
                                            ...
                                            /* ck_anon_activ */ if (_16_else_clock_IfBlock1) {
                                              ...
                                              /* ck_anon_activ */ if (_15_else_clock_IfBlock1) {
                                                ...
                                                _14_else_clock_IfBlock1 =
                                                  dmi_request_int ==
                                                  INT_DMI_Request_T_Train_running;
                                                /* ck_anon_activ */ if (_14_else_clock_IfBlock1) {
                                                  dmi_reqest_ct =
                                                    ENUM_DMI_Request_T_Train_runnin;
                                                }
                                                else {
                                                  _13_else_clock_IfBlock1 =
                                                    dmi_request_int ==
                                                    INT_DMI_Request_T_Train_data_en;
                                                  /* ck_anon_activ */ if (_13_else_clock_IfBlock1) {
                                                    dmi_reqest_ct =
                                                      ENUM_DMI_Request_T_Train_data_e;
                                                  }
                                                  else {
                                                    _12_else_clock_IfBlock1 =
                                                      dmi_request_int ==
                                                      INT_DMI_Request_T_Track_Ahead_F;
                                                    /* ck_anon_activ */ if (_12_else_clock_IfBlock1) {
                                                      dmi_reqest_ct =
                                                        ENUM_DMI_Request_T_Track_Ahead_;
                                                    }
                                                    else {
                                                      _11_else_clock_IfBlock1 =
                                                        dmi_request_int ==
                                                        INT_DMI_Request_T_The_Train_Int;
                                                      /* ck_anon_activ */ if (_11_else_clock_IfBlock1) {
                                                        dmi_reqest_ct =
                                                          ENUM_DMI_Request_T_The_Train_In;
                                                      }
                                                      else {
                                                        _10_else_clock_IfBlock1 =
                                                          dmi_request_int ==
                                                          INT_DMI_Request_T_Start_of_miss;
                                                        /* ck_anon_activ */ if (_10_else_clock_IfBlock1) {
                                                          dmi_reqest_ct =
                                                            ENUM_DMI_Request_T_Start_of_mis;
                                                        }
                                                        else {
                                                          _9_else_clock_IfBlock1 =
                                                            dmi_request_int ==
                                                            INT_DMI_Request_T_SR_data_entry;
                                                          /* ck_anon_activ */ if (_9_else_clock_IfBlock1) {
                                                            dmi_reqest_ct =
                                                              ENUM_DMI_Request_T_SR_data_entr;
                                                          }
                                                          else {
                                                            ...
                                                            /* ck_anon_activ */ if (_8_else_clock_IfBlock1) {
                                                              dmi_reqest_ct =
                                                                ENUM_DMI_Request_T_Shunting_exi;
                                                            }
                                                            else {
                                                              _7_else_clock_IfBlock1 =
                                                                dmi_request_int ==
                                                                INT_DMI_Request_T_Shunting_entr;
                                                              /* ck_anon_activ */ if (_7_else_clock_IfBlock1) {
                                                                dmi_reqest_ct =
                                                                  ENUM_DMI_Request_T_Shunting_ent;
                                                              }
                                                              else {
                                                                _6_else_clock_IfBlock1 =
                                                                  dmi_request_int ==
                                                                  INT_DMI_Request_T_Show_tunnel_s;
                                                                /* ck_anon_activ */ if (_6_else_clock_IfBlock1) {
                                                                  dmi_reqest_ct =
                                                                    ENUM_DMI_Request_T_Show_tunnel_;
                                                                }
                                                                else {
                                                                  _5_else_clock_IfBlock1 =
                                                                    dmi_request_int ==
                                                                    INT_DMI_Request_T_Set_VBC_reque;
                                                                  /* ck_anon_activ */ if (_5_else_clock_IfBlock1) {
                                                                    dmi_reqest_ct =
                                                                      ENUM_DMI_Request_T_Set_VBC_requ;
                                                                  }
                                                                  else {
                                                                    _4_else_clock_IfBlock1 =
                                                                      dmi_request_int ==
                                                                      INT_DMI_Request_T_Scroll_text_u;
                                                                    /* ck_anon_activ */ if (_4_else_clock_IfBlock1) {
                                                                      dmi_reqest_ct =
                                                                        ENUM_DMI_Request_T_Scroll_text_;
                                                                    }
                                                                    else {
                                                                      ...
                                                                      /* ck_anon_activ */ if (_3_else_clock_IfBlock1) {
                                                                        ...
                                                                        _2_else_clock_IfBlock1 =
                                                                          dmi_request_int ==
                                                                          INT_DMI_Request_T_Request_to_us;
                                                                        /* ck_anon_activ */ if (_2_else_clock_IfBlock1) {
                                                                          dmi_reqest_ct =
                                                                            ENUM_DMI_Request_T_Request_to_u;
                                                                        }
                                                                        else {
                                                                          ...
                                                                          /* ck_anon_activ */ if (_1_else_clock_IfBlock1) {
                                                                            ...
                                                                            /* ck_anon_activ */ if (else_clock_IfBlock1) {
                                                                              ...
                                                                              dmi_reqest_ct =
                                                                                ENUM_DMI_Request_T_End_of_NTC_d;
                                                                            }
                                                                          }
                                                                        }
                                                                      }
