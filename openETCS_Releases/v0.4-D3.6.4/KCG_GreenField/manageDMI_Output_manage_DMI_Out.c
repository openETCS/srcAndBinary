...
void manageDMI_Output_manage_DMI_Out(
  ...
  /* manage_DMI_Output_Pkg::manageDMI_Output::dmi_evc_coded_train_data */ _28_DMI_EVC_Coded_Train_Data_T_ *dmi_evc_coded_train_data,
  ...
  /* manage_DMI_Output_Pkg::manageDMI_Output::dmi_EVC_radioNet */ _26_DMI_EVC_Radio_Net_Data_T_DM *dmi_EVC_radioNet,
  /* manage_DMI_Output_Pkg::manageDMI_Output::dmi_driverIdentifier */ _25_DMI_Driver_Identifier_T_DMI *dmi_driverIdentifier,
  /* manage_DMI_Output_Pkg::manageDMI_Output::dmi_trainRunningNumber */ _24_DMI_Train_Running_Number_T_ *dmi_trainRunningNumber,
  /* manage_DMI_Output_Pkg::manageDMI_Output::dmi_adhesionFactor */ _23_DMI_Adhesion_Factor_Data_T_ *dmi_adhesionFactor,
