...
/* EVC::API_SystemTime */
T_internal_Type_Obu_BasicTypes_ API_SystemTime;
/* EVC::API_fromTrack */
API_TrackSideInput_T_API_Msg_Pk API_fromTrack;
/* EVC::API_fromDMI */
DMI_to_EVC_Message_int_T_API_DM API_fromDMI;
/* EVC::API_fromTIU */
...
ps_dataForStartOfMission_T_API_ API_persistentData;
