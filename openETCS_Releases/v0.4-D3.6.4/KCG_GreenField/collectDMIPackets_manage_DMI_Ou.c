...
void collectDMIPackets_manage_DMI_Ou(
  ...
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_evc_coded_train_data */ _28_DMI_EVC_Coded_Train_Data_T_ *dmi_evc_coded_train_data,
  ...
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_identifierRequest */ _27_DMI_Identifier_Request_T_DM *dmi_identifierRequest,
  ...
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_EVC_radioNet */ _26_DMI_EVC_Radio_Net_Data_T_DM *dmi_EVC_radioNet,
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_driverIdentifier */ _25_DMI_Driver_Identifier_T_DMI *dmi_driverIdentifier,
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_trainRunningNumber */ _24_DMI_Train_Running_Number_T_ *dmi_trainRunningNumber,
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_trainData */ DMI_Train_Data_T_DMI_Messages_B *dmi_trainData,
  /* manage_DMI_Output_Pkg::collectDMIPackets::dmi_adhesionFactor */ _23_DMI_Adhesion_Factor_Data_T_ *dmi_adhesionFactor,
  ...
  outC_collectDMIPackets_manage_D *outC)
{
  ...
  kcg_copy_DMI_Entry_Request_T_DM(
    ...
    dmi_entryRequest);
  kcg_copy__28_DMI_EVC_Coded_Trai(
  ...
  kcg_copy_DMI_EVC_Level_Data_T_D(
    ...
    dmi_EVC_levelData);
  kcg_copy__26_DMI_EVC_Radio_Net_(
