...
#include "MEM_convertP80_element_EVC_MEM_.h"

/* EVC_MEM_Support_Pkg::MEM_convertP80_element */
void MEM_convertP80_element_EVC_MEM_(
  ...
  /* EVC_MEM_Support_Pkg::MEM_convertP80_element::p80 */ P80_ModeProfile_T_Packet_Types_ *p80)
{
  (*p80).q_dir = qDir;
  (*p80).q_scale = qScale;
  ...
  *_1_continue = (*p80TM).valid;
  ...
  (*p80).d_mamode = /* 1 */
    scaledDistance_2_distance_Input(qScale, (*p80TM).d_mamode);
  (*p80).l_mamode = /* 2 */
    scaledDistance_2_distance_Input(qScale, (*p80TM).l_mamode);
  (*p80).l_ackmamode = /* 3 */
    scaledDistance_2_distance_Input(qScale, (*p80TM).l_ackmamode);
}

/* $**************** KCG Version 6.4 (build i21) ****************
** MEM_convertP80_element_EVC_MEM_.c
** Generation date: 2015-12-03T13:39:53
*************************************************************$ */
