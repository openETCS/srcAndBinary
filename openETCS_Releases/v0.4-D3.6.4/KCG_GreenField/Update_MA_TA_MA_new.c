...
void Update_MA_TA_MA_new(
  /* TA_MA_new::Update_MA::ProfileIn */ MovementAuthority_t_TrackAtlasT *ProfileIn,
  outC_Update_MA_TA_MA_new *outC)
{
  /* TA_MA_new::Update_MA::IfBlock1::else */
  static kcg_bool else_clock_IfBlock1;
  /* TA_MA_new::Update_MA::IfBlock1 */
  static kcg_bool IfBlock1_clock;
  /* TA_MA_new::Update_MA::action */
  static ActionType_TA_MA_new action;
