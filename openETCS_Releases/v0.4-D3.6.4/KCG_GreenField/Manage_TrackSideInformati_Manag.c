...
{
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */
  static ReceivedMessage_T_Common_Types_ tmp5;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */
  static ReceivedMessage_T_Common_Types_ tmp4;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */
  static positionedBG_T_TrainPosition_Ty tmp3;
  /* Manage_TrackSideInformation_Integration_Pkg::Manage_TrackSideInformation_Integration */
  ...
  /* ck_doRadio */ if (doRadio) {
    ...
    CheckEuroRadioMessage_CheckEuro(
      ...
      fullChecks,
      &outC->_1_Context_1);
    kcg_copy_ReceivedMessage_T_Comm(&tmp5, &outC->_1_Context_1.checkedMessage);
  ...
  kcg_copy_positionedBG_T_TrainPo(&tmp3, &(*trainPosition).LRBG);
  tmp3.valid = kcg_true;
  /* ck_doBaliseBranch */ if (doBaliseBranch) {
    ...
    /* ck_doRadio */ if (doRadio) {
      kcg_copy_ReceivedMessage_T_Comm(&tmp4, &tmp5);
    }
    else {
  ...
  kcg_copy_T_Data_From_Track_MASS(&outC->IF_toML, &outC->Context_3.IF_toML);
