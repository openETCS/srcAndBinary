  ...
  outC_InformationFilter_InformationFilter_Pkg *outC)
{
  ...
  static _35_SSM_ST_SM1 SM1_state_sel;
  /* InformationFilter_Pkg::InformationFilter::SM1 */
  static _35_SSM_ST_SM1 SM1_state_act;
  ...
  /* sel_SM1 */ switch (SM1_state_sel) {
    case SSM_st_State1_SM1 :
      SM1_state_act = _34_SSM_st_State2_SM1;
      break;
    case _34_SSM_st_State2_SM1 :
  ...
  /* act_SM1 */ switch (SM1_state_act) {
    ...
    case _34_SSM_st_State2_SM1 :
      ...
      outC->SM1_state_nxt = _34_SSM_st_State2_SM1;
      break;
    case SSM_st_State1_SM1 :
