  ...
  outC_registeringToTheRadioNetwork_v2_MoRC_Pck_Subfunc_Pkg *outC)
{
  ...
  br_1_guard_Register_SM_Registering = ((*sessionStatus).phase ==
      sp_establishing_RCM_Session_Types_Pkg) | ((*sessionStatus).phase ==
      sp_terminating_RCM_Session_Types_Pkg) | ((*sessionStatus).phase ==
  ...
  /* init_Register_SM */ if (outC->init) {
    ...
    outC->orderRegistrationDelayed = (triggerRegistrationOfMobile & (_L185 |
          (br_1_guard_Register_SM_Registering & (*sessionStatus).valid)) &
  ...
  orderRegistrationImmediately = triggerRegistrationOfMobile &
    ((*mobileRegistrationContext).valid &
      ...
      !br_1_guard_Register_SM_Registering);
  /* 1 */
  FallingEdge_digital(
    (kcg_bool)
      (br_1_guard_Register_SM_Registering | ((*connectionStatus).status ==
          mcs_connecting_RCM_Types_Pkg) | ((*connectionStatus).status ==
