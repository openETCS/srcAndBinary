  ...
  /* TM_lib_internal::BufferOutput_read_write3::Message_out */ M_TrainTrack_Message_T_TM_radio_messages *Message_out)
{
  ...
  /* 2 */ if (_L34) {
    kcg_copy_array_99005(&(*Buffer_Out)[0], (array_99005 *) &(*Message_In)[1]);
    ...
    kcg_copy_array_99276(&(*Buffer_Out)[0], (array_99276 *) &(*Message_In)[0]);
  ...
  kcg_copy_array_102017(&(*Buffer_Out)[3], (array_102017 *) &(*Buffer_In)[0]);
